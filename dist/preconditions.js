export function findPreconditionAddress(preconditions) {
    console.log("[trails-sdk] Finding precondition address from:", JSON.stringify(preconditions, null, 2));
    ...
    for (const type of preconditionTypes) {
        ...
        if (precondition) {
            console.log(`[trails-sdk] Found ${type} precondition with address:`, precondition.data.address);
