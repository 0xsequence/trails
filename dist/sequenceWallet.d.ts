...
export declare function getAccountNetworks(input: GetAccountNetworksInput): (import("@0xsequence/network").NetworkConfig | {
    relayer: any;
    chainId: import("@0xsequence/network").ChainId;
    type?: import("@0xsequence/network").NetworkType;
    name: string;
    title?: string;
    logoURI?: string;
    blockExplorer?: import("@0xsequence/network").BlockExplorerConfig;
    ensAddress?: string;
    testnet?: boolean;
    deprecated?: boolean;
    nativeToken: {
    ...
    indexerUrl?: string;
    indexer?: import("@0xsequence/indexer").Indexer;
...
export declare function getFeeOptions(relayer: Relayer.Rpc.RpcRelayer, wallet: string, chainId: number, calls: Payload.Call[]): Promise<{
