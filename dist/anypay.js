...
export function useAnyPay(config) {
    ...
    const [anypayInfos, setAnypayInfos] = useState(null);
    ...
    const calculatedIntentAddress = useMemo(() => {
        ...
        return calculateIntentAddress(account.address, intentCallsPayloads, anypayInfos, anypayFee?.quoteProvider); // TODO: Add proper type
    ...
    const commitIntentConfigMutation = useMutation({
        mutationFn: async (args) => {
            ...
            if (!args.anypayInfos)
                throw new Error("AnypayInfos not available");
            ...
            try {
                ...
                args.anypayInfos, // TODO: Add proper type
                args.quoteProvider);
    ...
    useEffect(() => {
        if (isAutoExecute &&
            ...
            commitIntentConfigMutation.mutate({
                ...
                quoteProvider: anypayFee.quoteProvider,
            });
        }
    }, [
        isAutoExecute,
    ...
    const sendMetaTxnMutation = useMutation({
        mutationFn: async ({ selectedId }) => {
            ...
            const intentAddress = calculateIntentAddress(account.address, intentCallsPayloads, anypayInfos, anypayFee.quoteProvider); // TODO: Add proper type
