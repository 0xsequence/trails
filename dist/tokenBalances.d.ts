...
export declare function formatRawAmount(balance: string | bigint, decimals?: number): string;
export declare function getTokenBalanceUsd(token: TokenBalance | NativeTokenBalance, tokenPrice: Price): number;
export declare function formatAmount(value: string | number, { maxFractionDigits, minFractionDigits, }?: {
    maxFractionDigits?: number;
    minFractionDigits?: number;
}): string;
export declare function formatAmountDisplay(value: string | number, { maxFractionDigits, minFractionDigits, }?: {
    maxFractionDigits?: number;
    minFractionDigits?: number;
}): string;
export declare function formatUsdAmountDisplay(value?: number | string): string;
