...
import { getSequenceProjectAccessKey, getSequenceUseV3Relayers, getSequenceEnv, } from "./config.js";
...
export function getBackupRelayer(chainId) {
    if (chainId === 42161) {
        return new Relayer.Standard.Rpc.RpcRelayer("https://a1b4a8c5d856.ngrok.app/", chainId, "https://nodes.sequence.app/arbitrum");
    }
    else if (chainId === 8453) {
        return new Relayer.Standard.Rpc.RpcRelayer("https://644a6aeb891e.ngrok.app/", chainId, "https://nodes.sequence.app/base");
    }
    return undefined;
}
// TODO: add relayer url to config
export function getRelayerUrl(config = {
    env: getSequenceEnv(),
...
export function getRelayer(config = {
    env: getSequenceEnv(),
    useV3Relayers: getSequenceUseV3Relayers(),
}, chainId) {
    ...
    return new Relayer.Standard.Rpc.RpcRelayer(relayerUrl, chainId, rpcUrl, wrappedFetch);
}
