...
import { isAddressEqual, http, createPublicClient, } from "viem";
import { ATTESATION_SIGNER_ADDRESS, TRAILS_CCTP_SAPIENT_SIGNER_ADDRESS, TRAILS_LIFI_SAPIENT_SIGNER_ADDRESS, TRAILS_RELAY_SAPIENT_SIGNER_ADDRESS, } from "./constants.js";
import { findPreconditionAddresses } from "./preconditions.js";
import { getChainInfo } from "./chains.js";
import { trackTransactionStarted, trackTransactionSubmitted, trackTransactionError, trackIntentQuoteRequested, trackIntentQuoteReceived, trackIntentQuoteError, trackIntentCommitStarted, trackIntentCommitCompleted, trackIntentCommitError, } from "./analytics.js";
export async function getIntentCallsPayloads(apiClient, args) {
    ...
    try {
        ...
        trackIntentQuoteReceived({
            ...
            gasFeesPerChainUSD: result.trailsFee?.executeQuote?.chainQuotes?.map((quote) => parseFloat(quote.totalFeeUSD || "0")) || [],
...
export async function commitIntentConfig(apiClient, mainSignerAddress, calls, preconditions) {
