import { BaseError, concat, createWalletClient, custom, decodeAbiParameters, decodeFunctionData, encodeDeployData, encodeFunctionData, } from "viem";
import { entryPoint07Abi, entryPoint07Address, getUserOperationHash, toSmartAccount, } from "viem/account-abstraction";
import { toAccount } from "viem/accounts";
import { call, getChainId, readContract, signMessage, signTypedData, } from "viem/actions";
import { getAction } from "viem/utils";
export const getAccountInitCode = async (owner, index = BigInt(0)) => {
    if (!owner)
...
export const getFactoryAddress = (factoryAddress) => {
    if (factoryAddress)
...
export async function toSimpleSmartAccount(parameters) {
    const { client, owner, factoryAddress: _factoryAddress, index = BigInt(0), address, nonceKey,
...
export const GetSenderAddressHelperByteCode = "";
