...
export declare const ENTRYPOINT_ADDRESS = "0x0000000071727De22E5E9d8BAf0edAc6f37da032";
...
export declare function getAccountGasLimits(op: UserOperationV07): `0x${string}`;
export declare function getGasFees(op: UserOperationV07): `0x${string}`;
export declare function getInitCode(op: UserOperationV07): `0x${string}`;
export declare function getPaymasterAndData(op: UserOperationV07): `0x${string}`;
...
export declare function toUnpackedUserOperation(packedUserOperation: PackedUserOperation): UnpackedUserOperation;
