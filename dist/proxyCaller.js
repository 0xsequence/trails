...
const PLACEHOLDER_AMOUNT = 0xdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefn;
const proxyCallers = {
...
export function encodeProxyCallerCalldata({ token, target, calldata, amountOffset, }) {
    ...
    const placeholderBytes32 = `0x${PLACEHOLDER_AMOUNT.toString(16).padStart(64, "0")}`;
