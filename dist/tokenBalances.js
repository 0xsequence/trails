...
export function formatRawAmount(balance, decimals = 18) {
    try {
...
export function formatAmount(value, { maxFractionDigits = 8, minFractionDigits = 2, } = {}) {
    if (!value) {
        value = 0;
    }
    try {
...
export function formatAmountDisplay(value, { maxFractionDigits = 8, minFractionDigits = 2, } = {}) {
    if (!value) {
        value = 0;
    }
    try {
...
export function formatUsdAmountDisplay(value = 0) {
    if (!value) {
        value = 0;
    }
