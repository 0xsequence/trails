import { i as _, a as N, r as Y, h as C, I as h, d as I, R as L, O as z, e as E, f as W, W as F } from "./index-C5WaG16p.js";
import { x as a } from "./lit-html-jz-94mx9.js";
import { n as l, c as S, o as k, r as v } from "./if-defined-CulHeU7H.js";
import { T as A, D as U } from "./index-BrrcoI8n.js";
...
`;
var m = function(r, t, e, o) {
  var s = arguments.length, i = s < 3 ? t : o === null ? o = Object.getOwnPropertyDescriptor(t, e) : o, n;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") i = Reflect.decorate(r, t, e, o);
  else for (var c = r.length - 1; c >= 0; c--) (n = r[c]) && (i = (s < 3 ? n(i) : s > 3 ? n(t, e, i) : n(t, e)) || i);
...
let f = class extends N {
  ...
  render() {
    const [t, e] = this.images, o = (t == null ? void 0 : t.type) === "NFT", s = e != null && e.url ? e.type === "NFT" : o, i = o ? "var(--wui-border-radius-xxs)" : "var(--wui-border-radius-s)", n = s ? "var(--wui-border-radius-xxs)" : "var(--wui-border-radius-s)";
  ...
  templateVisual() {
    const [t, e] = this.images, o = t == null ? void 0 : t.type;
    return this.images.length === 2 && (t != null && t.url || e != null && e.url) ? a`<div class="swap-images-container">
      ...
      </div>` : t != null && t.url ? a`<wui-image src=${t.url} alt="Transaction image"></wui-image>` : o === "NFT" ? a`<wui-icon size="inherit" color="fg-200" name="nftPlaceholder"></wui-icon>` : a`<wui-icon size="inherit" color="fg-200" name="coinPlaceholder"></wui-icon>`;
  }
  templateIcon() {
    let t = "accent-100", e;
...
w([
  l({ type: Array })
], p.prototype, "descriptions", void 0);
w([
  l()
], p.prototype, "date", void 0);
w([
  l({ type: Boolean })
], p.prototype, "onlyDirectionIcon", void 0);
w([
  l()
...
`;
var x = function(r, t, e, o) {
  var s = arguments.length, i = s < 3 ? t : o === null ? o = Object.getOwnPropertyDescriptor(t, e) : o, n;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") i = Reflect.decorate(r, t, e, o);
  else for (var c = r.length - 1; c >= 0; c--) (n = r[c]) && (i = (s < 3 ? n(i) : s > 3 ? n(t, e, i) : n(t, e)) || i);
  return s > 3 && i && Object.defineProperty(t, e, i), i;
};
const D = "last-transaction", P = 7;
let g = class extends N {
  constructor() {
    super(), this.unsubscribe = [], this.paginationObserver = void 0, this.page = "activity", this.caipAddress = C.state.activeCaipAddress, this.transactionsByYear = h.state.transactionsByYear, this.loading = h.state.loading, this.empty = h.state.empty, this.next = h.state.next, h.clearCursor(), this.unsubscribe.push(C.subscribeKey("activeCaipAddress", (t) => {
      t && this.caipAddress !== t && (h.resetTransactions(), h.fetchTransactions(t)), this.caipAddress = t;
    }), C.subscribeKey("activeCaipNetwork", () => {
  ...
  updateTransactionView() {
    h.resetTransactions(), this.caipAddress && h.fetchTransactions(I.getPlainAddress(this.caipAddress));
  }
  templateTransactionsByYear() {
    return Object.keys(this.transactionsByYear).sort().reverse().map((e) => {
      const o = parseInt(e, 10), s = new Array(12).fill(null).map((i, n) => {
        var u;
        const c = A.getTransactionGroupTitle(o, n), d = (u = this.transactionsByYear[o]) == null ? void 0 : u[n];
        return {
          groupTitle: c,
          transactions: d
        };
  ...
  templateRenderTransaction(t, e) {
    const { date: o, descriptions: s, direction: i, isAllNFT: n, images: c, status: d, transfers: u, type: y } = this.getTransactionListItemProps(t), b = (u == null ? void 0 : u.length) > 1;
    return (u == null ? void 0 : u.length) === 2 && !n ? a`
        ...
        ></wui-transaction-list-item>
      ` : b ? u.map(($, j) => {
      const B = A.getTransferDescription($), T = e && j === u.length - 1;
  ...
  templateLoading() {
    return this.page === "activity" ? Array(P).fill(a` <wui-transaction-list-item-loader></wui-transaction-list-item-loader> `).map((t) => t) : null;
  }
  onReceiveClick() {
    L.push("WalletReceive");
  }
  createPaginationObserver() {
    const { projectId: t } = z.state;
    this.paginationObserver = new IntersectionObserver(([e]) => {
      e != null && e.isIntersecting && !this.loading && (h.fetchTransactions(I.getPlainAddress(this.caipAddress)), E.sendEvent({
        type: "track",
        event: "LOAD_MORE_TRANSACTIONS",
        properties: {
          address: I.getPlainAddress(this.caipAddress),
          projectId: t,
          cursor: this.next,
          isSmartAccount: W(C.state.activeChain) === F.ACCOUNT_TYPES.SMART_ACCOUNT
        }
      }));
    }, {}), this.setPaginationObserver();
  }
  setPaginationObserver() {
    ...
    const t = (o = this.shadowRoot) == null ? void 0 : o.querySelector(`#${D}`);
    t && ((s = this.paginationObserver) == null || s.observe(t));
  }
  getTransactionListItemProps(t) {
    var d, u, y, b, O;
    const e = U.formatDate((d = t == null ? void 0 : t.metadata) == null ? void 0 : d.minedAt), o = A.getTransactionDescriptions(t), s = t == null ? void 0 : t.transfers, i = (u = t == null ? void 0 : t.transfers) == null ? void 0 : u[0], n = !!i && ((y = t == null ? void 0 : t.transfers) == null ? void 0 : y.every(($) => !!$.nft_info)), c = A.getTransactionImages(s);
    return {
      date: e,
      ...
      transfers: s,
      type: (O = t.metadata) == null ? void 0 : O.operationType
    };
  }
};
g.styles = M;
