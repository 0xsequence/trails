import { defineChain as Ga, createPublicClient as $a, http as In, isAddress as mt, isHex as je, hashTypedData as nn, hashMessage as kr, numberToHex as se, slice as ei, keccak256 as ti, toHex as Re, hexToBigInt as ut, stringToBytes as On, hexToBytes as qt, trim as Cn, encodeFunctionData as xe, decodeFunctionData as Ar, BaseError as _r, encodeAbiParameters as Ir, stringToHex as ni, size as ri, parseSignature as ai, encodePacked as ii, hexToString as Tn, pad as oi, decodeAbiParameters as Or, erc20Abi as si, hexToNumber as Ot, isAddressEqual as ci } from "viem";
import { J as Ht, K as ui } from "./index-CUWmD1rN.js";
import { ah as Ue, ai as rn, aj as ht, ak as li, al as we, am as di, an as fi, ao as Cr, ap as pi, aq as mi, ar as hi, as as gi, at as bi, au as Pn, av as yi, aw as Bn, ax as vi, ay as jn, _ as wi, az as Ei, aA as Si, aB as xi, Y as ki, aC as Ai, aD as _i, aE as Ii, aF as Oi, aG as Ci, aH as Ti, aI as Pi, aJ as Nn } from "./prepareSend-CNn7e23s.js";
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const an = /* @__PURE__ */ BigInt(0), Lt = /* @__PURE__ */ BigInt(1);
function gt(e, t = "") {
  if (typeof e != "boolean") {
    const n = t && `"${t}"`;
...
function _e(e, t, n = "") {
  const r = rn(e), a = e == null ? void 0 : e.length, i = t !== void 0;
  if (!r || i && a !== t) {
    const o = n && `"${n}" `, c = i ? ` of length ${t}` : "", s = r ? `length=${a}` : `type=${typeof e}`;
    throw new Error(o + "expected Uint8Array" + c + ", got " + s);
  }
  return e;
}
function Qe(e) {
...
function Tr(e) {
  ...
  return e === "" ? an : BigInt("0x" + e);
}
function Et(e) {
  return Tr(Ue(e));
}
function Pr(e) {
  return li(e), Tr(Ue(Uint8Array.from(e).reverse()));
}
function on(e, t) {
...
const Ct = (e) => typeof e == "bigint" && an <= e;
function Bi(e, t, n) {
...
function jr(e) {
  let t;
  for (t = 0; e > an; e >>= Lt, t += 1)
    ;
  return t;
}
const Ye = (e) => (Lt << BigInt(e)) - Lt;
function Ni(e, t, n) {
  ...
  const r = (l) => new Uint8Array(l), a = (l) => Uint8Array.of(l);
  let i = r(e), o = r(e), c = 0;
  const s = () => {
    i.fill(1), o.fill(0), c = 0;
  }, u = (...l) => n(o, i, ...l), p = (l = r(0)) => {
    o = u(a(0), l), i = u(), l.length !== 0 && (o = u(a(1), l), i = u());
  }, f = () => {
    if (c++ >= 1e3)
...
function sn(e, t, n = {}) {
  ...
  function r(a, i, o) {
    ...
    const s = typeof c;
    if (s !== i || c === null)
      throw new Error(`param "${a}" is invalid: expected ${i}, got ${s}`);
  }
  Object.entries(t).forEach(([a, i]) => r(a, i, !1)), Object.entries(n).forEach(([a, i]) => r(a, i, !0));
}
function Rn(e) {
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const ce = BigInt(0), re = BigInt(1), Ie = /* @__PURE__ */ BigInt(2), Nr = /* @__PURE__ */ BigInt(3), Rr = /* @__PURE__ */ BigInt(4), Ur = /* @__PURE__ */ BigInt(5), Ri = /* @__PURE__ */ BigInt(7), Mr = /* @__PURE__ */ BigInt(8), Ui = /* @__PURE__ */ BigInt(9), Kr = /* @__PURE__ */ BigInt(16);
function pe(e, t) {
  const n = e % t;
  return n >= ce ? n : t + n;
}
function Un(e, t) {
  ...
  let n = pe(e, t), r = t, a = ce, i = re;
  for (; n !== ce; ) {
    const c = r / n, s = r % n, u = a - i * c;
    r = n, n = s, a = i, i = u;
  }
  if (r !== re)
...
function Dr(e, t) {
  const n = (e.ORDER + re) / Rr, r = e.pow(t, n);
  return cn(e, r, t), r;
}
function Mi(e, t) {
  const n = (e.ORDER - Ur) / Mr, r = e.mul(t, Ie), a = e.pow(r, n), i = e.mul(t, a), o = e.mul(e.mul(i, Ie), a), c = e.mul(i, e.sub(o, e.ONE));
  return cn(e, c, t), c;
}
function Ki(e) {
  const t = Pe(e), n = qr(e), r = n(t, t.neg(t.ONE)), a = n(t, r), i = n(t, t.neg(r)), o = (e + Ri) / Kr;
  return (c, s) => {
    let u = c.pow(s, o), p = c.mul(u, r);
    const f = c.mul(u, a), d = c.mul(u, i), l = c.eql(c.sqr(p), s), m = c.eql(c.sqr(f), s);
    u = c.cmov(u, p, l), p = c.cmov(d, f, m);
    const h = c.eql(c.sqr(p), s), v = c.cmov(u, p, h);
    return cn(c, v, s), v;
  };
}
function qr(e) {
  ...
  return function(s, u) {
    ...
    if (Mn(s, u) !== 1)
      throw new Error("Cannot find square root");
    let p = n, f = s.mul(s.ONE, i), d = s.pow(u, t), l = s.pow(u, o);
    for (; !s.eql(d, s.ONE); ) {
      if (s.is0(d))
        return s.ZERO;
      let m = 1, h = s.sqr(d);
      for (; !s.eql(h, s.ONE); )
        if (m++, h = s.sqr(h), m === p)
          throw new Error("Cannot find square root");
      const v = re << BigInt(p - m - 1), S = s.pow(f, v);
      p = m, f = s.sqr(S), d = s.mul(d, f), l = s.mul(l, S);
    }
    return l;
  };
}
function Di(e) {
  return e % Rr === Nr ? Dr : e % Mr === Ur ? Mi : e % Kr === Ui ? Ki(e) : qr(e);
}
const qi = [
  "create",
  "isValid",
...
function Hi(e) {
  const t = {
    ...
    BYTES: "number",
    BITS: "number"
  }, n = qi.reduce((r, a) => (r[a] = "function", r), t);
  return sn(e, n), e;
}
function Li(e, t, n) {
  if (n < ce)
  ...
  let r = e.ONE, a = t;
  for (; n > ce; )
    n & re && (r = e.mul(r, a)), a = e.sqr(a), n >>= re;
  return r;
}
function Hr(e, t, n = !1) {
  const r = new Array(t.length).fill(n ? e.ZERO : void 0), a = t.reduce((o, c, s) => e.is0(c) ? o : (r[s] = o, e.mul(o, c)), e.ONE), i = e.inv(a);
  return t.reduceRight((o, c, s) => e.is0(c) ? o : (r[s] = e.mul(o, r[s]), e.mul(o, c)), i), r;
}
function Mn(e, t) {
  const n = (e.ORDER - re) / Ie, r = e.pow(t, n), a = e.eql(r, e.ONE), i = e.eql(r, e.ZERO), o = e.eql(r, e.neg(e.ONE));
  if (!a && !i && !o)
...
function Pe(e, t, n = !1, r = {}) {
  ...
  if (typeof t == "object" && t != null) {
    ...
    const d = t;
    d.BITS && (a = d.BITS), d.sqrt && (i = d.sqrt), typeof d.isLE == "boolean" && (n = d.isLE), typeof d.modFromBytes == "boolean" && (o = d.modFromBytes), c = d.allowedLengths;
  } else
    typeof t == "number" && (a = t), r.sqrt && (i = r.sqrt);
  const { nBitLength: s, nByteLength: u } = Lr(e, a);
  if (u > 2048)
  ...
  const f = Object.freeze({
    ...
    mulN: (d, l) => d * l,
    inv: (d) => Un(d, e),
    sqrt: i || ((d) => (p || (p = Di(e)), p(f, d))),
    toBytes: (d) => n ? Br(d, u) : on(d, u),
    fromBytes: (d, l = !0) => {
      if (c) {
        if (!c.includes(d.length) || d.length > u)
          throw new Error("Field.fromBytes: expected " + c + " bytes, got " + d.length);
      ...
      let m = n ? Pr(d) : Et(d);
      if (o && (m = pe(m, e)), !l && !f.isValid(m))
        throw new Error("invalid field element: outside of range 0..ORDER");
      return m;
    },
    // TODO: we don't need it here, move out to separate fn
    invertBatch: (d) => Hr(f, d),
...
function zi(e, t, n = !1) {
  const r = e.length, a = zr(t), i = Fr(t);
  if (r < 16 || r < i || r > 1024)
    throw new Error("expected " + i + "-1024 bytes of input, got " + r);
  const o = n ? Pr(e) : Et(e), c = pe(o, t - re) + re;
  return n ? Br(c, a) : on(c, a);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Ke = BigInt(0), Oe = BigInt(1);
function bt(e, t) {
  const n = t.negate();
  return e ? n : t;
}
function Tt(e, t) {
  const n = Hr(e.Fp, t.map((r) => r.Z));
...
function Pt(e, t) {
  Zr(e, t);
  const n = Math.ceil(t / e) + 1, r = 2 ** (e - 1), a = 2 ** e, i = Ye(e), o = BigInt(e);
  return { windows: n, windowSize: r, mask: i, maxNumber: a, shiftBy: o };
}
function Kn(e, t, n) {
  const { windowSize: r, mask: a, maxNumber: i, shiftBy: o } = n;
  let c = Number(e & a), s = e >> o;
  c > r && (c -= i, s += Oe);
  const u = t * r, p = u + Math.abs(c) - 1, f = c === 0, d = c < 0, l = t % 2 !== 0;
  return { nextN: s, offset: p, isZero: f, isNeg: d, isNegF: l, offsetF: u };
}
function Fi(e, t) {
  if (!Array.isArray(e))
...
const Bt = /* @__PURE__ */ new WeakMap(), Vr = /* @__PURE__ */ new WeakMap();
function jt(e) {
  return Vr.get(e) || 1;
}
function Dn(e) {
...
class Vi {
  ...
  _unsafeLadder(t, n, r = this.ZERO) {
    let a = t;
    for (; n > Ke; )
      n & Oe && (r = r.add(a)), a = a.double(), n >>= Oe;
    return r;
  }
  /**
  ...
  precomputeWindow(t, n) {
    const { windows: r, windowSize: a } = Pt(n, this.bits), i = [];
    let o = t, c = o;
    for (let s = 0; s < r; s++) {
      c = o, i.push(c);
      for (let u = 1; u < a; u++)
  ...
  wNAF(t, n, r) {
    ...
    let a = this.ZERO, i = this.BASE;
    const o = Pt(t, this.bits);
    for (let c = 0; c < o.windows; c++) {
      const { nextN: s, offset: u, isZero: p, isNeg: f, isNegF: d, offsetF: l } = Kn(r, c, o);
      r = s, p ? i = i.add(bt(d, n[l])) : a = a.add(bt(f, n[u]));
    }
    return Dn(r), { p: a, f: i };
  }
  /**
  ...
  wNAFUnsafe(t, n, r, a = this.ZERO) {
    const i = Pt(t, this.bits);
    for (let o = 0; o < i.windows && r !== Ke; o++) {
      const { nextN: c, offset: s, isZero: u, isNeg: p } = Kn(r, o, i);
      if (r = c, !u) {
        const f = n[s];
        a = a.add(p ? f.negate() : f);
      }
    }
    return Dn(r), a;
  }
  getPrecomputes(t, n, r) {
    let a = Bt.get(n);
    return a || (a = this.precomputeWindow(n, t), t !== 1 && (typeof r == "function" && (a = r(a)), Bt.set(n, a))), a;
  }
  cached(t, n, r) {
    const a = jt(t);
  ...
  unsafe(t, n, r, a) {
    const i = jt(t);
    return i === 1 ? this._unsafeLadder(t, n, a) : this.wNAFUnsafe(i, this.getPrecomputes(i, t, r), n, a);
  }
  // We calculate precomputes for elliptic curve point multiplication
  // using windowed method. This specifies window size and
  // stores precomputed values. Usually only base point would be precomputed.
  createCache(t, n) {
    Zr(n, this.bits), Vr.set(t, n), Bt.delete(t);
  }
  hasCache(t) {
    return jt(t) !== 1;
  }
...
function Wi(e, t, n, r) {
  let a = t, i = e.ZERO, o = e.ZERO;
  for (; n > Ke || r > Ke; )
    n & Oe && (i = i.add(a)), r & Oe && (o = o.add(a)), a = a.double(), n >>= Oe, r >>= Oe;
  return { p1: i, p2: o };
}
function Ji(e, t, n, r) {
  Fi(n, e), Zi(r, t);
  ...
  const o = e.ZERO, c = jr(BigInt(a));
  let s = 1;
  c > 12 ? s = c - 3 : c > 4 ? s = c - 2 : c > 0 && (s = 2);
  const u = Ye(s), p = new Array(Number(u) + 1).fill(o), f = Math.floor((t.BITS - 1) / s) * s;
  let d = o;
  for (let l = f; l >= 0; l -= s) {
    p.fill(o);
    for (let h = 0; h < i; h++) {
      const v = r[h], S = Number(v >> BigInt(l) & u);
      p[S] = p[S].add(n[h]);
    }
    let m = o;
    for (let h = p.length - 1, v = o; h > 0; h--)
      v = v.add(p[h]), m = m.add(v);
    if (d = d.add(m), l !== 0)
      for (let h = 0; h < s; h++)
        d = d.double();
  }
...
function Yi(e, t, n = {}, r) {
  ...
  const a = qn(t.p, n.Fp, r), i = qn(t.n, n.Fn, r), c = ["Gx", "Gy", "a", "b"];
  for (const s of c)
    if (!a.isValid(t[s]))
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Hn = (e, t) => (e + (e >= 0 ? t : -t) / Wr) / t;
function Xi(e, t, n) {
  const [[r, a], [i, o]] = t, c = Hn(o * e, n), s = Hn(-a * e, n);
  let u = e - c * r - s * i, p = -c * a - s * o;
  const f = u < ye, d = p < ye;
  f && (u = -u), d && (p = -p);
  const l = Ye(Math.ceil(jr(n) / 2)) + Me;
  if (u < ye || u >= l || p < ye || p >= l)
...
function Nt(e, t) {
  ...
  return gt(n.lowS, "lowS"), gt(n.prehash, "prehash"), n.format !== void 0 && zt(n.format), n;
}
...
const ge = {
  ...
  _tlv: {
    encode: (e, t) => {
      ...
      const r = t.length / 2, a = Qe(r);
      if (a.length / 2 & 128)
        throw new n("tlv.encode: long form length too big");
      const i = r > 127 ? Qe(a.length / 2 | 128) : "";
      return Qe(e) + i + a + t;
    },
    ...
    decode(e, t) {
      ...
      const c = t.subarray(r, r + o);
      if (c.length !== o)
        throw new n("tlv.decode: wrong value length");
      return { v: c, l: t.subarray(r + o) };
    }
  },
  ...
  toSig(e) {
    const { Err: t, _int: n, _tlv: r } = ge, a = oe("signature", e), { v: i, l: o } = r.decode(48, a);
    if (o.length)
      throw new t("invalid signature: left bytes after parsing");
    const { v: c, l: s } = r.decode(2, i), { v: u, l: p } = r.decode(2, s);
    if (p.length)
      throw new t("invalid signature: left bytes after parsing");
    return { r: n.decode(c), s: n.decode(u) };
  },
  hexFromSig(e) {
    const { _tlv: t, _int: n } = ge, r = t.encode(2, n.encode(e.r)), a = t.encode(2, n.encode(e.s)), i = r + a;
    return t.encode(48, i);
  }
}, ye = BigInt(0), Me = BigInt(1), Wr = BigInt(2), Ge = BigInt(3), Gi = BigInt(4);
function Ne(e, t) {
  const { BYTES: n } = e;
  let r;
  if (typeof t == "bigint")
...
function $i(e, t = {}) {
  const n = Yi("weierstrass", e, t), { Fp: r, Fn: a } = n;
  let i = n.CURVE;
  const { h: o, n: c } = i;
  sn(t, {}, {
  ...
  const { endo: s } = t;
  if (s && (!r.is0(i.a) || typeof s.beta != "bigint" || !Array.isArray(s.basises)))
  ...
  function f(U, y, b) {
    const { x: g, y: x } = y.toAffine(), A = r.toBytes(g);
    if (gt(b, "isCompressed"), b) {
      p();
      const T = !r.isOdd(x);
      return we(Jr(T), A);
    } else
      return we(Uint8Array.of(4), A, r.toBytes(x));
  }
  function d(U) {
    _e(U, void 0, "Point");
    const { publicKey: y, publicKeyUncompressed: b } = u, g = U.length, x = U[0], A = U.subarray(1);
    if (g === y && (x === 2 || x === 3)) {
      const T = r.fromBytes(A);
      if (!r.isValid(T))
      ...
      p();
      const P = r.isOdd(I);
      return (x & 1) === 1 !== P && (I = r.neg(I)), { x: T, y: I };
    } else if (g === b && x === 4) {
      const T = r.BYTES, C = r.fromBytes(A.subarray(0, T)), I = r.fromBytes(A.subarray(T, T * 2));
      if (!v(C, I))
        throw new Error("bad point: is not on curve");
      return { x: C, y: I };
    } else
      throw new Error(`bad point: got length ${g}, expected compressed=${y} or uncompressed=${b}`);
  }
  const l = t.toBytes || f, m = t.fromBytes || d;
  function h(U) {
    const y = r.sqr(U), b = r.mul(y, U);
    return r.add(r.add(b, r.mul(U, i.a)), i.b);
  }
  function v(U, y) {
    const b = r.sqr(y), g = h(U);
    return r.eql(b, g);
  }
  if (!v(i.Gx, i.Gy))
    throw new Error("bad curve params: generator point");
  const S = r.mul(r.pow(i.a, Ge), Gi), O = r.mul(r.sqr(i.b), BigInt(27));
  if (r.is0(r.add(S, O)))
    throw new Error("bad curve params: a or b");
  function k(U, y, b = !1) {
    if (!r.isValid(y) || b && r.is0(y))
  ...
  const $ = Rn((U, y) => {
    ...
    if (r.eql(x, r.ONE))
      return { x: b, y: g };
    const A = U.is0();
    y == null && (y = A ? r.ONE : r.inv(x));
    const T = r.mul(b, y), C = r.mul(g, y), I = r.mul(x, y);
    if (A)
  ...
  function te(U, y, b, g, x) {
    return b = new B(r.mul(b.X, U), b.Y, b.Z), y = bt(g, y), b = bt(x, b), y.add(b);
  }
  class B {
    /** Does NOT validate if the point is valid. Use `.assertValidity()`. */
    constructor(y, b, g) {
      this.X = k("x", y), this.Y = k("y", b, !0), this.Z = k("z", g), Object.freeze(this);
    }
    static CURVE() {
      return i;
    }
    ...
    static fromAffine(y) {
      const { x: b, y: g } = y || {};
      if (!y || !r.isValid(b) || !r.isValid(g))
        throw new Error("invalid affine point");
      if (y instanceof B)
        throw new Error("projective point not allowed");
      return r.is0(b) && r.is0(g) ? B.ZERO : new B(b, g, r.ONE);
    }
    static fromBytes(y) {
      const b = B.fromAffine(m(_e(y, void 0, "point")));
      return b.assertValidity(), b;
    }
    static fromHex(y) {
      return B.fromBytes(oe("pointHex", y));
    }
    get x() {
     ...
     */
    precompute(y = 8, b = !0) {
      return ue.createCache(this, y), b || this.multiply(Ge), this;
    }
    // TODO: return `this`
    ...
    equals(y) {
      _(y);
      const { X: b, Y: g, Z: x } = this, { X: A, Y: T, Z: C } = y, I = r.eql(r.mul(b, C), r.mul(A, x)), P = r.eql(r.mul(g, C), r.mul(T, x));
      return I && P;
    }
    ...
    double() {
      const { a: y, b } = i, g = r.mul(b, Ge), { X: x, Y: A, Z: T } = this;
      let C = r.ZERO, I = r.ZERO, P = r.ZERO, j = r.mul(x, x), Q = r.mul(A, A), H = r.mul(T, T), R = r.mul(x, A);
      return R = r.add(R, R), P = r.mul(x, T), P = r.add(P, P), C = r.mul(y, P), I = r.mul(g, H), I = r.add(C, I), C = r.sub(Q, I), I = r.add(Q, I), I = r.mul(C, I), C = r.mul(R, C), P = r.mul(g, P), H = r.mul(y, H), R = r.sub(j, H), R = r.mul(y, R), R = r.add(R, P), P = r.add(j, j), j = r.add(P, j), j = r.add(j, H), j = r.mul(j, R), I = r.add(I, j), H = r.mul(A, T), H = r.add(H, H), j = r.mul(H, R), C = r.sub(C, j), P = r.mul(H, Q), P = r.add(P, P), P = r.add(P, P), new B(C, I, P);
    }
    ...
    add(y) {
      _(y);
      const { X: b, Y: g, Z: x } = this, { X: A, Y: T, Z: C } = y;
      let I = r.ZERO, P = r.ZERO, j = r.ZERO;
      const Q = i.a, H = r.mul(i.b, Ge);
      let R = r.mul(b, A), F = r.mul(g, T), G = r.mul(x, C), ie = r.add(b, g), Z = r.add(A, T);
      ie = r.mul(ie, Z), Z = r.add(R, F), ie = r.sub(ie, Z), Z = r.add(b, x);
      let ee = r.add(A, C);
      return Z = r.mul(Z, ee), ee = r.add(R, G), Z = r.sub(Z, ee), ee = r.add(g, x), I = r.add(T, C), ee = r.mul(ee, I), I = r.add(F, G), ee = r.sub(ee, I), j = r.mul(Q, Z), I = r.mul(H, G), j = r.add(I, j), I = r.sub(F, j), j = r.add(F, j), P = r.mul(I, j), F = r.add(R, R), F = r.add(F, R), G = r.mul(Q, G), Z = r.mul(H, Z), F = r.add(F, G), G = r.sub(R, G), G = r.mul(Q, G), Z = r.add(Z, G), R = r.mul(F, Z), P = r.add(P, R), R = r.mul(ee, Z), I = r.mul(ie, I), I = r.sub(I, R), R = r.mul(ie, F), j = r.mul(ee, j), j = r.add(j, R), new B(I, P, j);
    }
    subtract(y) {
    ...
    multiply(y) {
      ...
      let g, x;
      const A = (T) => ue.cached(this, T, (C) => Tt(B, C));
      if (b) {
        const { k1neg: T, k1: C, k2neg: I, k2: P } = N(y), { p: j, f: Q } = A(C), { p: H, f: R } = A(P);
        x = Q.add(R), g = te(b.beta, j, H, T, I);
      } else {
        const { p: T, f: C } = A(y);
        g = T, x = C;
      }
    ...
    multiplyUnsafe(y) {
      ...
      if (b) {
        const { k1neg: x, k1: A, k2neg: T, k2: C } = N(y), { p1: I, p2: P } = Wi(B, g, A, C);
        return te(b.beta, I, P, x, T);
      } else
        return ue.unsafe(g, y);
    }
    multiplyAndAddUnsafe(y, b, g) {
      const x = this.multiplyUnsafe(b).add(y.multiplyUnsafe(g));
    ...
    isTorsionFree() {
      ...
      return o === Me ? !0 : y ? y(B, this) : ue.unsafe(this, c).is0();
    }
    clearCofactor() {
      const { clearCofactor: y } = t;
      return o === Me ? this : y ? y(B, this) : this.multiplyUnsafe(o);
    }
    isSmallOrder() {
      return this.multiplyUnsafe(o).is0();
    }
    toBytes(y = !0) {
      return gt(y, "isCompressed"), this.assertValidity(), l(B, this, y);
    }
    toHex(y = !0) {
      return Ue(this.toBytes(y));
    }
    toString() {
    ...
    static fromPrivateKey(y) {
      return B.BASE.multiply(Ne(a, y));
    }
  }
  B.BASE = new B(i.Gx, i.Gy, r.ONE), B.ZERO = new B(r.ZERO, r.ONE, r.ZERO), B.Fp = r, B.Fn = a;
  const ne = a.BITS, ue = new Vi(B, t.endo ? Math.ceil(ne / 2) : ne);
...
function eo(e, t = {}) {
  const { Fn: n } = e, r = t.randomBytes || Cr, a = Object.assign(Yr(e.Fp, n), { seed: Fr(n.ORDER) });
  function i(l) {
    try {
      return !!Ne(n, l);
    } catch {
  ...
  function o(l, m) {
    const { publicKey: h, publicKeyUncompressed: v } = a;
    try {
      const S = l.length;
      return m === !0 && S !== h || m === !1 && S !== v ? !1 : !!e.fromBytes(l);
    } catch {
      return !1;
    }
  }
  function c(l = r(a.seed)) {
    return zi(_e(l, a.seed, "seed"), n.ORDER);
  }
  function s(l, m = !0) {
    return e.BASE.multiply(Ne(n, l)).toBytes(m);
  }
  function u(l) {
    const m = c(l);
    return { secretKey: m, publicKey: s(m) };
  }
  function p(l) {
    if (typeof l == "bigint")
      return !1;
    if (l instanceof e)
      return !0;
    const { secretKey: m, publicKey: h, publicKeyUncompressed: v } = a;
    if (n.allowedLengths || m === h)
      return;
    const S = oe("key", l).length;
    return S === h || S === v;
  }
  function f(l, m, h = !0) {
    if (p(l) === !0)
    ...
    const v = Ne(n, l);
    return e.fromHex(m).multiply(v).toBytes(h);
  }
  return Object.freeze({ getPublicKey: s, getSharedSecret: f, keygen: u, Point: e, utils: {
    isValidSecretKey: i,
    isValidPublicKey: o,
    randomSecretKey: c,
    // TODO: remove
    isValidPrivateKey: i,
    randomPrivateKey: c,
    normPrivateKeyToScalar: (l) => Ne(n, l),
...
function to(e, t, n = {}) {
  ...
  const r = n.randomBytes || Cr, a = n.hmac || ((b, ...g) => pi(t, b, we(...g))), { Fp: i, Fn: o } = e, { ORDER: c, BITS: s } = o, { keygen: u, getPublicKey: p, getSharedSecret: f, utils: d, lengths: l } = eo(e, n), m = {
    prehash: !1,
  ...
  function O(b, g) {
    zt(g);
    const x = l.signature, A = g === "compact" ? x : g === "recovered" ? x + 1 : void 0;
    return _e(b, A, `${g} signature`);
  }
  class k {
    constructor(g, x, A) {
      this.r = S("r", g), this.s = S("s", x), A != null && (this.recovery = A), Object.freeze(this);
    }
    static fromBytes(g, x = h) {
      O(g, x);
      let A;
      if (x === "der") {
        const { r: P, s: j } = ge.toSig(_e(g));
        return new k(P, j);
      }
      x === "recovered" && (A = g[0], x = "compact", g = g.subarray(1));
      const T = o.BYTES, C = g.subarray(0, T), I = g.subarray(T, T * 2);
      return new k(o.fromBytes(C), o.fromBytes(I), A);
    }
    static fromHex(g, x) {
      return this.fromBytes(ht(g), x);
    }
    addRecoveryBit(g) {
      return new k(this.r, this.s, g);
    }
    recoverPublicKey(g) {
      const x = i.ORDER, { r: A, s: T, recovery: C } = this;
      if (C == null || ![0, 1, 2, 3].includes(C))
        throw new Error("recovery id invalid");
      if (c * Wr < x && C > 1)
        throw new Error("recovery id is ambiguous for h>1 curve");
      const P = C === 2 || C === 3 ? A + c : A;
      if (!i.isValid(P))
        throw new Error("recovery id 2 or 3 invalid");
      const j = i.toBytes(P), Q = e.fromBytes(we(Jr((C & 1) === 0), j)), H = o.inv(P), R = N(oe("msgHash", g)), F = o.create(-R * H), G = o.create(T * H), ie = e.BASE.multiplyUnsafe(F).add(Q.multiplyUnsafe(G));
      if (ie.is0())
    ...
    toBytes(g = h) {
      if (zt(g), g === "der")
        return ht(ge.hexFromSig(this));
      const x = o.toBytes(this.r), A = o.toBytes(this.s);
      if (g === "recovered") {
        if (this.recovery == null)
          throw new Error("recovery bit must be present");
        return we(Uint8Array.of(this.recovery), x, A);
      }
      return we(x, A);
    }
    toHex(g) {
    ...
    static fromCompact(g) {
      return k.fromBytes(oe("sig", g), "compact");
    }
    static fromDER(g) {
      return k.fromBytes(oe("sig", g), "der");
    }
    normalizeS() {
  ...
  const _ = n.bits2int || function(g) {
    ...
    const x = Et(g), A = g.length * 8 - s;
    return A > 0 ? x >> BigInt(A) : x;
  }, N = n.bits2int_modN || function(g) {
    return o.create(_(g));
  }, $ = Ye(s);
  function ae(b) {
    return ji("num < 2^" + s, b, ye, $), o.toBytes(b);
  }
  function te(b, g) {
    return _e(b, void 0, "message"), g ? _e(t(b), void 0, "prehashed message") : b;
  }
  function B(b, g, x) {
    if (["recovered", "canonical"].some((F) => F in x))
      throw new Error("sign() legacy options not supported");
    const { lowS: A, prehash: T, extraEntropy: C } = Nt(x, m);
    b = te(b, T);
    const I = N(b), P = Ne(o, g), j = [ae(P), ae(I)];
    if (C != null && C !== !1) {
      const F = C === !0 ? r(l.secretKey) : C;
      j.push(oe("extraEntropy", F));
    }
    const Q = we(...j), H = I;
    function R(F) {
      const G = _(F);
      if (!o.isValidNot0(G))
        return;
      const ie = o.inv(G), Z = e.BASE.multiply(G).toAffine(), ee = o.create(Z.x);
      if (ee === ye)
        return;
      const Xe = o.create(ie * o.create(H + ee * P));
      if (Xe === ye)
        return;
      let An = (Z.x === ee ? 0 : 2) | Number(Z.y & Me), _n = Xe;
      return A && v(Xe) && (_n = o.neg(Xe), An ^= 1), new k(ee, _n, An);
    }
    return { seed: Q, k2sig: R };
  }
  function ne(b, g, x = {}) {
    b = oe("message", b);
    const { seed: A, k2sig: T } = B(b, g, x);
    return Ni(t.outputLen, o.BYTES, a)(A, T);
  }
  function ue(b) {
    let g;
    const x = typeof b == "string" || rn(b), A = !x && b !== null && typeof b == "object" && typeof b.r == "bigint" && typeof b.s == "bigint";
    if (!x && !A)
    ...
    if (A)
      ...
      try {
        g = k.fromBytes(oe("sig", b), "der");
      } catch (T) {
        if (!(T instanceof ge.Err))
          throw T;
      }
      if (!g)
        try {
          g = k.fromBytes(oe("sig", b), "compact");
        } catch {
          return !1;
        }
    }
  ...
  function U(b, g, x, A = {}) {
    const { lowS: T, prehash: C, format: I } = Nt(A, m);
    if (x = oe("publicKey", x), g = te(oe("message", g), C), "strict" in A)
      throw new Error("options.strict was renamed to lowS");
    const P = I === void 0 ? ue(b) : k.fromBytes(oe("sig", b), I);
    if (P === !1)
      return !1;
    try {
      const j = e.fromBytes(x);
      if (T && P.hasHighS())
        return !1;
      const { r: Q, s: H } = P, R = N(g), F = o.inv(H), G = o.create(R * F), ie = o.create(Q * F), Z = e.BASE.multiplyUnsafe(G).add(j.multiplyUnsafe(ie));
  ...
  function y(b, g, x = {}) {
    const { prehash: A } = Nt(x, m);
    return g = te(g, A), k.fromBytes(b, "recovered").recoverPublicKey(g).toBytes();
  }
...
function ro(e) {
  const { CURVE: t, curveOpts: n } = no(e), r = {
    hmac: e.hmac,
...
function ao(e, t) {
  ...
  return Object.assign({}, t, {
    ProjectivePoint: n,
    CURVE: Object.assign({}, e, Lr(n.Fn.ORDER, n.Fn.BITS))
  });
}
function io(e) {
  const { CURVE: t, curveOpts: n, hash: r, ecdsaOpts: a } = ro(e), i = $i(t, n), o = to(i, r, a);
  return ao(e, o);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
function un(e, t) {
  const n = (r) => io({ ...e, hash: r });
  return { ...n(t), create: n };
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Xr = {
...
}, oo = Pe(Xr.p), so = Pe(Qr.p), co = Pe(Gr.p), uo = un({ ...Xr, Fp: oo, lowS: !1 }, mi);
un({ ...Qr, Fp: so, lowS: !1 }, hi);
un({ ...Gr, Fp: co, lowS: !1, allowedPrivateKeyLengths: [130, 131, 132] }, gi);
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Ln = uo, lo = "0x5792579257925792579257925792579257925792579257925792579257925792", fo = bi(0, {
  size: 32
});
async function po(e, t) {
  async function n(p) {
    if (p.endsWith(lo.slice(2))) {
      const d = vi(jn(p, -64, -32)), l = jn(p, 0, -64).slice(2).match(/.{1,64}/g), m = await Promise.all(l.map((v) => fo.slice(2) !== v ? e.request({
        method: "eth_getTransactionReceipt",
        params: [`0x${v}`]
      }, { dedupe: !0 }) : void 0)), h = m.some((v) => v === null) ? 100 : m.every((v) => (v == null ? void 0 : v.status) === "0x1") ? 200 : m.every((v) => (v == null ? void 0 : v.status) === "0x0") ? 500 : 600;
      return {
        atomic: !1,
        chainId: Pn(d),
  ...
  const { atomic: r = !1, chainId: a, receipts: i, version: o = "2.0.0", ...c } = await n(t.id), [s, u] = (() => {
    const p = c.status;
    return p >= 100 && p < 200 ? ["pending", p] : p >= 200 && p < 300 ? ["success", p] : p >= 300 && p < 700 ? ["failure", p] : p === "CONFIRMED" ? ["success", 200] : p === "PENDING" ? ["pending", 100] : [void 0, p];
  })();
  return {
    ...c,
    atomic: r,
    // @ts-expect-error: for backwards compatibility
    chainId: a ? Pn(a) : void 0,
    receipts: (i == null ? void 0 : i.map((p) => ({
      ...p,
      blockNumber: Bn(p.blockNumber),
      gasUsed: Bn(p.gasUsed),
      status: yi[p.status]
    }))) ?? [],
    statusCode: u,
    status: s,
...
async function $r(e, t) {
  const { id: n, pollingInterval: r = e.pollingInterval, status: a = ({ statusCode: d }) => d >= 200, timeout: i = 6e4 } = t, o = wi(["waitForCallsStatus", e.uid, n]), { promise: c, resolve: s, reject: u } = Ei();
  let p;
  const f = Si(o, { resolve: s, reject: u }, (d) => {
    const l = xi(async () => {
      const m = (h) => {
        clearTimeout(p), l(), h(), f();
      };
      try {
        const h = await po(e, { id: n });
        if (!a(h))
          return;
        m(() => d.resolve(h));
      } catch (h) {
  ...
  return p = i ? setTimeout(() => {
    f(), clearTimeout(p), u(new mo({ id: n }));
  }, i) : void 0, await c;
}
class mo extends ki {
  constructor({ id: t }) {
...
const ho = "@base-org/account", go = "1.1.1", ea = {
  name: ho,
  version: go
}, bo = "https://keys.coinbase.com/connect", ta = "https://rpc.wallet.coinbase.com", St = ea.name, ze = ea.version;
function na(e, t) {
  let n;
  try {
    n = e();
  ...
  return {
    getItem: (a) => {
      var i;
      const o = (s) => s === null ? null : JSON.parse(s, void 0), c = (i = n.getItem(a)) != null ? i : null;
      return c instanceof Promise ? c.then(o) : o(c);
    },
    setItem: (a, i) => n.setItem(
      a,
...
const Ft = (e) => (t) => {
  ...
  const m = () => {
    ...
    o = !1, c.forEach((O) => {
      var k;
      return O((k = r()) != null ? k : d);
    });
    const S = ((v = i.onRehydrateStorage) == null ? void 0 : v.call(i, (h = r()) != null ? h : d)) || void 0;
    return Ft(u.getItem.bind(u))(i.name).then((O) => {
      if (O)
        if (typeof O.version == "number" && O.version !== i.version) {
          if (i.migrate) {
            ...
            return k instanceof Promise ? k.then((_) => [!0, _]) : [!0, k];
          }
          console.error(
      ...
      S == null || S(l, void 0), l = r(), o = !0, s.forEach((O) => O(l));
    }).catch((O) => {
      S == null || S(void 0, O);
    });
  };
  return a.persist = {
    ...
    onFinishHydration: (h) => (s.add(h), () => {
      s.delete(h);
    })
  }, i.skipHydration || m(), l || d;
}, vo = yo, zn = (e) => {
  let t;
  ...
  }, a = () => t, c = { setState: r, getState: a, getInitialState: () => s, subscribe: (u) => (n.add(u), () => n.delete(u)) }, s = t = e(r, a, c);
  return c;
}, ln = (e) => e ? zn(e) : zn, wo = () => ({
  chains: []
}), Eo = () => ({
...
}), Y = ln(vo((...e) => Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, wo(...e)), Eo(...e)), So(...e)), xo(...e)), Ao(...e)), _o(...e)), ko(...e)), {
  ...
  set: (e, t) => {
    Y.setState((n) => ({ keys: Object.assign(Object.assign({}, n.keys), { [e]: t }) }));
  },
  clear: () => {
    Y.setState({
      keys: {}
  ...
  var e, t, n;
  if (typeof window < "u") {
    const r = (n = (e = w.config.get().deviceId) !== null && e !== void 0 ? e : (t = window.crypto) === null || t === void 0 ? void 0 : t.randomUUID()) !== null && n !== void 0 ? n : "";
    if (window.ClientAnalytics) {
      const { init: a, identify: i, PlatformName: o } = window.ClientAnalytics;
      a({
        isProd: !0,
      ...
      }), i({ deviceId: r }), w.config.set({ deviceId: r });
    }
  }
}, Mo = "0xba5ed110efdba3d005bfc882d75358acbbb85842", aa = "0xf85210B21cC50302F477BA56686d2019dC9b67Ad", me = [
...
}, oa = "Unspecified error message.", Ko = "Unspecified server error.";
function dn(e, t = oa) {
...
function qo(e, { shouldIncludeStack: t = !1 } = {}) {
  const n = {};
  if (e && typeof e == "object" && !Array.isArray(e) && Vt(e, "code") && Do(e.code)) {
    const r = e;
    n.code = r.code, r.message && typeof r.message == "string" ? (n.message = r.message, Vt(r, "data") && (n.data = r.data)) : (n.message = dn(n.code), n.data = { originalError: Fn(e) });
  } else
    n.code = W.rpc.internal, n.message = Zn(e, "message") ? e.message : oa, n.data = { originalError: Fn(e) };
...
const E = {
  rpc: {
    parse: (e) => le(W.rpc.parse, e),
    invalidRequest: (e) => le(W.rpc.invalidRequest, e),
    invalidParams: (e) => le(W.rpc.invalidParams, e),
    methodNotFound: (e) => le(W.rpc.methodNotFound, e),
    internal: (e) => le(W.rpc.internal, e),
    server: (e) => {
    ...
    invalidInput: (e) => le(W.rpc.invalidInput, e),
    resourceNotFound: (e) => le(W.rpc.resourceNotFound, e),
    resourceUnavailable: (e) => le(W.rpc.resourceUnavailable, e),
    transactionRejected: (e) => le(W.rpc.transactionRejected, e),
    methodNotSupported: (e) => le(W.rpc.methodNotSupported, e),
    limitExceeded: (e) => le(W.rpc.limitExceeded, e)
  },
  provider: {
    userRejectedRequest: (e) => Be(W.provider.userRejectedRequest, e),
    unauthorized: (e) => Be(W.provider.unauthorized, e),
    unsupportedMethod: (e) => Be(W.provider.unsupportedMethod, e),
    disconnected: (e) => Be(W.provider.disconnected, e),
    chainDisconnected: (e) => Be(W.provider.chainDisconnected, e),
    unsupportedChain: (e) => Be(W.provider.unsupportedChain, e),
    custom: (e) => {
      if (!e || typeof e != "object" || Array.isArray(e))
...
function le(e, t) {
  const [n, r] = ca(t);
  return new fn(e, n || dn(e), r);
}
function Be(e, t) {
  const [n, r] = ca(t);
  return new ua(e, n || dn(e), r);
}
function ca(e) {
  if (e) {
    if (typeof e == "string")
...
function Lo(e) {
  try {
    ...
    return new fn(t.code, t.message, t.data);
  } catch {
    return null;
  }
}
...
const zo = `Base Account SDK requires the Cross-Origin-Opener-Policy header to not be set to 'same-origin'. This is to ensure that the SDK can communicate with the Base Account app.

Please see https://docs.base.org/smart-wallet/quickstart#cross-origin-opener-policy for more information.`, Fo = () => {
  let e;
  return {
    ...
    checkCrossOriginOpenerPolicy: async () => {
      ...
      try {
        ...
        e = r ?? "null", e === "same-origin" && console.error(zo);
      } catch (t) {
        console.error("Error checking Cross-Origin-Opener-Policy:", t.message), e = "error";
      }
    }
  };
}, { checkCrossOriginOpenerPolicy: Zo, getCrossOriginOpenerPolicy: Vo } = Fo();
function Wo(e) {
  if (e) {
...
function z(e, t, n) {
  var r, a, i;
  window.ClientAnalytics && ((r = window.ClientAnalytics) === null || r === void 0 || r.logEvent(e, Object.assign(Object.assign({}, t), { sdkVersion: ze, sdkName: St, appName: (i = (a = w.config.get().metadata) === null || a === void 0 ? void 0 : a.appName) !== null && i !== void 0 ? i : "", appOrigin: window.location.origin }), n));
}
const Jo = () => {
  z("communicator.popup_setup.started", {
    action: D.unknown,
    componentType: K.unknown
  }, q.high);
}, Yo = () => {
  z("communicator.popup_setup.completed", {
    action: D.unknown,
    componentType: K.unknown
  }, q.high);
}, Xo = () => {
  z("communicator.popup_unload.received", {
    action: D.unknown,
    componentType: K.unknown
  }, q.high);
}, pn = ({ dialogContext: e }) => {
  z(`dialog.${e}.shown`, {
    action: D.render,
    componentType: K.modal,
    dialogContext: e
  }, q.high);
}, da = ({ dialogContext: e }) => {
  z(`dialog.${e}.dismissed`, {
    action: D.dismiss,
    componentType: K.modal,
    dialogContext: e
  }, q.high);
}, Ce = ({ dialogContext: e, dialogAction: t }) => {
  z(`dialog.${e}.action_clicked`, {
    action: D.click,
    componentType: K.button,
    dialogContext: e,
    dialogAction: t
  }, q.high);
}, Qo = `
...
`, Jn = "BaseSans-Regular";
function Go() {
  if (document.head.querySelector(`style[base-sdk-font="${Jn}"]`))
    return;
  const t = document.createElement("style");
  t.setAttribute("base-sdk-font", Jn), t.textContent = Qo, document.head.appendChild(t);
}
var xt, M, fa, Ae, Yn, pa, Wt, mn, Jt, Yt, We = {}, ma = [], $o = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, hn = Array.isArray;
function Ee(e, t) {
...
function ga(e, t, n) {
  ...
  if (arguments.length > 2 && (o.children = arguments.length > 3 ? xt.call(arguments, 2) : n), typeof e == "function" && e.defaultProps != null) for (i in e.defaultProps) o[i] === void 0 && (o[i] = e.defaultProps[i]);
  return lt(e, o, r, a, null);
}
function lt(e, t, n, r, a) {
  var i = { type: e, props: t, key: n, ref: r, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: a ?? ++fa, __i: -1, __u: 0 };
...
function Xn(e) {
  (!e.__d && (e.__d = !0) && Ae.push(e) && !yt.__r++ || Yn !== M.debounceRendering) && ((Yn = M.debounceRendering) || pa)(yt);
}
function yt() {
  var e, t, n, r, a, i, o, c;
  for (Ae.sort(Wt); e = Ae.shift(); ) e.__d && (t = Ae.length, r = void 0, i = (a = (n = e).__v).__e, o = [], c = [], n.__P && ((r = Ee({}, a)).__v = a.__v + 1, M.vnode && M.vnode(r), gn(n.__P, r, a, n.__n, n.__P.namespaceURI, 32 & a.__u ? [i] : null, o, i ?? De(a), !!(32 & a.__u), c), r.__v = a.__v, r.__.__k[r.__i] = r, wa(o, r, c), r.__e != i && ba(r)), Ae.length > t && Ae.sort(Wt));
  yt.__r = 0;
}
function ya(e, t, n, r, a, i, o, c, s, u, p) {
  var f, d, l, m, h, v = r && r.__k || ma, S = t.length;
  for (n.__d = s, es(n, t, v), s = n.__d, f = 0; f < S; f++) (l = n.__k[f]) != null && (d = l.__i === -1 ? We : v[l.__i] || We, l.__i = f, gn(e, l, d, a, i, o, c, s, u, p), m = l.__e, l.ref && d.ref != l.ref && (d.ref && bn(d.ref, null, l), p.push(l.ref, l.__c || m, l)), h == null && m != null && (h = m), 65536 & l.__u || d.__k === l.__k ? s = va(l, s, e) : typeof l.type == "function" && l.__d !== void 0 ? s = l.__d : m && (s = m.nextSibling), l.__d = void 0, l.__u &= -196609);
  n.__d = s, n.__e = h;
}
function es(e, t, n) {
  var r, a, i, o, c, s = t.length, u = n.length, p = u, f = 0;
  for (e.__k = [], r = 0; r < s; r++) (a = t[r]) != null && typeof a != "boolean" && typeof a != "function" ? (o = r + f, (a = e.__k[r] = typeof a == "string" || typeof a == "number" || typeof a == "bigint" || a.constructor == String ? lt(null, a, null, null, null) : hn(a) ? lt(kt, { children: a }, null, null, null) : a.constructor === void 0 && a.__b > 0 ? lt(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v) : a).__ = e, a.__b = e.__b + 1, i = null, (c = a.__i = ts(a, n, o, p)) !== -1 && (p--, (i = n[c]) && (i.__u |= 131072)), i == null || i.__v === null ? (c == -1 && f--, typeof a.type != "function" && (a.__u |= 65536)) : c !== o && (c == o - 1 ? f-- : c == o + 1 ? f++ : (c > o ? f-- : f++, a.__u |= 65536))) : a = e.__k[r] = null;
  if (p) for (r = 0; r < u; r++) (i = n[r]) != null && !(131072 & i.__u) && (i.__e == e.__d && (e.__d = De(i)), Ea(i, i));
}
function va(e, t, n) {
  var r, a;
  if (typeof e.type == "function") {
    for (r = e.__k, a = 0; r && a < r.length; a++) r[a] && (r[a].__ = e, t = va(r[a], t, n));
    return t;
  }
  e.__e != t && (t && e.type && !n.contains(t) && (t = De(e)), n.insertBefore(e.__e, t || null), t = e.__e);
  do
    t = t && t.nextSibling;
...
function ts(e, t, n, r) {
  var a = e.key, i = e.type, o = n - 1, c = n + 1, s = t[n];
  if (s === null || s && a == s.key && i === s.type && !(131072 & s.__u)) return n;
  if (r > (s != null && !(131072 & s.__u) ? 1 : 0)) for (; o >= 0 || c < t.length; ) {
    if (o >= 0) {
      if ((s = t[o]) && !(131072 & s.__u) && a == s.key && i === s.type) return o;
      o--;
    }
    if (c < t.length) {
      if ((s = t[c]) && !(131072 & s.__u) && a == s.key && i === s.type) return c;
      c++;
    }
  }
  return -1;
...
function $e(e, t, n, r, a) {
  ...
  e: if (t === "style") if (typeof n == "string") e.style.cssText = n;
    ...
    if (typeof r == "string" && (e.style.cssText = r = ""), r) for (t in r) n && t in n || Qn(e.style, t, "");
    if (n) for (t in n) r && n[t] === r[t] || Qn(e.style, t, n[t]);
  }
  else if (t[0] === "o" && t[1] === "n") i = t !== (t = t.replace(/(PointerCapture)$|Capture$/i, "$1")), t = t.toLowerCase() in e || t === "onFocusOut" || t === "onFocusIn" ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + i] = n, n ? r ? n.u = r.u : (n.u = mn, e.addEventListener(t, i ? Yt : Jt, i)) : e.removeEventListener(t, i ? Yt : Jt, i);
  else {
...
function gn(e, t, n, r, a, i, o, c, s, u) {
  var p, f, d, l, m, h, v, S, O, k, _, N, $, ae, te, B, ne = t.type;
  if (t.constructor !== void 0) return null;
  128 & n.__u && (s = !!(32 & n.__u), i = [c = t.__e = n.__e]), (p = M.__b) && p(t);
  e: if (typeof ne == "function") try {
    if (S = t.props, O = "prototype" in ne && ne.prototype.render, k = (p = ne.contextType) && r[p.__c], _ = p ? k ? k.props.value : p.__ : r, n.__c ? v = (f = t.__c = n.__c).__ = f.__E : (O ? t.__c = f = new ne(S, _) : (t.__c = f = new dt(S, _), f.constructor = ne, f.render = rs), k && k.sub(f), f.props = S, f.state || (f.state = {}), f.context = _, f.__n = r, d = f.__d = !0, f.__h = [], f._sb = []), O && f.__s == null && (f.__s = f.state), O && ne.getDerivedStateFromProps != null && (f.__s == f.state && (f.__s = Ee({}, f.__s)), Ee(f.__s, ne.getDerivedStateFromProps(S, f.__s))), l = f.props, m = f.state, f.__v = t, d) O && ne.getDerivedStateFromProps == null && f.componentWillMount != null && f.componentWillMount(), O && f.componentDidMount != null && f.__h.push(f.componentDidMount);
    else {
      if (O && ne.getDerivedStateFromProps == null && S !== l && f.componentWillReceiveProps != null && f.componentWillReceiveProps(S, _), !f.__e && (f.shouldComponentUpdate != null && f.shouldComponentUpdate(S, f.__s, _) === !1 || t.__v === n.__v)) {
        for (t.__v !== n.__v && (f.props = S, f.state = f.__s, f.__d = !1), t.__e = n.__e, t.__k = n.__k, t.__k.some(function(ue) {
          ue && (ue.__ = t);
        }), N = 0; N < f._sb.length; N++) f.__h.push(f._sb[N]);
        f._sb = [], f.__h.length && o.push(f);
        break e;
      }
      f.componentWillUpdate != null && f.componentWillUpdate(S, f.__s, _), O && f.componentDidUpdate != null && f.__h.push(function() {
        f.componentDidUpdate(l, m, h);
      });
    }
    if (f.context = _, f.props = S, f.__P = e, f.__e = !1, $ = M.__r, ae = 0, O) {
      for (f.state = f.__s, f.__d = !1, $ && $(t), p = f.render(f.props, f.state, f.context), te = 0; te < f._sb.length; te++) f.__h.push(f._sb[te]);
      f._sb = [];
    } else do
      f.__d = !1, $ && $(t), p = f.render(f.props, f.state, f.context), f.state = f.__s;
    while (f.__d && ++ae < 25);
    f.state = f.__s, f.getChildContext != null && (r = Ee(Ee({}, r), f.getChildContext())), O && !d && f.getSnapshotBeforeUpdate != null && (h = f.getSnapshotBeforeUpdate(l, m)), ya(e, hn(B = p != null && p.type === kt && p.key == null ? p.props.children : p) ? B : [B], t, n, r, a, i, o, c, s, u), f.base = t.__e, t.__u &= -161, f.__h.length && o.push(f), v && (f.__E = f.__ = null);
  } catch (ue) {
    if (t.__v = null, s || i != null) {
      for (t.__u |= s ? 160 : 32; c && c.nodeType === 8 && c.nextSibling; ) c = c.nextSibling;
      i[i.indexOf(c)] = null, t.__e = c;
    } else t.__e = n.__e, t.__k = n.__k;
    M.__e(ue, t, n);
  }
  else i == null && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = ns(n.__e, t, n, r, a, i, o, s, u);
  (p = M.diffed) && p(t);
}
function wa(e, t, n) {
  t.__d = void 0;
  for (var r = 0; r < n.length; r++) bn(n[r], n[++r], n[++r]);
...
function ns(e, t, n, r, a, i, o, c, s) {
  var u, p, f, d, l, m, h, v = n.props, S = t.props, O = t.type;
  if (O === "svg" ? a = "http://www.w3.org/2000/svg" : O === "math" ? a = "http://www.w3.org/1998/Math/MathML" : a || (a = "http://www.w3.org/1999/xhtml"), i != null) {
    for (u = 0; u < i.length; u++) if ((l = i[u]) && "setAttribute" in l == !!O && (O ? l.localName === O : l.nodeType === 3)) {
      e = l, i[u] = null;
      break;
    }
  }
  if (e == null) {
    if (O === null) return document.createTextNode(S);
    e = document.createElementNS(a, O, S.is && S), c && (M.__m && M.__m(t, i), c = !1), i = null;
  }
  if (O === null) v === S || c && e.data === S || (e.data = S);
  else {
    if (i = i && xt.call(e.childNodes), v = n.props || We, !c && i != null) for (v = {}, u = 0; u < e.attributes.length; u++) v[(l = e.attributes[u]).name] = l.value;
    for (u in v) if (l = v[u], u != "children") {
    ...
    for (u in S) l = S[u], u == "children" ? d = l : u == "dangerouslySetInnerHTML" ? p = l : u == "value" ? m = l : u == "checked" ? h = l : c && typeof l != "function" || v[u] === l || $e(e, u, l, v[u], a);
    if (p) c || f && (p.__html === f.__html || p.__html === e.innerHTML) || (e.innerHTML = p.__html), t.__k = [];
    else if (f && (e.innerHTML = ""), ya(e, hn(d) ? d : [d], t, n, r, O === "foreignObject" ? "http://www.w3.org/1999/xhtml" : a, i, o, i ? i[0] : n.__k && De(n, 0), c, s), i != null) for (u = i.length; u--; ) ha(i[u]);
    c || (u = "value", O === "progress" && m == null ? e.removeAttribute("value") : m !== void 0 && (m !== e[u] || O === "progress" && !m || O === "option" && m !== v[u]) && $e(e, u, m, v[u], a), u = "checked", h !== void 0 && h !== e[u] && $e(e, u, h, v[u], a));
  }
  return e;
}
function bn(e, t, n) {
...
function Ea(e, t, n) {
  var r, a;
  if (M.unmount && M.unmount(e), (r = e.ref) && (r.current && r.current !== e.__e || bn(r, null, t)), (r = e.__c) != null) {
  ...
  if (r = e.__k) for (a = 0; a < r.length; a++) r[a] && Ea(r[a], t, n || typeof e.type != "function");
  n || ha(e.__e), e.__c = e.__ = e.__e = e.__d = void 0;
}
function rs(e, t, n) {
...
function $n(e, t, n) {
  var r, a, i, o;
  M.__ && M.__(e, t), a = (r = !1) ? null : t.__k, i = [], o = [], gn(t, e = t.__k = ga(kt, null, [e]), a || We, We, t.namespaceURI, a ? null : t.firstChild ? xt.call(t.childNodes) : null, i, a ? a.__e : t.firstChild, r, o), wa(i, e, o);
}
xt = ma.slice, M = { __e: function(e, t, n, r) {
  for (var a, i, o; t = t.__; ) if ((a = t.__c) && !a.__) try {
    if ((i = a.constructor) && i.getDerivedStateFromError != null && (a.setState(i.getDerivedStateFromError(e)), o = a.__d), a.componentDidCatch != null && (a.componentDidCatch(e, r || {}), o = a.__d), o) return a.__E = a;
  } catch (c) {
    e = c;
  }
  throw e;
} }, fa = 0, dt.prototype.setState = function(e, t) {
  var n;
  n = this.__s != null && this.__s !== this.state ? this.__s : this.__s = Ee({}, this.state), typeof e == "function" && (e = e(Ee({}, n), this.props)), e && Ee(n, e), e != null && this.__v && (t && this._sb.push(t), Xn(this));
}, dt.prototype.forceUpdate = function(e) {
  this.__v && (this.__e = !0, e && this.__h.push(e), Xn(this));
}, dt.prototype.render = kt, Ae = [], pa = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Wt = function(e, t) {
  return e.__v.__b - t.__v.__b;
}, yt.__r = 0, mn = 0, Jt = Gn(!1), Yt = Gn(!0);
var as = 0;
function V(e, t, n, r, a, i) {
  t || (t = {});
  var o, c, s = t;
  "ref" in t && (o = t.ref, delete t.ref);
  var u = { type: e, props: s, key: n, ref: o, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: --as, __i: -1, __u: 0, __source: a, __self: i };
  if (typeof e == "function" && (o = e.defaultProps)) for (c in o) s[c] === void 0 && (s[c] = o[c]);
...
function ls(e, t, n) {
  ...
  if (r.t = e, !r.__c && (r.__ = [ka(void 0, t), function(c) {
    ...
    var a = function(c, s, u) {
      ...
      }), !(!f && r.__c.props === c) && (!i || i.call(this, c, s, u));
    };
    J.u = !0;
    var i = J.shouldComponentUpdate, o = J.componentWillUpdate;
    J.componentWillUpdate = function(c, s, u) {
      if (this.__e) {
        var p = i;
        i = void 0, a(c, s, u), i = p;
      }
      o && o.call(this, c, s, u);
...
function Qt(e, t) {
  var n = yn(Je++, 3);
  !X.__s && xa(n.__H, t) && (n.__ = e, n.i = t, J.__H.__h.push(n));
}
function ds(e, t) {
  var n = yn(Je++, 7);
  return xa(n.__H, t) && (n.__ = e(), n.__H = t, n.__h = e), n.__;
}
function fs() {
  for (var e; e = Sa.shift(); ) if (e.__P && e.__H) try {
    e.__H.__h.forEach(ft), e.__H.__h.forEach(Gt), e.__H.__h = [];
  } catch (t) {
...
X.__b = function(e) {
  ...
  nr && nr(e), Je = 0;
  var t = (J = e.__c).__H;
  t && (Rt === J ? (t.__h = [], J.__h = [], t.__.forEach(function(n) {
    n.__N && (n.__ = n.__N), n.i = n.__N = void 0;
  })) : (t.__h.forEach(ft), t.__h.forEach(Gt), t.__h = [], Je = 0)), Rt = J;
}, X.diffed = function(e) {
  rr && rr(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (Sa.push(t) !== 1 && er === X.requestAnimationFrame || ((er = X.requestAnimationFrame) || ps)(fs)), t.__H.__.forEach(function(n) {
...
function ps(e) {
  var t, n = function() {
    clearTimeout(r), sr && cancelAnimationFrame(t), setTimeout(e);
  }, r = setTimeout(n, 100);
  sr && (t = requestAnimationFrame(n));
}
function ft(e) {
  var t = J, n = e.__c;
...
const gs = () => {
  ...
  }, []), e ? V("div", { class: "-base-acc-sdk-dialog-handle-bar" }) : null;
};
class bs {
  constructor() {
    this.items = /* @__PURE__ */ new Map(), this.nextItemKey = 0, this.root = null;
  }
  attach(t) {
    this.root = document.createElement("div"), this.root.className = "-base-acc-sdk-dialog-root", t.appendChild(this.root), this.render();
  }
  presentItem(t) {
    const n = this.nextItemKey++;
    this.items.set(n, t), this.render();
  }
  clear() {
    this.items.clear(), this.root && $n(null, this.root);
  }
  render() {
    this.root && $n(V("div", { children: V(ys, { children: Array.from(this.items.entries()).map(([t, n]) => ga(vs, Object.assign({}, n, { key: t, handleClose: () => {
      var r;
      this.clear(), (r = n.onClose) === null || r === void 0 || r.call(n);
    } }))) }) }), this.root);
  }
}
const ys = (e) => {
  const [t, n] = Te(0), [r, a] = Te(!1), [i, o] = Te(0), c = (p) => {
    if (!Aa())
      return;
    const f = p.touches[0];
    o(f.clientY), a(!0);
    ...
    if (!r)
      return;
    const d = p.touches[0].clientY - i;
    d > 0 && (n(d), p.preventDefault());
  }, u = () => {
    if (r)
      if (a(!1), t > 100) {
        const p = document.querySelector(".-base-acc-sdk-dialog-instance-header-close");
        p && p.click();
      } else
        n(0);
  };
  return V("div", { class: Ht("-base-acc-sdk-dialog-container"), children: [V("style", { children: ms }), V("div", { class: "-base-acc-sdk-dialog-backdrop", onTouchStart: c, onTouchMove: s, onTouchEnd: u, children: V("div", { class: "-base-acc-sdk-dialog", style: {
    transform: `translateY(${t}px)`,
    transition: r ? "none" : "transform 0.2s ease-out"
  }, children: [V(gs, {}), e.children] }) })] });
}, vs = ({ title: e, message: t, actionItems: n, handleClose: r }) => {
  const [a, i] = Te(!0), [o, c] = Te(!0), [s, u] = Te(null);
  Qt(() => {
    ...
    (async () => {
      var l;
      const m = (l = w.account.get().accounts) === null || l === void 0 ? void 0 : l[0];
      if (m) {
        const h = await is(m);
        u(h);
      }
  ...
  const p = ds(() => s ? `Signed in as ${s}` : "Base Account", [s]), f = !o;
  return V("div", { class: Ht("-base-acc-sdk-dialog-instance", a && "-base-acc-sdk-dialog-instance-hidden"), children: [V("div", { class: "-base-acc-sdk-dialog-instance-header", children: [V("div", { class: "-base-acc-sdk-dialog-instance-header-icon-and-title", children: [V(us, { fill: "blue" }), f && V("div", { class: "-base-acc-sdk-dialog-instance-header-icon-and-title-title", children: p })] }), V("div", { class: "-base-acc-sdk-dialog-instance-header-close", onClick: r, children: V("img", { src: hs, class: "-base-acc-sdk-dialog-instance-header-close-icon" }) })] }), V("div", { class: "-base-acc-sdk-dialog-instance-content", children: [V("div", { class: "-base-acc-sdk-dialog-instance-content-title", children: e }), V("div", { class: "-base-acc-sdk-dialog-instance-content-message", children: t })] }), n && n.length > 0 && V("div", { class: "-base-acc-sdk-dialog-instance-actions", children: n.map((d, l) => V("button", { class: Ht("-base-acc-sdk-dialog-instance-button", d.variant === "primary" && "-base-acc-sdk-dialog-instance-button-primary", d.variant === "secondary" && "-base-acc-sdk-dialog-instance-button-secondary"), onClick: d.onClick, children: d.text }, l)) })] });
};
let et = null;
function vn() {
  if (!et) {
    const e = document.createElement("div");
    e.className = "-base-acc-sdk-css-reset", document.body.appendChild(e), et = new bs(), et.attach(e);
  }
  return Go(), et;
}
const cr = 420, ur = 700, ws = "{app} wants to continue in Base Account", Es = "This action requires your permission to open a new window.";
function Ss(e) {
  const t = (window.innerWidth - cr) / 2 + window.screenX, n = (window.innerHeight - ur) / 2 + window.screenY;
  ks(e);
  function r() {
    const i = `wallet_${crypto.randomUUID()}`, o = window.open(e, i, `width=${cr}, height=${ur}, left=${t}, top=${n}`);
    return o == null || o.focus(), o || null;
  }
  const a = r();
  return a ? Promise.resolve(a) : As(r);
}
function xs(e) {
  e && !e.closed && e.close();
}
...
function As(e) {
  var t, n;
  const r = (n = (t = w.config.get().metadata) === null || t === void 0 ? void 0 : t.appName) !== null && n !== void 0 ? n : "App", a = vn();
  return new Promise((i, o) => {
    pn({ dialogContext: "popup_blocked" }), a.presentItem({
      title: ws.replace("{app}", r),
      message: Es,
      onClose: () => {
        Ce({
          dialogContext: "popup_blocked",
          dialogAction: "cancel"
        }), o(E.rpc.internal("Popup window was blocked"));
      },
      actionItems: [
        {
          text: "Try again",
          ...
          onClick: () => {
            ...
            const c = e();
            c ? i(c) : o(E.rpc.internal("Popup window was blocked")), a.clear();
          }
        },
        {
          text: "Cancel",
          ...
          onClick: () => {
            Ce({
              dialogContext: "popup_blocked",
              dialogAction: "cancel"
            }), o(E.rpc.internal("Popup window was blocked")), a.clear();
          }
        }
      ]
    });
...
class _s {
  constructor({ url: t = bo, metadata: n, preference: r }) {
    this.popup = null, this.listeners = /* @__PURE__ */ new Map(), this.postMessage = async (a) => {
      (await this.waitForPopupLoaded()).postMessage(a, this.url.origin);
    }, this.postRequestAndWaitForResponse = async (a) => {
      const i = this.onMessage(({ requestId: o }) => o === a.id);
      return this.postMessage(a), await i;
    }, this.onMessage = async (a) => new Promise((i, o) => {
      const c = (s) => {
        if (s.origin !== this.url.origin)
          return;
        const u = s.data;
        a(u) && (i(u), window.removeEventListener("message", c), this.listeners.delete(c));
      };
      window.addEventListener("message", c), this.listeners.set(c, { reject: o });
    }), this.disconnect = () => {
      xs(this.popup), this.popup = null, this.listeners.forEach(({ reject: a }, i) => {
        a(E.provider.userRejectedRequest("Request rejected")), window.removeEventListener("message", i);
      }), this.listeners.clear();
    }, this.waitForPopupLoaded = async () => this.popup && !this.popup.closed ? (this.popup.focus(), this.popup) : (Jo(), this.popup = await Ss(this.url), this.onMessage(({ event: a }) => a === "PopupUnload").then(() => {
      this.disconnect(), Xo();
    }).catch(() => {
    }), this.onMessage(({ event: a }) => a === "PopupLoaded").then((a) => {
      this.postMessage({
        requestId: a.id,
        data: {
          version: ze,
      ...
      if (!this.popup)
        throw E.rpc.internal();
      return Yo(), this.popup;
...
function Is(e) {
  ...
  return n.searchParams.set("version", ze), n.searchParams.set("code", t.code.toString()), n.searchParams.set("message", t.message), Object.assign(Object.assign({}, t), { docUrl: n.href });
}
function Os(e) {
...
function Cs(e) {
  ...
  if (Os(e)) {
    const n = e.errorMessage, r = (t = e.errorCode) !== null && t !== void 0 ? t : n.match(/(denied|rejected)/i) ? W.provider.userRejectedRequest : void 0;
...
const Ps = ({ method: e, correlationId: t }) => {
  z("provider.request.started", {
    action: D.unknown,
    componentType: K.unknown,
    method: e,
...
}, Bs = ({ method: e, correlationId: t, errorMessage: n }) => {
  z("provider.request.error", {
    action: D.error,
    componentType: K.unknown,
    method: e,
    signerType: "base-account",
...
}, js = ({ method: e, correlationId: t }) => {
  z("provider.request.responded", {
    action: D.unknown,
    componentType: K.unknown,
    method: e,
    signerType: "base-account",
...
function Ia(e) {
  return vt(`0x${BigInt(e).toString(16)}`);
}
function Ks(e) {
  return e.startsWith("0x") || e.startsWith("0X");
}
function Oa(e) {
  return Ks(e) ? e.slice(2) : e;
}
function Ds(e) {
  if (typeof e != "string")
    return !1;
...
function qs(e, t = !1) {
  let n = $t(e, !1);
  return n.length % 2 === 1 && (n = vt(`0${n}`)), t ? vt(`0x${n}`) : n;
}
function Hs(e) {
  ...
  if (typeof e == "string") {
    if (Rs.test(e))
      return Ut(Number(e));
    if (Ds(e))
      return Ut(Number(BigInt(qs(e, !0))));
  }
  throw E.rpc.invalidParams(`Not an integer: ${String(e)}`);
}
const Ls = ({ method: e, correlationId: t }) => {
  var n;
  z("scw_signer.handshake.started", {
    ...
    method: e,
    correlationId: t,
    enableAutoSubAccounts: (n = w.subAccountsConfig.get()) === null || n === void 0 ? void 0 : n.enableAutoSubAccounts
  }, q.high);
}, zs = ({ method: e, correlationId: t, errorMessage: n }) => {
  var r;
  z("scw_signer.handshake.error", {
    action: D.error,
    componentType: K.unknown,
    method: e,
    correlationId: t,
    errorMessage: n,
    enableAutoSubAccounts: (r = w.subAccountsConfig.get()) === null || r === void 0 ? void 0 : r.enableAutoSubAccounts
  }, q.high);
}, Fs = ({ method: e, correlationId: t }) => {
  var n;
  z("scw_signer.handshake.completed", {
    action: D.unknown,
    componentType: K.unknown,
    method: e,
    correlationId: t,
...
}, Zs = ({ method: e, correlationId: t }) => {
  var n;
  z("scw_signer.request.started", {
    action: D.unknown,
    componentType: K.unknown,
    method: e,
    correlationId: t,
...
}, Vs = ({ method: e, correlationId: t, errorMessage: n }) => {
  var r;
  z("scw_signer.request.error", {
    action: D.error,
    componentType: K.unknown,
    method: e,
    correlationId: t,
...
}, Ws = ({ method: e, correlationId: t }) => {
  var n;
  z("scw_signer.request.completed", {
    action: D.unknown,
    componentType: K.unknown,
    method: e,
    correlationId: t,
  ...
  var n;
  z("scw_sub_account.request.started", {
    action: D.unknown,
    componentType: K.unknown,
    method: e,
    correlationId: t,
...
}, Ys = ({ method: e, correlationId: t }) => {
  var n;
  z("scw_sub_account.request.completed", {
    action: D.unknown,
    componentType: K.unknown,
    method: e,
    correlationId: t,
...
}, Xs = ({ method: e, correlationId: t, errorMessage: n }) => {
  var r;
  z("scw_sub_account.request.error", {
    action: D.error,
    componentType: K.unknown,
    method: e,
    correlationId: t,
...
}, Qs = ({ method: e, correlationId: t }) => {
  var n;
  z("scw_sub_account.add_owner.started", {
    action: D.unknown,
    componentType: K.unknown,
    method: e,
    correlationId: t,
...
}, Gs = ({ method: e, correlationId: t }) => {
  var n;
  z("scw_sub_account.add_owner.completed", {
    action: D.unknown,
    componentType: K.unknown,
    method: e,
    correlationId: t,
...
}, $s = ({ method: e, correlationId: t, errorMessage: n }) => {
  var r;
  z("scw_sub_account.add_owner.error", {
    action: D.error,
    componentType: K.unknown,
    method: e,
    correlationId: t,
...
}, ec = ({ method: e, correlationId: t }) => {
  var n;
  z("scw_sub_account.insufficient_balance.error_handling.started", {
    action: D.unknown,
    componentType: K.unknown,
    method: e,
    correlationId: t,
  ...
  var n;
  z("scw_sub_account.insufficient_balance.error_handling.completed", {
    action: D.unknown,
    componentType: K.unknown,
    method: e,
    correlationId: t,
...
}, nc = ({ method: e, correlationId: t, errorMessage: n }) => {
  var r;
  z("scw_sub_account.insufficient_balance.error_handling.error", {
    action: D.error,
    componentType: K.unknown,
    method: e,
    correlationId: t,
...
}, Fe = (e) => "message" in e && typeof e.message == "string" ? e.message : "", Ca = ln(() => ({}));
function lr(e) {
  e.forEach((t) => {
    var n, r, a, i, o, c, s, u;
    if (!t.rpcUrl)
    ...
    const p = Ga({
      ...
      nativeCurrency: {
        name: (i = (a = t.nativeCurrency) === null || a === void 0 ? void 0 : a.name) !== null && i !== void 0 ? i : "",
        symbol: (c = (o = t.nativeCurrency) === null || o === void 0 ? void 0 : o.symbol) !== null && c !== void 0 ? c : "",
        decimals: (u = (s = t.nativeCurrency) === null || s === void 0 ? void 0 : s.decimal) !== null && u !== void 0 ? u : 18
      }
    }), f = $a({
      chain: p,
      transport: In(t.rpcUrl)
    }), d = Ai({
      client: f,
      transport: In(t.rpcUrl)
    });
...
function Ta(e) {
  var t;
  return (t = Ca.getState()[e]) === null || t === void 0 ? void 0 : t.client;
}
const tt = ln(() => ({
  correlationIds: /* @__PURE__ */ new Map()
})), be = {
  get: (e) => tt.getState().correlationIds.get(e),
  set: (e, t) => {
    tt.setState((n) => {
...
function nt(e) {
  ...
  if (!("address" in e))
    throw E.rpc.internal("sub account is invalid");
  if ("address" in e && typeof e.address == "string" && !mt(e.address))
    throw E.rpc.internal("sub account address is invalid");
  if ("factory" in e && typeof e.factory == "string" && !mt(e.factory))
    throw E.rpc.internal("sub account factory address is invalid");
  if ("factoryData" in e && typeof e.factoryData == "string" && !je(e.factoryData))
...
async function oc(e, { iv: t, cipherText: n }) {
...
async function Ba(e, t) {
  const n = Pa(e), r = await crypto.subtle.exportKey(n, t);
  return Us(new Uint8Array(r));
}
async function ja(e, t) {
  const n = Pa(e), r = Ms(t).buffer;
...
async function cc(e, t) {
  return JSON.parse(await oc(t, e));
}
...
class L extends Error {
  constructor(t, n = {}) {
    const r = (() => {
      ...
      return (s = n.cause) != null && s.message ? n.cause.message : n.details;
    })(), a = n.cause instanceof L && n.cause.docsPath || n.docsPath, o = `https://oxlib.sh${a ?? ""}`, c = [
      t || "An error occurred.",
...
function Na(e, t) {
  return t != null && t(e) ? e : e && typeof e == "object" && "cause" in e && e.cause ? Na(e.cause, t) : t ? null : e;
}
const fc = "#__bigint";
function At(e, t, n) {
  return JSON.stringify(e, (r, a) => typeof a == "bigint" ? a.toString() + fc : a, n);
}
function pc(e, t) {
  if (He(e) > t)
    throw new Cc({
...
function mc(e, t) {
  if (typeof t == "number" && t > 0 && t > He(e) - 1)
    throw new za({
      offset: t,
      position: "start",
      size: He(e)
...
function hc(e, t, n) {
  if (typeof t == "number" && typeof n == "number" && He(e) !== n - t)
    throw new za({
      offset: n,
      position: "end",
      size: He(e)
...
const yc = /* @__PURE__ */ new TextEncoder(), vc = /* @__PURE__ */ Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function wc(e, t = {}) {
  const { strict: n = !1 } = t;
  if (!e)
    throw new fr(e);
...
function Ua(e) {
  return e instanceof Uint8Array ? qe(e) : Array.isArray(e) ? qe(new Uint8Array(e)) : e;
}
function qe(e, t = {}) {
  let n = "";
  for (let a = 0; a < e.length; a++)
    n += vc[e[a]];
  const r = `0x${n}`;
  return typeof t.size == "number" ? (wn(r, t.size), Ka(r, t.size)) : r;
}
function Se(e, t = {}) {
  ...
  const s = `0x${(n && a < 0 ? (1n << BigInt(r * 8)) + BigInt(a) : a).toString(16)}`;
  return r ? Ec(s, r) : s;
}
function Ma(e, t = {}) {
  return qe(yc.encode(e), t);
}
function Ec(e, t) {
  return Ra(e, { dir: "left", size: t });
}
function Ka(e, t) {
  return Ra(e, { dir: "right", size: t });
}
function de(e, t, n, r = {}) {
  const { strict: a } = r;
  gc(e, t);
...
function Sc(e, t = {}) {
  ...
  if (!n)
    return r;
  const a = (e.length - 2) / 2, i = (1n << BigInt(a) * 8n) - 1n, o = i >> 1n;
  return r <= o ? r : r - i - 1n;
}
function xc(e, t = {}) {
  const { strict: n = !1 } = t;
  try {
    return wc(e, { strict: n }), !0;
  } catch {
    return !1;
  }
}
class kc extends L {
  constructor({ max: t, min: n, signed: r, size: a, value: i }) {
    super(`Number \`${i}\` is not in safe${a ? ` ${a * 8}-bit` : ""}${r ? " signed" : " unsigned"} integer range ${t ? `(\`${n}\` to \`${t}\`)` : `(above \`${n}\`)`}`), Object.defineProperty(this, "name", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
...
class fr extends L {
  constructor(t) {
    super(`Value \`${typeof t == "object" ? At(t) : t}\` of type \`${typeof t}\` is an invalid hex type.`, {
...
function qa(e) {
  return e instanceof Uint8Array ? e : typeof e == "string" ? La(e) : Ha(e);
}
function Ha(e) {
...
function La(e, t = {}) {
  ...
  let a = r.slice(2);
  a.length % 2 && (a = `0${a}`);
  const i = a.length / 2, o = new Uint8Array(i);
  for (let c = 0, s = 0; c < i; c++) {
    const u = dr(a.charCodeAt(s++)), p = dr(a.charCodeAt(s++));
    if (u === void 0 || p === void 0)
      throw new L(`Invalid byte sequence ("${a[s - 2]}${a[s - 1]}" in "${a}").`);
    o[c] = u * 16 + p;
  }
  return o;
}
...
class rt extends L {
  constructor(t) {
    super(`Value \`${typeof t == "object" ? At(t) : t}\` of type \`${typeof t}\` is an invalid Bytes value.`, {
...
function Fa(e, t = {}) {
  const { as: n = typeof e == "string" ? "Hex" : "Bytes" } = t, r = _i(qa(e));
  return n === "Bytes" ? r : qe(r);
}
function Za(e, t = {}) {
  const { compressed: n } = t, { prefix: r, x: a, y: i } = e;
...
function Tc(e) {
  const t = (() => {
    ...
    return typeof r == "bigint" && typeof a == "bigint" ? { prefix: n ?? 4, x: r, y: a } : { prefix: n, x: r };
  })();
  return Za(t), t;
}
function Pc(e) {
...
function Va(e) {
  if (e.length !== 132 && e.length !== 130 && e.length !== 68)
    throw new Rc({ publicKey: e });
  if (e.length === 130) {
    const r = BigInt(de(e, 0, 32)), a = BigInt(de(e, 32, 64));
    return {
      prefix: 4,
      x: r,
      y: a
  ...
  if (e.length === 132) {
    const r = Number(de(e, 0, 1)), a = BigInt(de(e, 1, 33)), i = BigInt(de(e, 33, 65));
    return {
      prefix: r,
      x: a,
      y: i
  ...
  const t = Number(de(e, 0, 1)), n = BigInt(de(e, 1, 33));
  return {
    prefix: t,
    x: n
  };
...
function En(e, t = {}) {
  Za(e);
  const { prefix: n, x: r, y: a } = e, { includePrefix: i = !0 } = t;
  return _t(
    i ? Se(n, { size: 1 }) : "0x",
    Se(r, { size: 32 }),
    // If the public key is not compressed, add the y coordinate.
    typeof a == "bigint" ? Se(a, { size: 32 }) : "0x"
  );
}
class Bc extends L {
  constructor({ publicKey: t }) {
    super(`Value \`${At(t)}\` is not a valid public key.`, {
      metaMessages: [
...
function Uc(e, t = {}) {
  const { recovered: n } = t;
  if (typeof e.r > "u")
    throw new Mt({ signature: e });
  if (typeof e.s > "u")
    throw new Mt({ signature: e });
  if (n && typeof e.yParity > "u")
    throw new Mt({ signature: e });
  if (e.r < 0n || e.r > br)
    throw new Hc({ value: e.r });
  if (e.s < 0n || e.s > br)
    throw new Lc({ value: e.s });
  if (typeof e.yParity == "number" && e.yParity !== 0 && e.yParity !== 1)
    throw new Sn({ value: e.yParity });
}
function Wa(e) {
  if (e.length !== 130 && e.length !== 132)
    throw new qc({ signature: e });
  const t = BigInt(de(e, 0, 32)), n = BigInt(de(e, 32, 64)), r = (() => {
    const a = +`0x${e.slice(130)}`;
    if (!Number.isNaN(a))
      try {
        return Kc(a);
      } catch {
        throw new Sn({ value: a });
      }
  })();
  return typeof r > "u" ? {
    r: t,
...
function Mc(e) {
  ...
  return _t(
    ...
    typeof e.yParity == "number" ? Se(Dc(e.yParity), { size: 1 }) : "0x"
  );
}
function Kc(e) {
  if (e === 0 || e === 27)
...
class Mt extends L {
  constructor({ signature: t }) {
    super(`Signature \`${At(t)}\` is missing either an \`r\`, \`s\`, or \`yParity\` property.`), Object.defineProperty(this, "name", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
...
const Fc = /* @__PURE__ */ new TextDecoder(), at = /* @__PURE__ */ Object.fromEntries(Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").map((e, t) => [t, e.charCodeAt(0)]));
({
  ...Object.fromEntries(Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").map((e, t) => [e.charCodeAt(0), t]))
});
function Zc(e, t = {}) {
  const { pad: n = !0, url: r = !1 } = t, a = new Uint8Array(Math.ceil(e.length / 3) * 4);
  for (let s = 0, u = 0; u < e.length; s += 4, u += 3) {
    const p = (e[u] << 16) + (e[u + 1] << 8) + (e[u + 2] | 0);
    a[s] = at[p >> 18], a[s + 1] = at[p >> 12 & 63], a[s + 2] = at[p >> 6 & 63], a[s + 3] = at[p & 63];
  }
  const i = e.length % 3, o = Math.floor(e.length / 3) * 4 + (i && i + 1);
  let c = Fc.decode(new Uint8Array(a.buffer, 0, o));
  return n && i === 1 && (c += "=="), n && i === 2 && (c += "="), r && (c = c.replaceAll("+", "-").replaceAll("/", "_")), c;
}
function Vc(e, t = {}) {
  return Zc(La(e), t);
}
...
function Wc(e = {}) {
  const { flag: t = 5, rpId: n = window.location.hostname, signCount: r = 0 } = e, a = Fa(Ma(n)), i = Se(t, { size: 1 }), o = Se(r, { size: 4 });
  return _t(a, i, o);
}
function Jc(e) {
  const { challenge: t, crossOrigin: n = !1, extraClientData: r, origin: a = window.location.origin } = e;
  return JSON.stringify({
    type: "webauthn.get",
    challenge: Vc(t, { url: !0, pad: !1 }),
    origin: a,
    crossOrigin: n,
    ...r
  });
...
function Yc(e) {
  const { challenge: t, crossOrigin: n, extraClientData: r, flag: a, origin: i, rpId: o, signCount: c, userVerification: s = "required" } = e, u = Wc({
    flag: a,
    rpId: o,
    signCount: c
  }), p = Jc({
    ...
    extraClientData: r,
    origin: i
  }), f = Fa(Ma(p)), d = p.indexOf('"challenge"'), l = p.indexOf('"type"'), m = {
    authenticatorData: u,
    clientDataJSON: p,
    challengeIndex: d,
    typeIndex: l,
    userVerificationRequired: s === "required"
  }, h = _t(u, f);
...
async function Xc(e = {}) {
  const { extractable: t = !1 } = e, n = await globalThis.crypto.subtle.generateKey({
    name: "ECDSA",
    namedCurve: "P-256"
  }, t, ["sign", "verify"]), r = await globalThis.crypto.subtle.exportKey("raw", n.publicKey), a = Tc(new Uint8Array(r));
  return {
...
async function Qc(e) {
  const { payload: t, privateKey: n } = e, r = await globalThis.crypto.subtle.sign({
    name: "ECDSA",
    hash: "SHA-256"
  }, n, qa(t)), a = Ha(new Uint8Array(r)), i = hr(mr(a, 0, 32));
  let o = hr(mr(a, 32, 64));
  return o > Ln.CURVE.n / 2n && (o = Ln.CURVE.n - o), { r: i, s: o };
}
function It(e) {
...
function Ja(e, t) {
  ...
  const r = It(n);
  return (a, i) => r.then((o) => i(o.transaction(t, a).objectStore(t)));
}
let Kt;
function xn() {
  return Kt || (Kt = Ja("keyval-store", "keyval")), Kt;
}
function Gc(e, t = xn()) {
...
function tu(e, t) {
  const n = typeof indexedDB < "u" ? Ja(e, t) : void 0;
  return {
    getItem: async (r) => {
      const a = await Gc(r, n);
      return a || null;
    },
    removeItem: async (r) => eu(r, n),
    setItem: async (r, a) => $c(r, a, n)
  };
}
const nu = "base-acc-sdk", ru = "keys", kn = "activeId", Le = tu(nu, ru);
async function au() {
  const e = await Xc({ extractable: !1 }), t = de(En(e.publicKey), 1);
  return await Le.setItem(t, e), await Le.setItem(kn, t), e;
}
async function iu() {
  const e = await Le.getItem(kn);
  if (!e)
    return null;
  const t = await Le.getItem(e);
  return t || null;
}
async function ou() {
  const e = await iu();
  if (!e) {
    const t = await au(), n = de(En(t.publicKey), 1);
    return await Le.setItem(n, t), await Le.setItem(kn, n), t;
  }
  return e;
}
async function su() {
  const e = await ou(), t = de(En(e.publicKey), 1), n = async (r) => {
    const { payload: a, metadata: i } = Yc({
      challenge: r,
...
class cu {
  ...
  async setPeerPublicKey(t) {
    this.sharedSecret = null, this.peerPublicKey = t, await this.storeKey(wr, t), await this.loadKeysIfNeeded();
  }
  async clear() {
    this.ownPrivateKey = null, this.ownPublicKey = null, this.peerPublicKey = null, this.sharedSecret = null, w.keys.clear();
  }
  async generateKeyPair() {
    const t = await rc();
    this.ownPrivateKey = t.privateKey, this.ownPublicKey = t.publicKey, await this.storeKey(yr, t.privateKey), await this.storeKey(vr, t.publicKey);
  }
  async loadKeysIfNeeded() {
    if (this.ownPrivateKey === null && (this.ownPrivateKey = await this.loadKey(yr)), this.ownPublicKey === null && (this.ownPublicKey = await this.loadKey(vr)), (this.ownPrivateKey === null || this.ownPublicKey === null) && await this.generateKeyPair(), this.peerPublicKey === null && (this.peerPublicKey = await this.loadKey(wr)), this.sharedSecret === null) {
      if (this.ownPrivateKey === null || this.peerPublicKey === null)
        return;
      this.sharedSecret = await ac(this.ownPrivateKey, this.peerPublicKey);
    }
  }
  // storage methods
  async loadKey(t) {
    const n = w.keys.get(t.storageKey);
    return n ? ja(t.keyType, n) : null;
  }
  async storeKey(t, n) {
    const r = await Ba(t.keyType, n);
    w.keys.set(t.storageKey, r);
  }
}
function Ve(e, t) {
  if (!(typeof e != "object" || e === null))
...
function lu(e) {
  if (!e || !Array.isArray(e) || e.length !== 1 && e.length !== 2 || typeof e[0] != "string" || !mt(e[0]))
    throw E.rpc.invalidParams();
  if (e.length === 2) {
...
function wt(e, t) {
  ...
  if (t && e.method.startsWith("wallet_")) {
    let r = Ve(n, "params.0.capabilities");
...
async function tn() {
  var e;
  const t = (e = w.subAccountsConfig.get()) !== null && e !== void 0 ? e : {}, n = {};
  if (t.enableAutoSubAccounts) {
    const { account: r } = t.toOwnerAccount ? await t.toOwnerAccount() : await en();
    if (!r)
      throw E.provider.unauthorized("No owner account found");
    n.addSubAccount = {
      account: {
        type: "create",
        keys: [
  ...
  if (!(e.method === "coinbase_fetchPermissions" && e.params === void 0)) {
    if (e.method === "coinbase_fetchPermissions" && Array.isArray(e.params) && e.params.length === 1 && typeof e.params[0] == "object") {
      if (typeof e.params[0].account != "string" || !e.params[0].chainId.startsWith("0x"))
        throw E.rpc.invalidParams("FetchPermissions - Invalid params: params[0].account must be a hex string");
      if (typeof e.params[0].chainId != "string" || !e.params[0].chainId.startsWith("0x"))
        throw E.rpc.invalidParams("FetchPermissions - Invalid params: params[0].chainId must be a hex string");
      if (typeof e.params[0].spender != "string" || !e.params[0].spender.startsWith("0x"))
        throw E.rpc.invalidParams("FetchPermissions - Invalid params: params[0].spender must be a hex string");
      return;
    }
    throw E.rpc.invalidParams();
  }
...
function fu(e) {
  ...
  if (e.params !== void 0)
    return e;
  const a = (t = w.getState().account.accounts) === null || t === void 0 ? void 0 : t[0], i = (n = w.getState().account.chain) === null || n === void 0 ? void 0 : n.id, o = (r = w.getState().subAccount) === null || r === void 0 ? void 0 : r.address;
  if (!a || !o || !i)
    throw E.rpc.invalidParams("FetchPermissions - one or more of account, sub account, or chain id is missing, connect to sub account via wallet_connect first");
  return {
...
function pu({ spendPermission: e, chainId: t }) {
  return {
    domain: {
      name: "Spend Permission Manager",
      version: "1",
      chainId: t,
      verifyingContract: aa
    },
    types: {
      SpendPermission: [
...
function mu({ spendPermissionBatch: e, chainId: t }) {
  return {
    domain: {
      name: "Spend Permission Manager",
      version: "1",
...
async function Ya({ client: e, id: t }) {
  var n;
  const r = await $r(e, {
    id: t
  });
...
function Xa({ calls: e, from: t, chainId: n, capabilities: r }) {
  const a = ra.get().paymasterUrls;
  let i = {
  ...
  return a != null && a[n] && (i = wt(i, {
    paymasterService: { url: a == null ? void 0 : a[n] }
  })), i;
}
async function hu() {
  const e = vn();
  return await new Promise((n) => {
    pn({ dialogContext: "sub_account_insufficient_balance" }), e.presentItem({
      ...
      onClose: () => {
        da({ dialogContext: "sub_account_insufficient_balance" }), e.clear();
      },
      actionItems: [
        {
...
function gu({ errorData: e, sourceAddress: t }) {
  var n;
  const r = [];
  for (const [a, { amount: i, sources: o }] of Object.entries((n = e == null ? void 0 : e.required) !== null && n !== void 0 ? n : {})) {
    if (o.filter((s) => ut(s.balance) >= ut(i) && s.address.toLowerCase() === (t == null ? void 0 : t.toLowerCase())).length === 0)
...
function vu(e) {
  return ei(ti(Re(e)), 0, 16);
}
function wu({ attribution: e, dappOrigin: t }) {
  if (e) {
...
function Eu(e, t) {
  var n;
  if (!Array.isArray(e == null ? void 0 : e.params))
    return !1;
...
async function Su() {
  const e = w.spendPermissions.get(), t = w.subAccounts.get(), n = w.account.get().accounts;
  return n ? {
    accounts: n == null ? void 0 : n.map((a) => ({
      address: a,
      capabilities: {
...
function ku({ webauthn: e, signature: t, id: n }) {
  const r = Wa(t);
  return {
    id: n,
    rawId: st(On(n)),
    response: {
      authenticatorData: st(qt(e.authenticatorData)),
      clientDataJSON: st(On(e.clientDataJSON)),
      signature: st(Au(r.r, r.s))
    },
    type: JSON.parse(e.clientDataJSON).type
  };
}
function Au(e, t) {
  const n = qt(Cn(se(e))), r = qt(Cn(se(t))), a = n.length, i = r.length, o = a + i + 4, c = new Uint8Array(o + 2);
  return c[0] = 48, c[1] = o, c[2] = 2, c[3] = a, c.set(n, 4), c[a + 4] = 2, c[a + 5] = i, c.set(r, a + 6), c;
}
var _u = function(e, t) {
  var n = {};
...
async function Iu(e) {
  const { owner: t, ownerIndex: n, address: r, client: a, factoryData: i } = e, o = {
    abi: Ci,
    address: Oi,
    version: "0.6"
  }, c = {
  ...
  return Ii({
    ...
    async decodeCalls(s) {
      ...
      throw new _r(`unable to decode calls for "${u.functionName}"`);
    },
    async encodeCalls(s) {
      var u, p;
      return s.length === 1 ? xe({
        abi: me,
        functionName: "execute",
        args: [s[0].to, (u = s[0].value) !== null && u !== void 0 ? u : BigInt(0), (p = s[0].data) !== null && p !== void 0 ? p : "0x"]
      }) : xe({
        abi: me,
    ...
    async getFactoryArgs() {
      return i ? { factory: c.address, factoryData: i } : { factory: c.address, factoryData: i };
    },
    ...
    async sign(s) {
      const u = await this.getAddress(), p = Dt({
        address: u,
        chainId: a.chain.id,
        hash: s.hash
      }), f = await ct({ hash: p, owner: t });
      return Ze({
        ownerIndex: n,
        signature: f
      });
    ...
    async signMessage(s) {
      const { message: u } = s, p = await this.getAddress(), f = Dt({
        address: p,
        chainId: a.chain.id,
        hash: kr(u)
      }), d = await ct({ hash: f, owner: t });
      return Ze({
        ownerIndex: n,
        signature: d
      });
    ...
    async signTypedData(s) {
      const { domain: u, types: p, primaryType: f, message: d } = s, l = await this.getAddress(), m = Dt({
        address: l,
        chainId: a.chain.id,
        hash: nn({
          domain: u,
      ...
      }), h = await ct({ hash: m, owner: t });
      return Ze({
        ownerIndex: n,
        signature: h
      });
    },
    async signUserOperation(s) {
      const { chainId: u = a.chain.id } = s, p = _u(s, ["chainId"]), f = await this.getAddress(), d = Ti({
        chainId: u,
        entryPointAddress: o.address,
        entryPointVersion: o.version,
        userOperation: Object.assign(Object.assign({}, p), { sender: f })
      }), l = await ct({ hash: d, owner: t });
      return Ze({
        ownerIndex: n,
        signature: l
      });
    ...
    userOperation: {
      async estimateGas(s) {
        ...
        if (t.type === "webAuthn")
          return {
            verificationGasLimit: BigInt(Math.max(Number((u = s.verificationGasLimit) !== null && u !== void 0 ? u : BigInt(0)), 8e5))
          };
      }
    }
  });
}
async function ct({ hash: e, owner: t }) {
  if (t.type === "webAuthn") {
    const { signature: n, webauthn: r } = await t.sign({
      hash: e
    });
    return Ou({ signature: n, webauthn: r });
  }
  if (t.sign)
    return t.sign({ hash: e });
  throw new _r("`owner` does not support raw sign.");
}
function Dt({ address: e, chainId: t, hash: n }) {
  return nn({
    domain: {
      chainId: t,
...
function Ou({ webauthn: e, signature: t }) {
  const { r: n, s: r } = Wa(t);
  return Ir([
    {
      components: [
  ...
  ], [
    {
      ...
      clientDataJSON: ni(e.clientDataJSON),
...
function Ze(e) {
  const { ownerIndex: t = 0 } = e, n = (() => {
    if (ri(e.signature) !== 65)
      return e.signature;
    const r = ai(e.signature);
    return ii(["bytes32", "bytes32", "uint8"], [r.r, r.s, r.yParity === 0 ? 27 : 28]);
  })();
  return Ir([
    {
      components: [
...
async function Cu({ address: e, client: t, factory: n, factoryData: r, owner: a, ownerIndex: i, parentAddress: o, attribution: c }) {
  var s;
  const u = {
    address: e,
    factory: n,
    factoryData: r
  }, p = (s = t.chain) === null || s === void 0 ? void 0 : s.id;
  if (!p)
    throw E.rpc.internal("chainId not found");
  const f = await Iu({
    owner: a,
    ownerIndex: i ?? 1,
    address: e,
    ...
    try {
      switch (l.method) {
        ...
        case "eth_sendTransaction": {
          ve(l.params);
          const _ = l.params[0];
          fe(_.to, E.rpc.invalidParams("to is required"));
          const N = {
            to: _.to,
            data: $t((m = _.data) !== null && m !== void 0 ? m : "0x", !0),
            value: $t((h = _.value) !== null && h !== void 0 ? h : "0x", !0),
            from: (v = _.from) !== null && v !== void 0 ? v : u.address
          }, $ = Xa({
            calls: [N],
            chainId: p,
            from: N.from
        ...
        case "wallet_sendCalls": {
          ve(l.params);
          const _ = Ve(l.params[0], "chainId");
          if (!_)
            throw E.rpc.invalidParams("chainId is required");
          if (!je(_))
            throw E.rpc.invalidParams("chainId must be a hex encoded integer");
          if (!l.params[0])
          ...
          let $ = await d(N);
          const ae = await ((O = (S = a).sign) === null || O === void 0 ? void 0 : O.call(S, {
            // Hash returned from wallet_prepareCalls is double hex encoded
            hash: Tn($.signatureRequest.hash)
          }));
          let te;
          if (!ae)
            throw E.rpc.internal("signature not found");
          return je(ae) ? te = {
            type: "secp256k1",
            data: {
              address: a.address,
            ...
            type: "webauthn",
            data: {
              signature: JSON.stringify(ku(Object.assign({ id: (k = a.id) !== null && k !== void 0 ? k : "1" }, ae))),
        ...
        case "wallet_prepareCalls": {
          ...
          if (!l.params[0])
            throw E.rpc.invalidParams("params are required");
          if (!Ve(l.params[0], "calls"))
            throw E.rpc.invalidParams("calls are required");
          const N = l.params[0];
          return c && N.capabilities && !("attribution" in N.capabilities) && (N.capabilities.attribution = c), await t.request({
            method: "wallet_prepareCalls",
            params: [Object.assign(Object.assign({}, l.params[0]), { chainId: _ })]
          });
        }
        case "personal_sign": {
          if (ve(l.params), !je(l.params[0]))
            throw E.rpc.invalidParams("message must be a hex encoded string");
          const _ = Tn(l.params[0]);
          return f.signMessage({ message: _ });
        }
        case "eth_signTypedData_v4": {
          ve(l.params);
          const _ = typeof l.params[1] == "string" ? JSON.parse(l.params[1]) : l.params[1];
          return f.signTypedData(_);
        }
...
async function Qa({ address: e, client: t, publicKey: n, factory: r, factoryData: a }) {
  if (!await Pi(t, {
    address: e
  }) && r && a) {
    const c = Ar({
    ...
    if (c.functionName !== "createAccount")
      throw E.rpc.internal("unknown factory function");
    const [s] = c.args;
    return s.findIndex((u) => u.toLowerCase() === xr(n).toLowerCase());
  }
  const o = await Nn(t, {
    address: e,
    abi: me,
  ...
  for (let c = Number(o) - 1; c >= 0; c--) {
    ...
    if (s.toLowerCase() === u.toLowerCase())
      return c;
  }
  return -1;
}
...
async function Tu() {
  var e, t;
  const n = (t = (e = w.config.get().metadata) === null || e === void 0 ? void 0 : e.appName) !== null && t !== void 0 ? t : "App", r = vn();
  return new Promise((a) => {
    pn({ dialogContext: "sub_account_add_owner" }), r.presentItem({
      title: `Re-authorize ${n}`,
      message: `${n} has lost access to your account. Please sign at the next step to re-authorize ${n}`,
      onClose: () => {
        da({ dialogContext: "sub_account_add_owner" }), a("cancel");
      },
      actionItems: [
        {
          text: "Continue",
...
async function Pu({ ownerAccount: e, globalAccountRequest: t }) {
  var n, r;
  const a = w.account.get(), i = w.subAccounts.get(), o = (n = a.accounts) === null || n === void 0 ? void 0 : n.find((m) => m.toLowerCase() !== (i == null ? void 0 : i.address.toLowerCase()));
  fe(o, E.provider.unauthorized("no global account")), fe((r = a.chain) === null || r === void 0 ? void 0 : r.id, E.provider.unauthorized("no chain id")), fe(i == null ? void 0 : i.address, E.provider.unauthorized("no sub account"));
  const c = [];
  if (e.type === "local" && e.address && c.push({
    to: i.address,
    data: xe({
      abi: me,
    ...
    const [m, h] = Or([{ type: "bytes32" }, { type: "bytes32" }], e.publicKey);
    c.push({
      to: i.address,
      data: xe({
        abi: me,
  ...
  const p = await t(s), f = Ta(a.chain.id);
  if (fe(f, E.rpc.internal(`client not found for chainId ${a.chain.id}`)), (await $r(f, {
    id: p
  })).status !== "success")
  ...
  if (l === -1)
    throw E.rpc.internal("failed to find owner index");
  return l;
}
async function Bu({ errorData: e, globalAccountAddress: t, subAccountAddress: n, client: r, request: a, subAccountRequest: i, globalAccountRequest: o }) {
  var c;
  const s = (c = r.chain) === null || c === void 0 ? void 0 : c.id;
  fe(s, E.rpc.internal("invalid chainId"));
  const u = gu({
    errorData: e,
    sourceAddress: t
  }), p = await hu();
  ...
  let f;
  const d = 60 * 60 * 24, l = 3;
  if (p === "update_permission") {
    if (u.length === 1) {
      const k = u[0], _ = pu({
        spendPermission: {
          token: k.token,
          allowance: se(k.requiredAmount * BigInt(l)),
          period: d,
          account: t,
          spender: n,
          start: 0,
          end: 281474976710655,
          salt: se(BigInt(Math.floor(Math.random() * Number.MAX_SAFE_INTEGER))),
          extraData: "0x"
        },
        chainId: s
      });
      ...
      const k = mu({
        spendPermissionBatch: {
          ...
          permissions: u.map((_) => ({
            token: _.token,
            allowance: se(_.requiredAmount * BigInt(l)),
            period: d,
            account: t,
            spender: n,
            salt: "0x0",
    ...
    try {
      ...
      throw console.error(k), new Error("User denied spend permission request");
    }
    return i(a);
  }
  const m = u.map((k) => k.token.toLowerCase() === "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE".toLowerCase() ? {
    to: n,
    value: se(k.requiredAmount),
    data: "0x"
  } : {
    to: k.token,
    value: "0x0",
  ...
  let h;
  if (a.method === "wallet_sendCalls" && bu(a.params))
    h = a.params[0];
  else if (a.method === "eth_sendTransaction" && yu(a.params))
    h = Xa({
      calls: [a.params[0]],
      chainId: s,
      from: a.params[0].from
    }).params[0];
  else
  ...
  const v = xe({
    ...
    args: [
      h.calls.map((k) => {
        ...
        return {
          target: k.to,
          value: ut((_ = k.value) !== null && _ !== void 0 ? _ : "0x0"),
          data: (N = k.data) !== null && N !== void 0 ? N : "0x"
        };
      })
    ]
  }), S = [
    ...m,
    { data: v, to: n, value: "0x0" }
  ], O = await o({
    method: "wallet_sendCalls",
    params: [Object.assign(Object.assign({}, h), { calls: S, from: t })]
  });
  return a.method === "eth_sendTransaction" ? Ya({
    client: r,
    id: O
  }) : O;
}
class ju {
  constructor(t) {
    var n, r, a, i;
    this.communicator = t.communicator, this.callback = t.callback, this.keyManager = new cu();
    const { account: o, chains: c } = w.getState();
    this.accounts = (n = o.accounts) !== null && n !== void 0 ? n : [], this.chain = (r = o.chain) !== null && r !== void 0 ? r : {
      id: (i = (a = t.metadata.appChainIds) === null || a === void 0 ? void 0 : a[0]) !== null && i !== void 0 ? i : 1
    }, c && lr(c);
  }
  get isConnected() {
  ...
  async handshake(t) {
    var n, r, a;
    const i = be.get(t);
    Ls({ method: t.method, correlationId: i });
    try {
      ...
      }, i), c = await this.communicator.postRequestAndWaitForResponse(o);
      if ("failure" in c.content)
        throw c.content.failure;
      const s = await ja("public", c.sender);
      await this.keyManager.setPeerPublicKey(s);
      const u = await this.decryptResponseMessage(c);
      this.handleResponse(t, u), Fs({ method: t.method, correlationId: i });
    } catch (o) {
      throw zs({
        method: t.method,
        correlationId: i,
  ...
  async request(t) {
    const n = be.get(t);
    Zs({ method: t.method, correlationId: n });
    try {
      const r = await this._request(t);
      return Ws({ method: t.method, correlationId: n }), r;
    } catch (r) {
      throw Vs({
        method: t.method,
        correlationId: n,
  ...
  async _request(t) {
    var n, r, a, i, o, c, s, u, p, f;
    if (this.accounts.length === 0)
      switch (t.method) {
        case "wallet_switchEthereumChain": {
          Sr(t.params), this.chain.id = Number(t.params[0].chainId);
          return;
        }
        case "wallet_connect": {
          await ((r = (n = this.communicator).waitForPopupLoaded) === null || r === void 0 ? void 0 : r.call(n)), await tn();
          let d = {};
          Eu(t, "addSubAccount") && (d = (i = (a = w.subAccountsConfig.get()) === null || a === void 0 ? void 0 : a.capabilities) !== null && i !== void 0 ? i : {});
          const l = wt(t, d);
          return this.sendRequestToPopup(l);
        }
        case "wallet_sendCalls":
        case "wallet_sign":
    ...
    if (this.shouldRequestUseSubAccountSigner(t)) {
      const d = be.get(t);
      Js({ method: t.method, correlationId: d });
      try {
        const l = await this.sendRequestToSubAccountSigner(t);
        return Ys({ method: t.method, correlationId: d }), l;
      } catch (l) {
        throw Xs({
          method: t.method,
          correlationId: d,
    ...
    switch (t.method) {
      ...
      case "eth_accounts": {
        const d = w.subAccounts.get(), l = w.subAccountsConfig.get();
        return d != null && d.address && (this.accounts = l != null && l.enableAutoSubAccounts ? it(this.accounts, d.address) : ot(this.accounts, d.address)), (o = this.callback) === null || o === void 0 || o.call(this, "connect", { chainId: se(this.chain.id) }), this.accounts;
      }
      case "eth_coinbase":
      ...
      case "wallet_connect": {
        ...
        if (d)
          return d;
        await ((s = (c = this.communicator).waitForPopupLoaded) === null || s === void 0 ? void 0 : s.call(c)), await tn();
        const l = w.subAccountsConfig.get(), m = wt(t, (u = l == null ? void 0 : l.capabilities) !== null && u !== void 0 ? u : {}), h = await this.sendRequestToPopup(m);
        return (p = this.callback) === null || p === void 0 || p.call(this, "connect", { chainId: se(this.chain.id) }), h;
      }
      case "wallet_getSubAccounts": {
        const d = w.subAccounts.get();
        if (d != null && d.address)
          return {
            subAccounts: [d]
          };
        ...
        const l = await pt(t, this.chain.rpcUrl);
        if (ve(l.subAccounts, "subAccounts"), l.subAccounts.length > 0) {
          nt(l.subAccounts[0]);
          const m = l.subAccounts[0];
          w.subAccounts.set({
            address: m.address,
            factory: m.factory,
            factoryData: m.factoryData
          });
        }
        return l;
      }
      ...
      case "coinbase_fetchPermissions": {
        du(t);
        const d = fu(t), l = await pt(d, ta), m = Ot((f = d.params) === null || f === void 0 ? void 0 : f[0].chainId);
        return w.spendPermissions.set(l.permissions.map((h) => Object.assign(Object.assign({}, h), { chainId: m }))), l;
      }
      default:
        if (!this.chain.rpcUrl)
          throw E.rpc.internal("No RPC URL set for chain");
        return pt(t, this.chain.rpcUrl);
    }
  }
  async sendRequestToPopup(t) {
    var n, r;
    await ((r = (n = this.communicator).waitForPopupLoaded) === null || r === void 0 ? void 0 : r.call(n));
    const a = await this.sendEncryptedRequest(t), i = await this.decryptResponseMessage(a);
  ...
  async handleResponse(t, n) {
    ...
    switch (t.method) {
      ...
      case "wallet_connect": {
        const u = s.value, p = u.accounts.map((S) => S.address);
        this.accounts = p, w.account.set({
          accounts: p
        });
        const f = u.accounts.at(0), d = f == null ? void 0 : f.capabilities;
        if (d != null && d.subAccounts) {
          const S = d == null ? void 0 : d.subAccounts;
          ve(S, "subAccounts"), nt(S[0]), w.subAccounts.set({
            address: S[0].address,
            factory: S[0].factory,
            factoryData: S[0].factoryData
          });
        }
        let l = [this.accounts[0]];
        const m = w.subAccounts.get(), h = w.subAccountsConfig.get();
        m != null && m.address && (this.accounts = h != null && h.enableAutoSubAccounts ? it(this.accounts, m.address) : ot(this.accounts, m.address));
        const v = (i = (a = u == null ? void 0 : u.accounts) === null || a === void 0 ? void 0 : a[0].capabilities) === null || i === void 0 ? void 0 : i.spendPermissions;
        v && "permissions" in v && w.spendPermissions.set(v == null ? void 0 : v.permissions), (o = this.callback) === null || o === void 0 || o.call(this, "accountsChanged", l);
        break;
      }
      case "wallet_addSubAccount": {
        nt(s.value);
        const u = s.value;
        w.subAccounts.set(u);
        const p = w.subAccountsConfig.get();
        this.accounts = p != null && p.enableAutoSubAccounts ? it(this.accounts, u.address) : ot(this.accounts, u.address), (c = this.callback) === null || c === void 0 || c.call(this, "accountsChanged", this.accounts);
        break;
      }
    }
    return s.value;
  ...
  async cleanup() {
    var t, n;
    const r = w.config.get().metadata;
    await this.keyManager.clear(), w.account.clear(), w.subAccounts.clear(), w.spendPermissions.clear(), w.chains.clear(), this.accounts = [], this.chain = {
      id: (n = (t = r == null ? void 0 : r.appChainIds) === null || t === void 0 ? void 0 : t[0]) !== null && n !== void 0 ? n : 1
    };
  }
  /**
  ...
  async handleGetCapabilitiesRequest(t) {
    ...
    if (!this.accounts.some((c) => ci(c, n)))
      throw E.provider.unauthorized("no active account found when getting capabilities");
    const a = w.getState().account.capabilities;
    if (!a)
      return {};
    if (!r || r.length === 0)
      return a;
    const i = new Set(r.map((c) => Ot(c)));
    return Object.fromEntries(Object.entries(a).filter(([c]) => {
      try {
        const s = Ot(c);
        return i.has(s);
      } catch {
  ...
  async sendEncryptedRequest(t) {
    ...
    if (!n)
      throw E.provider.unauthorized("No shared secret found when encrypting request");
    const r = await sc({
      action: t,
      chainId: this.chain.id
    }, n), a = be.get(t), i = await this.createRequestMessage({ encrypted: r }, a);
    return this.communicator.postRequestAndWaitForResponse(i);
  }
  async createRequestMessage(t, n) {
    const r = await Ba("public", await this.keyManager.getOwnPublicKey());
    return {
  ...
  async decryptResponseMessage(t) {
    ...
    if ("failure" in i)
      throw i.failure;
    const o = await this.keyManager.getSharedSecret();
    if (!o)
      throw E.provider.unauthorized("Invalid session: no shared secret found when decrypting response");
    const c = await cc(i.encrypted, o), s = (n = c.data) === null || n === void 0 ? void 0 : n.chains;
    if (s) {
      const p = (r = c.data) === null || r === void 0 ? void 0 : r.nativeCurrencies, f = Object.entries(s).map(([d, l]) => {
        const m = p == null ? void 0 : p[Number(d)];
        return Object.assign({ id: Number(d), rpcUrl: l }, m ? { nativeCurrency: m } : {});
      });
      w.chains.set(f), this.updateChain(this.chain.id, f), lr(f);
    }
    const u = (a = c.data) === null || a === void 0 ? void 0 : a.capabilities;
    return u && w.account.set({
      capabilities: u
    }), c;
  }
  updateChain(t, n) {
    var r;
    const a = w.getState(), i = n ?? a.chains, o = i == null ? void 0 : i.find((c) => c.id === t);
    return o ? (o !== this.chain && (this.chain = o, w.account.set({
      chain: o
    }), (r = this.callback) === null || r === void 0 || r.call(this, "chainChanged", Ia(o.id))), !0) : !1;
  }
  async addSubAccount(t) {
    var n, r, a, i;
    const c = w.getState().subAccount, s = w.subAccountsConfig.get();
    if (c != null && c.address)
      return this.accounts = s != null && s.enableAutoSubAccounts ? it(this.accounts, c.address) : ot(this.accounts, c.address), (n = this.callback) === null || n === void 0 || n.call(this, "accountsChanged", this.accounts), c;
    if (await ((a = (r = this.communicator).waitForPopupLoaded) === null || a === void 0 ? void 0 : a.call(r)), Array.isArray(t.params) && t.params.length > 0 && t.params[0].account && t.params[0].account.type === "create") {
      let p;
      if (t.params[0].account.keys && t.params[0].account.keys.length > 0)
        p = t.params[0].account.keys;
      else {
        const f = (i = w.subAccountsConfig.get()) !== null && i !== void 0 ? i : {}, { account: d } = f.toOwnerAccount ? await f.toOwnerAccount() : await en();
        if (!d)
          throw E.provider.unauthorized("could not get subaccount owner account when adding sub account");
        p = [
          {
  ...
  shouldRequestUseSubAccountSigner(t) {
    const n = Er(t), r = w.subAccounts.get();
    return n ? n.toLowerCase() === (r == null ? void 0 : r.address.toLowerCase()) : !1;
  }
  async sendRequestToSubAccountSigner(t) {
    var n;
    const r = w.subAccounts.get(), a = w.subAccountsConfig.get(), i = w.config.get();
    fe(r == null ? void 0 : r.address, E.provider.unauthorized("no active sub account when sending request to sub account signer"));
    const o = a != null && a.toOwnerAccount ? await a.toOwnerAccount() : await en();
    fe(o == null ? void 0 : o.account, E.provider.unauthorized("no active sub account owner when sending request to sub account signer")), Er(t) === void 0 && (t = uu(t, r.address));
    const s = Ta(this.chain.id);
    fe(s, E.rpc.internal(`client not found for chainId ${this.chain.id} when sending request to sub account signer`));
    const u = this.accounts.find((m) => m.toLowerCase() !== r.address.toLowerCase());
    fe(u, E.provider.unauthorized("no global account found when sending request to sub account signer"));
    const p = wu({
      attribution: (n = i.preference) === null || n === void 0 ? void 0 : n.attribution,
      dappOrigin: window.location.origin
    }), f = o.account.type === "local" ? o.account.address : o.account.publicKey;
    let d = await Qa({
      address: r.address,
      factory: r.factory,
    ...
    if (d === -1) {
      const m = be.get(t);
      Qs({ method: t.method, correlationId: m });
      try {
        d = await Pu({
          ownerAccount: o.account,
          globalAccountRequest: this.sendRequestToPopup.bind(this)
        }), Gs({ method: t.method, correlationId: m });
      } catch (h) {
        return $s({
          method: t.method,
          correlationId: m,
          errorMessage: Fe(h)
        }), E.provider.unauthorized("failed to add sub account owner when sending request to sub account signer");
      }
    }
    const { request: l } = await Cu({
      address: r.address,
      owner: o.account,
      client: s,
      factory: r.factory,
    ...
    try {
      ...
      if (la(m))
        ...
        throw m;
      if (!(Vn(h) && h.data) || !h.data)
        throw m;
      const v = be.get(t);
      ec({ method: t.method, correlationId: v });
      try {
        const S = await Bu({
          errorData: h.data,
        ...
        return tc({ method: t.method, correlationId: v }), S;
      } catch (S) {
        throw console.error(S), nc({
          method: t.method,
          correlationId: v,
          errorMessage: Fe(S)
        }), m;
...
class Ru extends Ts {
  constructor(t) {
    var { metadata: n } = t, r = t.preference, { walletUrl: a } = r, i = Nu(r, ["walletUrl"]);
    super(), this.isBaseAccount = !0, this.communicator = new _s({
      url: a,
      metadata: n,
      preference: i
    }), this.signer = new ju({
  ...
  async request(t) {
    ...
    be.set(t, n), Ps({ method: t.method, correlationId: n });
    try {
      const r = await this._request(t);
      return js({
        method: t.method,
  ...
  async _request(t) {
    var n, r;
    try {
      if (uc(t), !this.signer.isConnected)
        switch (t.method) {
          case "eth_requestAccounts": {
            await this.signer.handshake({ method: "handshake" }), await tn(), await this.signer.request({
              method: "wallet_connect",
              params: [
                {
                  version: "1",
                  capabilities: Object.assign({}, (r = (n = w.subAccountsConfig.get()) === null || n === void 0 ? void 0 : n.capabilities) !== null && r !== void 0 ? r : {})
                }
              ]
            });
            break;
          ...
          case "wallet_connect":
            return await this.signer.handshake({ method: "handshake" }), await this.signer.request(t);
          case "wallet_sendCalls":
          case "wallet_sign":
            try {
              return await this.signer.handshake({ method: "handshake" }), await this.signer.request(t);
          ...
          case "eth_chainId":
            return Ia(1);
          default:
            throw E.provider.unauthorized("Must call 'eth_requestAccounts' before other methods");
        }
      return await this.signer.request(t);
    } catch (a) {
      const { code: i } = a;
      return i === W.provider.unauthorized && await this.disconnect(), Promise.reject(Is(a));
    }
  }
  async disconnect() {
    await this.signer.cleanup(), be.clear(), this.emit("disconnect", E.provider.disconnected("User initiated disconnection"));
  }
}
const Uu = "isCoinbaseBrowser";
function Mu() {
  var e, t;
  const n = (e = window.ethereum) !== null && e !== void 0 ? e : (t = window.top) === null || t === void 0 ? void 0 : t.ethereum;
  return n != null && n[Uu] ? n : null;
}
function Fu(e) {
  var t, n, r, a;
  const i = {
    ...
    preference: (t = e.preference) !== null && t !== void 0 ? t : {},
    paymasterUrls: e.paymasterUrls
  };
  !((n = e.subAccounts) === null || n === void 0) && n.toOwnerAccount && Wn(e.subAccounts.toOwnerAccount), w.subAccountsConfig.set({
    ...
    enableAutoSubAccounts: (a = e.subAccounts) === null || a === void 0 ? void 0 : a.enableAutoSubAccounts
  }), w.config.set(i), w.persist.rehydrate(), Zo(), Wo(i.preference), i.preference.telemetry !== !1 && Ro();
  let o = null;
  const c = {
    getProvider: () => {
      var s;
      return o || (o = (s = Mu()) !== null && s !== void 0 ? s : new Ru(i)), o;
    },
    subAccount: {
      async create(s) {
        var u;
        return await ((u = c.getProvider()) === null || u === void 0 ? void 0 : u.request({
      ...
      async get() {
        var s, u;
        const p = w.subAccounts.get();
        if (p != null && p.address)
          return p;
        const d = (u = (await ((s = c.getProvider()) === null || s === void 0 ? void 0 : s.request({
          method: "wallet_connect",
          params: [
            {
              version: "1",
      ...
      addOwner: async ({ address: s, publicKey: u, chainId: p }) => {
        var f, d;
        const l = w.subAccounts.get(), m = w.account.get();
        fe(m, new Error("account does not exist")), fe(l == null ? void 0 : l.address, new Error("subaccount does not exist"));
        const h = [];
        if (u) {
          const [v, S] = Or([{ type: "bytes32" }, { type: "bytes32" }], u);
          h.push({
            to: l.address,
            data: xe({
              abi: me,
        ...
        return s && h.push({
          ...
          value: Re(0)
        }), await ((f = c.getProvider()) === null || f === void 0 ? void 0 : f.request({
          method: "wallet_sendCalls",
          params: [
            {
              calls: h,
...
export {
  Fu as createBaseAccountSDK,
  en as getCryptoKeyAccount
};
