import { i as E, r as F, j as k, a as v, k as _, R as l, C as h, d as x, S as f, f as c, l as P, e as R, O as A, M as z, m as M, c as B } from "./index-D7QEUbBB.js";
import { n as C, c as d, r as m, U as V } from "./if-defined-C_M2V4-7.js";
import { x as u } from "./lit-html-jz-94mx9.js";
import "./index-XWBDgTd7.js";
import "./index-BMAzJhf3.js";
import "./index-QlLoATd0.js";
import { e as H, n as q } from "./ref-BKG_cabU.js";
...
let w = class extends v {
  ...
  handleInput(e, t) {
    ...
    if (o) {
      const i = o.value;
      e.inputType === "insertFromPaste" ? this.handlePaste(o, i, t) : V.isNumber(i) && e.data ? (this.updateInput(o, t, e.data), this.focusInputField("next", t)) : this.updateInput(o, t, "");
    }
  ...
  handlePaste(e, t, n) {
    ...
    if (o && V.isNumber(o)) {
      ...
      if (n + 1 < this.length && r.length) {
        const s = this.numerics[n + 1], D = s ? this.getInputElement(s) : void 0;
        D && this.handlePaste(D, r, n + 1);
      } else
    ...
    super(...arguments), this.onOtpSubmit = async (e) => {
      ...
      try {
        if (this.authConnector) {
          await this.authConnector.provider.connectOtp({ otp: e }), c.sendEvent({ type: "track", event: "EMAIL_VERIFICATION_CODE_PASS" });
          const o = P.getConnections(R.state.activeChain).length > 0;
          if (R.state.activeChain)
          ...
          const i = (t = A.state.remoteFeatures) == null ? void 0 : t.multiWallet;
          A.state.siwx || (o && i ? (l.replace("ProfileWallets"), f.showSuccess("New Wallet Added")) : z.close());
        }
      } catch (n) {
        throw c.sendEvent({
          type: "track",
...
let S = class extends v {
  constructor() {
    var e;
    super(), this.authConnector = h.getAuthConnector(), this.isEmailEnabled = (e = A.state.remoteFeatures) == null ? void 0 : e.email, this.isAuthEnabled = this.checkIfAuthEnabled(h.state.connectors), this.connectors = h.state.connectors, h.subscribeKey("connectors", (t) => {
...
U([
  m()
], S.prototype, "connectors", void 0);
S = U([
  d("w3m-email-login-view")
], S);
export {
  S as W3mEmailLoginView,
  y as W3mEmailVerifyDeviceView,
  N as W3mEmailVerifyOtpView,
  L as W3mUpdateEmailPrimaryOtpView,
  W as W3mUpdateEmailSecondaryOtpView,
