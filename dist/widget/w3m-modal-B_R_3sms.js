import { M as p, $ as R, R as l, i as y, r as U, a as C, o as _, j as le, X as ce, h, u as L, J as de, p as K, e as q, O as T, C as z, A as F, S as E, G as P, T as ue, a0 as pe, d as J, P as he, c as we } from "./index-C5WaG16p.js";
import { x as c } from "./lit-html-jz-94mx9.js";
import { c as f, n as u, r as d, o as M, U as me } from "./if-defined-CulHeU7H.js";
...
function H() {
  var s, r, k, v, $, S, O;
  const n = (r = (s = l.state.data) == null ? void 0 : s.connector) == null ? void 0 : r.name, e = (v = (k = l.state.data) == null ? void 0 : k.wallet) == null ? void 0 : v.name, t = (S = ($ = l.state.data) == null ? void 0 : $.network) == null ? void 0 : S.name, i = e ?? n, a = z.getConnectors();
  return {
...
class b extends C {
  ...
  initializeTheming() {
    const { themeVariables: e, themeMode: t } = ue.state, i = me.getColorTheme(t);
    pe(e, i);
  }
  onClose() {
  ...
  async onNewAddress(e) {
    const t = h.state.isSwitchingNamespace, i = !J.getPlainAddress(this.caipAddress), a = J.getPlainAddress(e), o = await R.getAllSessions(), s = e && R.getSIWX() ? o.some(($) => {
      var S;
      return $.data.accountAddress === ((S = he.parseCaipAddress(e)) == null ? void 0 : S.address);
    }) : !0, r = !a && !t, k = t && a && s;
    l.state.view === "ProfileWallets" || (r && !this.enableEmbedded ? p.close() : k && !this.enableEmbedded ? l.goBack() : this.enableEmbedded && i && a && p.close()), await R.initializeIfEnabled(), this.caipAddress = e, h.setIsSwitchingNamespace(!1);
  }
  onNewNetwork(e) {
    var Y, X, G;
    const t = this.caipNetwork, i = (Y = t == null ? void 0 : t.caipNetworkId) == null ? void 0 : Y.toString(), a = t == null ? void 0 : t.chainNamespace, o = (X = e == null ? void 0 : e.caipNetworkId) == null ? void 0 : X.toString(), s = e == null ? void 0 : e.chainNamespace, r = i !== o, v = r && !(a !== s), $ = (t == null ? void 0 : t.name) === we.UNSUPPORTED_NETWORK_NAME, S = l.state.view === "ConnectingExternal", O = l.state.view === "ProfileWallets", se = !((G = h.getAccountData(e == null ? void 0 : e.chainNamespace)) != null && G.caipAddress), ne = l.state.view === "UnsupportedChain", re = p.state.open;
    let N = !1;
    this.enableEmbedded && l.state.view === "SwitchNetwork" && (N = !0), re && !S && !O && (se ? r && (N = !0) : (ne || v && !$) && (N = !0)), N && l.state.view !== "SIWXSignMessage" && l.goBack(), this.caipNetwork = e;
  }
  prefetch() {
