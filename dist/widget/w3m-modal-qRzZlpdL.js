import { i as y, a as C, x as l } from "./lit-element-CWLRvgWK.js";
import { n as u, r as d, o as z } from "./class-map-h_7ODbZJ.js";
import { M as p, Y as R, R as c, r as j, m as _, h as re, L as ce, f as h, s as D, F as le, n as K, d as q, O as T, C as M, A as F, S as E, Q as P, T as de, _ as ue, P as pe, c as he, b as we } from "./index-YPhvagLx.js";
import { c as b, U as me } from "./index-BluLXyw-.js";
...
function H() {
  var s, r, k, m, $, A, O;
  const n = (r = (s = c.state.data) == null ? void 0 : s.connector) == null ? void 0 : r.name, e = (m = (k = c.state.data) == null ? void 0 : k.wallet) == null ? void 0 : m.name, t = (A = ($ = c.state.data) == null ? void 0 : $.network) == null ? void 0 : A.name, i = e ?? n, a = M.getConnectors();
  return {
...
let w = class extends C {
  constructor() {
    super(), this.unsubscribe = [], this.heading = H()[c.state.view], this.network = h.state.activeCaipNetwork, this.networkImage = D.getNetworkImage(this.network), this.showBack = !1, this.prevHistoryLength = 1, this.view = c.state.view, this.viewDirection = "", this.headerText = H()[c.state.view], this.unsubscribe.push(le.subscribeNetworkImages(() => {
...
let U = class extends C {
  ...
  render() {
    const { message: e, variant: t, svg: i } = E.state, a = $e[t], { icon: o, iconColor: s } = i ?? a ?? {};
    return l`
      <wui-snackbar
        message=${e}
...
class v extends C {
  ...
  async onConnected(e) {
    if (e.isInProfileView)
      return;
    const { chainNamespace: t, chainId: i, address: a } = pe.parseCaipAddress(e.caipAddress), o = `${t}:${i}`, s = !he.getPlainAddress(this.caipAddress), r = await R.getSessions({ address: a, caipNetworkId: o }), k = R.getSIWX() ? r.some((A) => A.data.accountAddress === a) : !0, m = e.isSwitchingNamespace && k && !this.enableEmbedded, $ = this.enableEmbedded && s;
    m ? c.goBack() : $ && p.close();
  }
  onNewNetwork(e) {
    var Y, X, G;
    ...
    let N = !1;
    this.enableEmbedded && c.state.view === "SwitchNetwork" && (N = !0), ne && !A && !O && (ae ? r && (N = !0) : (se || m && !$) && (N = !0)), N && c.state.view !== "SIWXSignMessage" && c.goBack(), this.caipNetwork = e;
  }
  prefetch() {
