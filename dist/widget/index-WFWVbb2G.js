import { i as h, a as p, x as g } from "./lit-element-CWLRvgWK.js";
import { n as c } from "./class-map-BaJ3HzzH.js";
import { c as v } from "./index-D5_HZ1pl.js";
import { r as f, e as m } from "./index-C8kdZHDI.js";
const x = h`
  :host {
    display: inline-flex;
...
let o = class extends p {
  ...
  render() {
   ...
   `, g` <wui-icon color=${this.iconColor} size=${e} name=${this.icon}></wui-icon> `;
  }
};
o.styles = [f, m, x];
i([
