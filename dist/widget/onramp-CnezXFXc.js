import { i as P, a as y, x as u } from "./lit-element-CWLRvgWK.js";
import { o as m, r as c, n as p } from "./class-map-BaJ3HzzH.js";
import { L as l, Q as $, O as _, M as C, b as I, o as F, E, g as z, W as M, R as j, c as U, C as K, T as N, S as B } from "./index-C8kdZHDI.js";
import { c as b } from "./index-D5_HZ1pl.js";
...
let R = class extends y {
  constructor() {
    super(), this.unsubscribe = [], this.selectedCurrency = l.state.paymentCurrency, this.currencies = l.state.paymentCurrencies, this.currencyImages = $.state.currencyImages, this.checked = W.state.isLegalCheckboxChecked, this.unsubscribe.push(l.subscribe((e) => {
      this.selectedCurrency = e.paymentCurrency, this.currencies = e.paymentCurrencies;
    }), $.subscribeKey("currencyImages", (e) => this.currencyImages = e), W.subscribeKey("isLegalCheckboxChecked", (e) => {
      this.checked = e;
    }));
  }
  ...
  render() {
    var a;
    const { termsConditionsUrl: e, privacyPolicyUrl: t } = _.state, r = (a = _.state.features) == null ? void 0 : a.legalCheckbox, n = !!(e || t) && !!r && !this.checked;
    return u`
...
let S = class extends y {
  render() {
    const { termsConditionsUrl: e, privacyPolicyUrl: t } = _.state;
    return !e && !t ? null : u`
      <wui-flex
        .padding=${["m", "s", "s", "s"]}
        flexDirection="column"
  ...
  onWhatIsBuy() {
    E.sendEvent({
      ...
      properties: {
        isSmartAccount: z(I.state.activeChain) === M.ACCOUNT_TYPES.SMART_ACCOUNT
      }
    }), j.push("WhatIsABuy");
  }
};
...
let L = class extends y {
  ...
  onClickProvider(e) {
    var t;
    l.setSelectedProvider(e), j.push("BuyInProgress"), U.openHref(((t = l.state.selectedProvider) == null ? void 0 : t.url) || e.url, "popupWindow", "width=600,height=800,scrollbars=yes"), E.sendEvent({
      type: "track",
...
let k = class extends y {
  constructor() {
    super(), this.unsubscribe = [], this.selectedCurrency = l.state.purchaseCurrencies, this.tokens = l.state.purchaseCurrencies, this.tokenImages = $.state.tokenImages, this.checked = W.state.isLegalCheckboxChecked, this.unsubscribe.push(l.subscribe((e) => {
      this.selectedCurrency = e.purchaseCurrencies, this.tokens = e.purchaseCurrencies;
    }), $.subscribeKey("tokenImages", (e) => this.tokenImages = e), W.subscribeKey("isLegalCheckboxChecked", (e) => {
      this.checked = e;
    }));
  }
  disconnectedCallback() {
...
let d = class extends y {
  constructor() {
    super(), this.unsubscribe = [], this.selectedOnRampProvider = l.state.selectedProvider, this.uri = K.state.wcUri, this.ready = !1, this.showRetry = !1, this.buffering = !1, this.error = !1, this.isMobile = !1, this.onRetry = void 0, this.unsubscribe.push(l.subscribeKey("selectedProvider", (e) => {
  ...
  loaderTemplate() {
    const e = N.state.themeVariables["--w3m-border-radius-master"], t = e ? parseInt(e.replace("px", ""), 10) : 4;
    return u`<wui-loading-thumbnail radius=${t * 9}></wui-loading-thumbnail>`;
  }
  onCopyUri() {
    var e;
    if (!((e = this.selectedOnRampProvider) != null && e.url)) {
      B.showError("No link found"), j.goBack();
      return;
    }
    try {
