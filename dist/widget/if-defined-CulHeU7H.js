import { a1 as H, a2 as I, i as _, r as z, X as L, a as A } from "./index-C5WaG16p.js";
...
const R = {
  add: async () => (await import("./add-CWxBGSgT.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-C1dWaXWb.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-U_ekEEbJ.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-Dhso4psv.js")).appStoreSvg,
  apple: async () => (await import("./apple-govKWqnK.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-DdwFV84C.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-ZyPEpVIp.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-Cypc12oW.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-zB2uT3Tz.js")).arrowTopSvg,
  bank: async () => (await import("./bank-DG1L85Kz.js")).bankSvg,
  browser: async () => (await import("./browser-CcnQsfO7.js")).browserSvg,
  bin: async () => (await import("./bin-BooFqjOj.js")).binSvg,
  bitcoin: async () => (await import("./bitcoin-CYPm6i-j.js")).bitcoinSvg,
  card: async () => (await import("./card-BimJbyPU.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-diJXdqj5.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-DrKyA02x.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-B42MUBdh.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-cngMjbeo.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-D4nU9DSS.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-B2WExMLP.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-Ds6Zor00.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-BswrLayM.js")).clockSvg,
  close: async () => (await import("./close-CqZWtoWQ.js")).closeSvg,
  compass: async () => (await import("./compass-BJv6QQ9e.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-C_EwbaZD.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-BHtztu9S.js")).copySvg,
  cursor: async () => (await import("./cursor-CR29pI2N.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-DhYv5iUk.js")).cursorTransparentSvg,
  circle: async () => (await import("./circle--fuVrTwj.js")).circleSvg,
  desktop: async () => (await import("./desktop-Bp-sLNbM.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-7J7Mjp1u.js")).disconnectSvg,
  discord: async () => (await import("./discord-rC8wtlf-.js")).discordSvg,
  ethereum: async () => (await import("./ethereum-BlQ9gmb_.js")).ethereumSvg,
  etherscan: async () => (await import("./etherscan-BScesEQ0.js")).etherscanSvg,
  extension: async () => (await import("./extension-Czm058hf.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-YclLmHgH.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-QqwbtXT0.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-BnSobu7v.js")).farcasterSvg,
  filters: async () => (await import("./filters-CiU_s0lM.js")).filtersSvg,
  github: async () => (await import("./github-BJTkkkW2.js")).githubSvg,
  google: async () => (await import("./google-8Ek3SXlN.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-kGYT0czm.js")).helpCircleSvg,
  image: async () => (await import("./image-D3L84yMx.js")).imageSvg,
  id: async () => (await import("./id-BTAw_JAQ.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-UVN-N8Va.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-BS-Vwaqc.js")).lightbulbSvg,
  mail: async () => (await import("./mail-BG4WnWSw.js")).mailSvg,
  mobile: async () => (await import("./mobile-DyUUEyxJ.js")).mobileSvg,
  more: async () => (await import("./more-Bd_SpX6Q.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-rciuDkI7.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-Bos4726n.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-C5zCwt03.js")).offSvg,
  playStore: async () => (await import("./play-store-B0UFzOgS.js")).playStoreSvg,
  plus: async () => (await import("./plus-DDebA4WM.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-Cmw-P4Cq.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-D2JnRN2N.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-CxJ8C4FC.js")).refreshSvg,
  search: async () => (await import("./search-KD6DFBoh.js")).searchSvg,
  send: async () => (await import("./send-CW661ll5.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-D8RRRl7u.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-C2DP3TMm.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-DiWZBbps.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-3on2DEP0.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-XN6F9n5Q.js")).swapVerticalSvg,
  solana: async () => (await import("./solana-BZKpWOie.js")).solanaSvg,
  telegram: async () => (await import("./telegram-DpZ9YrlL.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-mtHxR6ok.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-BYqizrpl.js")).twitchSvg,
  twitter: async () => (await import("./x-CFSHjkAh.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-CITwCAnD.js")).twitterIconSvg,
  verify: async () => (await import("./verify-Buioqep3.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-Cp4SdEoR.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-D89vTT0A.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-WCag_vFx.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-WCag_vFx.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-WCag_vFx.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-CiqXAnsi.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-79vef5Aj.js")).warningCircleSvg,
  x: async () => (await import("./x-CFSHjkAh.js")).xSvg,
  info: async () => (await import("./info-esFEe6Ns.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-B_kZA-af.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-KW3jbJbu.js")).reownSvg,
  "x-mark": async () => (await import("./x-mark-D1J4OGt2.js")).xMarkSvg
};
async function it(t) {
  if (C.has(t))
    return C.get(t);
