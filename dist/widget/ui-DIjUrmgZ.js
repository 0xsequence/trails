import { i as j, a as A, x as c } from "./lit-element-CWLRvgWK.js";
import { n as T, r as u } from "./class-map-BaJ3HzzH.js";
import { b as g, v as U, x as b, y as K, a as O, z as m, B as z, A as L, D as M, F as x, R as f, O as w, S as v } from "./index-C8kdZHDI.js";
import { c as $, U as V } from "./index-D5_HZ1pl.js";
import { f as R } from "./index-B3-Q96dp.js";
class X {
  constructor(e) {
...
class B extends X {
  ...
  getNetworkName(e) {
    ...
    return U.getNetworkNameByCaipNetworkId(t, e);
  }
  stringify(e) {
    var s;
...
` : "",
      ...
      ((s = e.resources) == null ? void 0 : s.length) && e.resources.reduce((n, r) => `${n}
- ${r}`, "Resources:")
...
class _ {
  ...
  async getSessions(e, t) {
    try {
      ...
      return this.emit("sessionChanged", r), this.setAppKitAccountUser(i), [r];
    } catch {
      return [];
    }
  }
  ...
  async request({ method: e, key: t, query: i, body: s, headers: n }) {
    var k;
    const { projectId: r, st: o, sv: P } = this.getSDKProperties(), p = new URL(`${O.W3M_API_URL}/auth/v1/${String(t)}`);
    p.searchParams.set("projectId", r), p.searchParams.set("st", o), p.searchParams.set("sv", P), i && Object.entries(i).forEach(([h, C]) => p.searchParams.set(h, String(C)));
  ...
  getWalletInfo() {
    ...
    if (!e)
      return;
    if ("social" in e) {
      const n = e.social, r = e.identifier;
      return { type: "social", social: n, identifier: r };
    }
...
var q = function(a, e, t, i) {
  var s = arguments.length, n = s < 3 ? e : i === null ? i = Object.getOwnPropertyDescriptor(e, t) : i, r;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") n = Reflect.decorate(a, e, t, i);
  else for (var o = a.length - 1; o >= 0; o--) (r = a[o]) && (n = (s < 3 ? r(n) : s > 3 ? r(e, t, n) : r(e, t)) || n);
...
let E = class extends A {
  ...
  render() {
    const e = F.filter(this.filter.bind(this)).map(this.item.bind(this));
...
let l = class extends A {
  constructor() {
    var e, t, i, s, n, r, o;
    super(...arguments), this.email = ((e = f.state.data) == null ? void 0 : e.email) ?? ((i = (t = g.getAccountData()) == null ? void 0 : t.user) == null ? void 0 : i.email) ?? "", this.address = ((s = g.getAccountData()) == null ? void 0 : s.address) ?? "", this.loading = !1, this.appName = ((n = w.state.metadata) == null ? void 0 : n.name) ?? "AppKit", this.siwx = w.state.siwx, this.isRequired = Array.isArray((r = w.state.remoteFeatures) == null ? void 0 : r.emailCapture) && ((o = w.state.remoteFeatures) == null ? void 0 : o.emailCapture.includes("required")), this.recentEmails = this.getRecentEmails();
  }
  connectedCallback() {
