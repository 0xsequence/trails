...
class Yl extends e0 {
  ...
  async injectModalUi() {
    if (!vc && X.isClient()) {
      if (await import("./basic-BhuiMw9Y.js"), await import("./w3m-modal-DPhwBXvh.js"), !document.querySelector("w3m-modal")) {
