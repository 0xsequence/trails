import { defineChain as Sr, createPublicClient as Ar, http as At, isAddress as Te, isHex as te, hashTypedData as ot, hashMessage as hn, numberToHex as B, slice as Er, keccak256 as _r, toHex as ne, hexToBigInt as Ee, stringToBytes as Et, hexToBytes as Ve, trim as _t, encodeFunctionData as Y, decodeFunctionData as gn, BaseError as bn, encodeAbiParameters as vn, stringToHex as Ir, size as Cr, parseSignature as Pr, encodePacked as Tr, hexToString as It, pad as Or, decodeAbiParameters as yn, erc20Abi as jr, hexToNumber as He, isAddressEqual as Nr } from "viem";
import { J as st, K as ct, L as Ze, M as Rr } from "./index-BTADCVrB.js";
import { aj as Mr, ak as Br, al as Ur, am as Dr, an as Kr, ao as Ct, ap as Hr, aq as Pt, ar as Fr, as as Tt, _ as wn, a0 as Lr, at as zr, au as qr, av as Wr, aw as Vr, ax as Zr, ay as Jr, az as Yr, aA as Qr, aB as Xr, aC as Gr, aD as Ot } from "./prepareSend-CyXootal.js";
...
}, $r = ct(kn.p), ea = ct(xn.p), ta = ct(Sn.p), na = st({ ...kn, Fp: $r, lowS: !1 }, Mr);
st({ ...xn, Fp: ea, lowS: !1 }, Br);
st({ ...Sn, Fp: ta, lowS: !1, allowedPrivateKeyLengths: [130, 131, 132] }, Ur);
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const jt = na;
function ra(e, { delay: t = 100, retryCount: n = 2, shouldRetry: r = () => !0 } = {}) {
  return new Promise((a, i) => {
    const c = async ({ count: s = 0 } = {}) => {
      const u = async ({ error: o }) => {
        const d = typeof t == "function" ? t({ count: s, error: o }) : t;
        d && await Dr(d), c({ count: s + 1 });
      };
      try {
        const o = await e();
        a(o);
      } catch (o) {
        if (s < n && await r({ count: s, error: o }))
          return u({ error: o });
        i(o);
      }
    };
...
const aa = "0x5792579257925792579257925792579257925792579257925792579257925792", ia = Kr(0, {
  size: 32
});
async function oa(e, t) {
  async function n(d) {
    if (d.endsWith(aa.slice(2))) {
      const p = Fr(Tt(d, -64, -32)), f = Tt(d, 0, -64).slice(2).match(/.{1,64}/g), h = await Promise.all(f.map((v) => ia.slice(2) !== v ? e.request({
        method: "eth_getTransactionReceipt",
        params: [`0x${v}`]
      }, { dedupe: !0 }) : void 0)), m = h.some((v) => v === null) ? 100 : h.every((v) => (v == null ? void 0 : v.status) === "0x1") ? 200 : h.every((v) => (v == null ? void 0 : v.status) === "0x0") ? 500 : 600;
      return {
        atomic: !1,
        chainId: Ct(p),
  ...
  const { atomic: r = !1, chainId: a, receipts: i, version: c = "2.0.0", ...s } = await n(t.id), [u, o] = (() => {
    const d = s.status;
  ...
  return {
    ...
    chainId: a ? Ct(a) : void 0,
    receipts: (i == null ? void 0 : i.map((d) => ({
      ...d,
      blockNumber: Pt(d.blockNumber),
      gasUsed: Pt(d.gasUsed),
      status: Hr[d.status]
    }))) ?? [],
    statusCode: o,
    status: u,
...
async function An(e, t) {
  const {
    ...
    status: a = ({ statusCode: m }) => m === 200 || m >= 300,
    retryCount: i = 4,
    retryDelay: c = ({ count: m }) => ~~(1 << m) * 200,
    // exponential backoff
    timeout: s = 6e4,
    throwOnFailure: u = !1
  } = t, o = Lr(["waitForCallsStatus", e.uid, n]), { promise: d, resolve: l, reject: p } = zr();
  let f;
  const h = qr(o, { resolve: l, reject: p }, (m) => {
    const v = Wr(async () => {
      const y = (w) => {
        clearTimeout(f), v(), w(), h();
      };
      try {
        const w = await ra(async () => {
          const x = await oa(e, { id: n });
          if (u && x.status === "failure")
            throw new sa(x);
          return x;
        }, {
          retryCount: i,
  ...
  return f = s ? setTimeout(() => {
    h(), clearTimeout(f), p(new ca({ id: n }));
  }, s) : void 0, await d;
}
class ca extends wn {
  constructor({ id: t }) {
...
const ua = "@base-org/account", la = "1.1.1", En = {
  name: ua,
  version: la
}, da = "https://keys.coinbase.com/connect", _n = "https://rpc.wallet.coinbase.com", Re = En.name, se = En.version;
function In(e, t) {
  let n;
  try {
    n = e();
  ...
  return {
    getItem: (a) => {
      var i;
      const c = (u) => u === null ? null : JSON.parse(u, void 0), s = (i = n.getItem(a)) != null ? i : null;
...
const Je = (e) => (t) => {
  ...
  const h = () => {
    ...
    const y = ((v = i.onRehydrateStorage) == null ? void 0 : v.call(i, (m = r()) != null ? m : p)) || void 0;
    return Je(o.getItem.bind(o))(i.name).then((w) => {
      if (w)
        if (typeof w.version == "number" && w.version !== i.version) {
          if (i.migrate) {
            ...
            return x instanceof Promise ? x.then((k) => [!0, k]) : [!0, x];
          }
          console.error(
      ...
      y == null || y(f, void 0), f = r(), c = !0, u.forEach((w) => w(f));
    }).catch((w) => {
      y == null || y(void 0, w);
    });
  };
  return a.persist = {
    setOptions: (m) => {
      i = {
        ...i,
        ...m
      }, m.storage && (o = m.storage);
    },
    clearStorage: () => {
      o == null || o.removeItem(i.name);
    },
    getOptions: () => i,
    rehydrate: () => h(),
    hasHydrated: () => c,
  ...
  let t;
  const n = /* @__PURE__ */ new Set(), r = (o, d) => {
    const l = typeof o == "function" ? o(t) : o;
    if (!Object.is(l, t)) {
      const p = t;
      t = d ?? (typeof l != "object" || l === null) ? l : Object.assign({}, t, l), n.forEach((f) => f(t, p));
    }
  }, a = () => t, s = { setState: r, getState: a, getInitialState: () => u, subscribe: (o) => (n.add(o), () => n.delete(o)) }, u = t = e(r, a, s);
  return s;
}, ut = (e) => e ? Nt(e) : Nt, ma = () => ({
  chains: []
}), ha = () => ({
...
}), N = ut(pa((...e) => Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, ma(...e)), ha(...e)), ga(...e)), ba(...e)), ya(...e)), wa(...e)), va(...e)), {
  ...
  get: () => N.getState().subAccountConfig,
  set: (e) => {
    N.setState((t) => ({
  ...
  get: () => N.getState().spendPermissions,
  set: (e) => {
    N.setState({ spendPermissions: e });
  },
  clear: () => {
    N.setState({
      spendPermissions: []
  ...
  get: (e) => N.getState().keys[e],
  set: (e, t) => {
    N.setState((n) => ({ keys: Object.assign(Object.assign({}, n.keys), { [e]: t }) }));
  },
  clear: () => {
    N.setState({
      keys: {}
  ...
  var e, t, n;
  if (typeof window < "u") {
    const r = (n = (e = g.config.get().deviceId) !== null && e !== void 0 ? e : (t = window.crypto) === null || t === void 0 ? void 0 : t.randomUUID()) !== null && n !== void 0 ? n : "";
    if (window.ClientAnalytics) {
      const { init: a, identify: i, PlatformName: c } = window.ClientAnalytics;
      a({
        isProd: !0,
      ...
      }), i({ deviceId: r }), g.config.set({ deviceId: r });
    }
  }
}, Oa = "0xba5ed110efdba3d005bfc882d75358acbbb85842", Pn = "0xf85210B21cC50302F477BA56686d2019dC9b67Ad", H = [
...
}, On = "Unspecified error message.", ja = "Unspecified server error.";
function lt(e, t = On) {
...
function Ra(e, { shouldIncludeStack: t = !1 } = {}) {
  const n = {};
  if (e && typeof e == "object" && !Array.isArray(e) && Qe(e, "code") && Na(e.code)) {
    const r = e;
    n.code = r.code, r.message && typeof r.message == "string" ? (n.message = r.message, Qe(r, "data") && (n.data = r.data)) : (n.message = lt(n.code), n.data = { originalError: Rt(e) });
  } else
    n.code = O.rpc.internal, n.message = Mt(e, "message") ? e.message : On, n.data = { originalError: Rt(e) };
  return t && (n.stack = Mt(e, "stack") ? e.stack : void 0), n;
}
function jn(e) {
...
const b = {
  rpc: {
    parse: (e) => U(O.rpc.parse, e),
    invalidRequest: (e) => U(O.rpc.invalidRequest, e),
    invalidParams: (e) => U(O.rpc.invalidParams, e),
    methodNotFound: (e) => U(O.rpc.methodNotFound, e),
    internal: (e) => U(O.rpc.internal, e),
    server: (e) => {
    ...
    invalidInput: (e) => U(O.rpc.invalidInput, e),
    resourceNotFound: (e) => U(O.rpc.resourceNotFound, e),
    resourceUnavailable: (e) => U(O.rpc.resourceUnavailable, e),
    transactionRejected: (e) => U(O.rpc.transactionRejected, e),
    methodNotSupported: (e) => U(O.rpc.methodNotSupported, e),
    limitExceeded: (e) => U(O.rpc.limitExceeded, e)
  },
  provider: {
    userRejectedRequest: (e) => ee(O.provider.userRejectedRequest, e),
    unauthorized: (e) => ee(O.provider.unauthorized, e),
    unsupportedMethod: (e) => ee(O.provider.unsupportedMethod, e),
    disconnected: (e) => ee(O.provider.disconnected, e),
    chainDisconnected: (e) => ee(O.provider.chainDisconnected, e),
    unsupportedChain: (e) => ee(O.provider.unsupportedChain, e),
    custom: (e) => {
      if (!e || typeof e != "object" || Array.isArray(e))
...
function U(e, t) {
  const [n, r] = Nn(t);
  return new dt(e, n || lt(e), r);
}
function ee(e, t) {
  const [n, r] = Nn(t);
  return new Rn(e, n || lt(e), r);
}
function Nn(e) {
  if (e) {
    if (typeof e == "string")
...
function Ba(e) {
  try {
    ...
    return new dt(t.code, t.message, t.data);
  } catch {
    return null;
  }
}
...
const Ua = `Base Account SDK requires the Cross-Origin-Opener-Policy header to not be set to 'same-origin'. This is to ensure that the SDK can communicate with the Base Account app.

Please see https://docs.base.org/smart-wallet/quickstart#cross-origin-opener-policy for more information.`, Da = () => {
  let e;
  return {
    ...
    checkCrossOriginOpenerPolicy: async () => {
      ...
      try {
        ...
        e = r ?? "null", e === "same-origin" && console.error(Ua);
      } catch (t) {
        console.error("Error checking Cross-Origin-Opener-Policy:", t.message), e = "error";
      }
    }
  };
}, { checkCrossOriginOpenerPolicy: Ka, getCrossOriginOpenerPolicy: Ha } = Da();
function Fa(e) {
  if (e) {
...
function P(e, t, n) {
  var r, a, i;
  window.ClientAnalytics && ((r = window.ClientAnalytics) === null || r === void 0 || r.logEvent(e, Object.assign(Object.assign({}, t), { sdkVersion: se, sdkName: Re, appName: (i = (a = g.config.get().metadata) === null || a === void 0 ? void 0 : a.appName) !== null && i !== void 0 ? i : "", appOrigin: window.location.origin }), n));
}
const La = () => {
  P("communicator.popup_setup.started", {
    action: E.unknown,
    componentType: A.unknown
  }, _.high);
}, za = () => {
  P("communicator.popup_setup.completed", {
    action: E.unknown,
    componentType: A.unknown
  }, _.high);
}, qa = () => {
  P("communicator.popup_unload.received", {
    action: E.unknown,
    componentType: A.unknown
  }, _.high);
}, ft = ({ dialogContext: e }) => {
  P(`dialog.${e}.shown`, {
    action: E.render,
    componentType: A.modal,
    dialogContext: e
  }, _.high);
}, Bn = ({ dialogContext: e }) => {
  P(`dialog.${e}.dismissed`, {
    action: E.dismiss,
    componentType: A.modal,
    dialogContext: e
  }, _.high);
}, G = ({ dialogContext: e, dialogAction: t }) => {
  P(`dialog.${e}.action_clicked`, {
    action: E.click,
...
`, Dt = "BaseSans-Regular";
function Va() {
  if (document.head.querySelector(`style[base-sdk-font="${Dt}"]`))
    return;
  const t = document.createElement("style");
  t.setAttribute("base-sdk-font", Dt), t.textContent = Wa, document.head.appendChild(t);
}
var Me, S, Un, X, Kt, Dn, Xe, pt, Ge, $e, de = {}, Kn = [], Za = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, mt = Array.isArray;
function Z(e, t) {
...
function Fn(e, t, n) {
  var r, a, i, c = {};
  for (i in t) i == "key" ? r = t[i] : i == "ref" ? a = t[i] : c[i] = t[i];
  if (arguments.length > 2 && (c.children = arguments.length > 3 ? Me.call(arguments, 2) : n), typeof e == "function" && e.defaultProps != null) for (i in e.defaultProps) c[i] === void 0 && (c[i] = e.defaultProps[i]);
  return _e(e, c, r, a, null);
}
function _e(e, t, n, r, a) {
  var i = { type: e, props: t, key: n, ref: r, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: a ?? ++Un, __i: -1, __u: 0 };
...
function re(e, t) {
  if (t == null) return e.__ ? re(e.__, e.__i + 1) : null;
...
function Ht(e) {
  (!e.__d && (e.__d = !0) && X.push(e) && !Oe.__r++ || Kt !== S.debounceRendering) && ((Kt = S.debounceRendering) || Dn)(Oe);
}
function Oe() {
  var e, t, n, r, a, i, c, s;
  for (X.sort(Xe); e = X.shift(); ) e.__d && (t = X.length, r = void 0, i = (a = (n = e).__v).__e, c = [], s = [], n.__P && ((r = Z({}, a)).__v = a.__v + 1, S.vnode && S.vnode(r), ht(n.__P, r, a, n.__n, n.__P.namespaceURI, 32 & a.__u ? [i] : null, c, i ?? re(a), !!(32 & a.__u), s), r.__v = a.__v, r.__.__k[r.__i] = r, Wn(c, r, s), r.__e != i && Ln(r)), X.length > t && X.sort(Xe));
  Oe.__r = 0;
}
function zn(e, t, n, r, a, i, c, s, u, o, d) {
  var l, p, f, h, m, v = r && r.__k || Kn, y = t.length;
  for (n.__d = u, Ja(n, t, v), u = n.__d, l = 0; l < y; l++) (f = n.__k[l]) != null && (p = f.__i === -1 ? de : v[f.__i] || de, f.__i = l, ht(e, f, p, a, i, c, s, u, o, d), h = f.__e, f.ref && p.ref != f.ref && (p.ref && gt(p.ref, null, f), d.push(f.ref, f.__c || h, f)), m == null && h != null && (m = h), 65536 & f.__u || p.__k === f.__k ? u = qn(f, u, e) : typeof f.type == "function" && f.__d !== void 0 ? u = f.__d : h && (u = h.nextSibling), f.__d = void 0, f.__u &= -196609);
  n.__d = u, n.__e = m;
}
function Ja(e, t, n) {
  var r, a, i, c, s, u = t.length, o = n.length, d = o, l = 0;
  for (e.__k = [], r = 0; r < u; r++) (a = t[r]) != null && typeof a != "boolean" && typeof a != "function" ? (c = r + l, (a = e.__k[r] = typeof a == "string" || typeof a == "number" || typeof a == "bigint" || a.constructor == String ? _e(null, a, null, null, null) : mt(a) ? _e(Be, { children: a }, null, null, null) : a.constructor === void 0 && a.__b > 0 ? _e(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v) : a).__ = e, a.__b = e.__b + 1, i = null, (s = a.__i = Ya(a, n, c, d)) !== -1 && (d--, (i = n[s]) && (i.__u |= 131072)), i == null || i.__v === null ? (s == -1 && l--, typeof a.type != "function" && (a.__u |= 65536)) : s !== c && (s == c - 1 ? l-- : s == c + 1 ? l++ : (s > c ? l-- : l++, a.__u |= 65536))) : a = e.__k[r] = null;
  if (d) for (r = 0; r < o; r++) (i = n[r]) != null && !(131072 & i.__u) && (i.__e == e.__d && (e.__d = re(i)), Vn(i, i));
}
function qn(e, t, n) {
  var r, a;
  if (typeof e.type == "function") {
    for (r = e.__k, a = 0; r && a < r.length; a++) r[a] && (r[a].__ = e, t = qn(r[a], t, n));
    return t;
  }
  e.__e != t && (t && e.type && !n.contains(t) && (t = re(e)), n.insertBefore(e.__e, t || null), t = e.__e);
  do
    t = t && t.nextSibling;
...
function Ya(e, t, n, r) {
  var a = e.key, i = e.type, c = n - 1, s = n + 1, u = t[n];
  if (u === null || u && a == u.key && i === u.type && !(131072 & u.__u)) return n;
  if (r > (u != null && !(131072 & u.__u) ? 1 : 0)) for (; c >= 0 || s < t.length; ) {
    if (c >= 0) {
      if ((u = t[c]) && !(131072 & u.__u) && a == u.key && i === u.type) return c;
      c--;
    }
    if (s < t.length) {
      if ((u = t[s]) && !(131072 & u.__u) && a == u.key && i === u.type) return s;
      s++;
    }
  }
  return -1;
...
function he(e, t, n, r, a) {
  ...
  else if (t[0] === "o" && t[1] === "n") i = t !== (t = t.replace(/(PointerCapture)$|Capture$/i, "$1")), t = t.toLowerCase() in e || t === "onFocusOut" || t === "onFocusIn" ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + i] = n, n ? r ? n.u = r.u : (n.u = pt, e.addEventListener(t, i ? $e : Ge, i)) : e.removeEventListener(t, i ? $e : Ge, i);
  else {
...
function ht(e, t, n, r, a, i, c, s, u, o) {
  var d, l, p, f, h, m, v, y, w, x, k, I, M, L, W, pe, F = t.type;
  if (t.constructor !== void 0) return null;
  128 & n.__u && (u = !!(32 & n.__u), i = [s = t.__e = n.__e]), (d = S.__b) && d(t);
  e: if (typeof F == "function") try {
    if (y = t.props, w = "prototype" in F && F.prototype.render, x = (d = F.contextType) && r[d.__c], k = d ? x ? x.props.value : d.__ : r, n.__c ? v = (l = t.__c = n.__c).__ = l.__E : (w ? t.__c = l = new F(y, k) : (t.__c = l = new Ie(y, k), l.constructor = F, l.render = Xa), x && x.sub(l), l.props = y, l.state || (l.state = {}), l.context = k, l.__n = r, p = l.__d = !0, l.__h = [], l._sb = []), w && l.__s == null && (l.__s = l.state), w && F.getDerivedStateFromProps != null && (l.__s == l.state && (l.__s = Z({}, l.__s)), Z(l.__s, F.getDerivedStateFromProps(y, l.__s))), f = l.props, h = l.state, l.__v = t, p) w && F.getDerivedStateFromProps == null && l.componentWillMount != null && l.componentWillMount(), w && l.componentDidMount != null && l.__h.push(l.componentDidMount);
    else {
      if (w && F.getDerivedStateFromProps == null && y !== f && l.componentWillReceiveProps != null && l.componentWillReceiveProps(y, k), !l.__e && (l.shouldComponentUpdate != null && l.shouldComponentUpdate(y, l.__s, k) === !1 || t.__v === n.__v)) {
        for (t.__v !== n.__v && (l.props = y, l.state = l.__s, l.__d = !1), t.__e = n.__e, t.__k = n.__k, t.__k.some(function(me) {
          me && (me.__ = t);
        }), I = 0; I < l._sb.length; I++) l.__h.push(l._sb[I]);
        l._sb = [], l.__h.length && c.push(l);
        break e;
      }
      l.componentWillUpdate != null && l.componentWillUpdate(y, l.__s, k), w && l.componentDidUpdate != null && l.__h.push(function() {
        l.componentDidUpdate(f, h, m);
      });
    }
    if (l.context = k, l.props = y, l.__P = e, l.__e = !1, M = S.__r, L = 0, w) {
      for (l.state = l.__s, l.__d = !1, M && M(t), d = l.render(l.props, l.state, l.context), W = 0; W < l._sb.length; W++) l.__h.push(l._sb[W]);
      l._sb = [];
    } else do
      l.__d = !1, M && M(t), d = l.render(l.props, l.state, l.context), l.state = l.__s;
    while (l.__d && ++L < 25);
    l.state = l.__s, l.getChildContext != null && (r = Z(Z({}, r), l.getChildContext())), w && !p && l.getSnapshotBeforeUpdate != null && (m = l.getSnapshotBeforeUpdate(f, h)), zn(e, mt(pe = d != null && d.type === Be && d.key == null ? d.props.children : d) ? pe : [pe], t, n, r, a, i, c, s, u, o), l.base = t.__e, t.__u &= -161, l.__h.length && c.push(l), v && (l.__E = l.__ = null);
  } catch (me) {
    if (t.__v = null, u || i != null) {
      for (t.__u |= u ? 160 : 32; s && s.nodeType === 8 && s.nextSibling; ) s = s.nextSibling;
      i[i.indexOf(s)] = null, t.__e = s;
    } else t.__e = n.__e, t.__k = n.__k;
    S.__e(me, t, n);
  }
  else i == null && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = Qa(n.__e, t, n, r, a, i, c, u, o);
  (d = S.diffed) && d(t);
}
function Wn(e, t, n) {
  t.__d = void 0;
  for (var r = 0; r < n.length; r++) gt(n[r], n[++r], n[++r]);
  S.__c && S.__c(t, e), e.some(function(a) {
    try {
...
function Qa(e, t, n, r, a, i, c, s, u) {
  var o, d, l, p, f, h, m, v = n.props, y = t.props, w = t.type;
  if (w === "svg" ? a = "http://www.w3.org/2000/svg" : w === "math" ? a = "http://www.w3.org/1998/Math/MathML" : a || (a = "http://www.w3.org/1999/xhtml"), i != null) {
    for (o = 0; o < i.length; o++) if ((f = i[o]) && "setAttribute" in f == !!w && (w ? f.localName === w : f.nodeType === 3)) {
      e = f, i[o] = null;
      break;
    }
  }
  if (e == null) {
    ...
    e = document.createElementNS(a, w, y.is && y), s && (S.__m && S.__m(t, i), s = !1), i = null;
  }
  if (w === null) v === y || s && e.data === y || (e.data = y);
  else {
    if (i = i && Me.call(e.childNodes), v = n.props || de, !s && i != null) for (v = {}, o = 0; o < e.attributes.length; o++) v[(f = e.attributes[o]).name] = f.value;
    for (o in v) if (f = v[o], o != "children") {
      if (o == "dangerouslySetInnerHTML") l = f;
      else if (!(o in y)) {
        if (o == "value" && "defaultValue" in y || o == "checked" && "defaultChecked" in y) continue;
        he(e, o, null, f, a);
      }
    }
    for (o in y) f = y[o], o == "children" ? p = f : o == "dangerouslySetInnerHTML" ? d = f : o == "value" ? h = f : o == "checked" ? m = f : s && typeof f != "function" || v[o] === f || he(e, o, f, v[o], a);
    if (d) s || l && (d.__html === l.__html || d.__html === e.innerHTML) || (e.innerHTML = d.__html), t.__k = [];
    else if (l && (e.innerHTML = ""), zn(e, mt(p) ? p : [p], t, n, r, w === "foreignObject" ? "http://www.w3.org/1999/xhtml" : a, i, c, i ? i[0] : n.__k && re(n, 0), s, u), i != null) for (o = i.length; o--; ) Hn(i[o]);
    s || (o = "value", w === "progress" && h == null ? e.removeAttribute("value") : h !== void 0 && (h !== e[o] || w === "progress" && !h || w === "option" && h !== v[o]) && he(e, o, h, v[o], a), o = "checked", m !== void 0 && m !== e[o] && he(e, o, m, v[o], a));
  }
  return e;
}
function gt(e, t, n) {
...
function Vn(e, t, n) {
  var r, a;
  if (S.unmount && S.unmount(e), (r = e.ref) && (r.current && r.current !== e.__e || gt(r, null, t)), (r = e.__c) != null) {
  ...
  if (r = e.__k) for (a = 0; a < r.length; a++) r[a] && Vn(r[a], t, n || typeof e.type != "function");
  n || Hn(e.__e), e.__c = e.__ = e.__e = e.__d = void 0;
}
function Xa(e, t, n) {
...
function zt(e, t, n) {
  var r, a, i, c;
  S.__ && S.__(e, t), a = (r = !1) ? null : t.__k, i = [], c = [], ht(t, e = t.__k = Fn(Be, null, [e]), a || de, de, t.namespaceURI, a ? null : t.firstChild ? Me.call(t.childNodes) : null, i, a ? a.__e : t.firstChild, r, c), Wn(i, e, c);
}
Me = Kn.slice, S = { __e: function(e, t, n, r) {
  for (var a, i, c; t = t.__; ) if ((a = t.__c) && !a.__) try {
    if ((i = a.constructor) && i.getDerivedStateFromError != null && (a.setState(i.getDerivedStateFromError(e)), c = a.__d), a.componentDidCatch != null && (a.componentDidCatch(e, r || {}), c = a.__d), c) return a.__E = a;
  } catch (s) {
    e = s;
  }
  throw e;
} }, Un = 0, Ie.prototype.setState = function(e, t) {
  var n;
...
}, Ie.prototype.render = Be, X = [], Dn = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Xe = function(e, t) {
  return e.__v.__b - t.__v.__b;
}, Oe.__r = 0, pt = 0, Ge = Lt(!1), $e = Lt(!0);
var Ga = 0;
function T(e, t, n, r, a, i) {
  t || (t = {});
  var c, s, u = t;
  "ref" in t && (c = t.ref, delete t.ref);
  var o = { type: e, props: u, key: n, ref: c, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: --Ga, __i: -1, __u: 0, __source: a, __self: i };
...
function ai(e, t, n) {
  var r = bt(fe++, 2);
  if (r.t = e, !r.__c && (r.__ = [Yn(void 0, t), function(s) {
    var u = r.__N ? r.__N[0] : r.__[0], o = r.t(u, s);
    u !== o && (r.__N = [o, r.__[1]], r.__c.setState({}));
  }], r.__c = j, !j.u)) {
    var a = function(s, u, o) {
      ...
      }), !(!l && r.__c.props === s) && (!i || i.call(this, s, u, o));
    };
    j.u = !0;
    var i = j.shouldComponentUpdate, c = j.componentWillUpdate;
    j.componentWillUpdate = function(s, u, o) {
      if (this.__e) {
        var d = i;
        i = void 0, a(s, u, o), i = d;
      }
      c && c.call(this, s, u, o);
...
function tt(e, t) {
  var n = bt(fe++, 3);
  !R.__s && Jn(n.__H, t) && (n.__ = e, n.i = t, j.__H.__h.push(n));
}
function ii(e, t) {
  var n = bt(fe++, 7);
  return Jn(n.__H, t) && (n.__ = e(), n.__H = t, n.__h = e), n.__;
}
function oi() {
  for (var e; e = Zn.shift(); ) if (e.__P && e.__H) try {
    e.__H.__h.forEach(Ce), e.__H.__h.forEach(nt), e.__H.__h = [];
  } catch (t) {
...
R.__b = function(e) {
  ...
  Vt && Vt(e), fe = 0;
  var t = (j = e.__c).__H;
  t && (Fe === j ? (t.__h = [], j.__h = [], t.__.forEach(function(n) {
    n.__N && (n.__ = n.__N), n.i = n.__N = void 0;
  })) : (t.__h.forEach(Ce), t.__h.forEach(nt), t.__h = [], fe = 0)), Fe = j;
}, R.diffed = function(e) {
  Zt && Zt(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (Zn.push(t) !== 1 && qt === R.requestAnimationFrame || ((qt = R.requestAnimationFrame) || si)(oi)), t.__H.__.forEach(function(n) {
...
const li = () => {
  ...
  }, []), e ? T("div", { class: "-base-acc-sdk-dialog-handle-bar" }) : null;
};
class di {
  constructor() {
  ...
  clear() {
    this.items.clear(), this.root && zt(null, this.root);
  }
  render() {
    this.root && zt(T("div", { children: T(fi, { children: Array.from(this.items.entries()).map(([t, n]) => Fn(pi, Object.assign({}, n, { key: t, handleClose: () => {
      var r;
...
const fi = (e) => {
  const [t, n] = $(0), [r, a] = $(!1), [i, c] = $(0), s = (d) => {
    ...
    if (!r)
      return;
    const p = d.touches[0].clientY - i;
    p > 0 && (n(p), d.preventDefault());
  }, o = () => {
    if (r)
      if (a(!1), t > 100) {
        const d = document.querySelector(".-base-acc-sdk-dialog-instance-header-close");
        d && d.click();
      } else
        n(0);
  };
  return T("div", { class: Ze("-base-acc-sdk-dialog-container"), children: [T("style", { children: ci }), T("div", { class: "-base-acc-sdk-dialog-backdrop", onTouchStart: s, onTouchMove: u, onTouchEnd: o, children: T("div", { class: "-base-acc-sdk-dialog", style: {
    transform: `translateY(${t}px)`,
    transition: r ? "none" : "transform 0.2s ease-out"
  }, children: [T(li, {}), e.children] }) })] });
}, pi = ({ title: e, message: t, actionItems: n, handleClose: r }) => {
  const [a, i] = $(!0), [c, s] = $(!0), [u, o] = $(null);
  tt(() => {
    ...
    (async () => {
      var f;
      const h = (f = g.account.get().accounts) === null || f === void 0 ? void 0 : f[0];
      if (h) {
        const m = await $a(h);
        o(m);
      }
  ...
  const d = ii(() => u ? `Signed in as ${u}` : "Base Account", [u]), l = !c;
  return T("div", { class: Ze("-base-acc-sdk-dialog-instance", a && "-base-acc-sdk-dialog-instance-hidden"), children: [T("div", { class: "-base-acc-sdk-dialog-instance-header", children: [T("div", { class: "-base-acc-sdk-dialog-instance-header-icon-and-title", children: [T(ri, { fill: "blue" }), l && T("div", { class: "-base-acc-sdk-dialog-instance-header-icon-and-title-title", children: d })] }), T("div", { class: "-base-acc-sdk-dialog-instance-header-close", onClick: r, children: T("img", { src: ui, class: "-base-acc-sdk-dialog-instance-header-close-icon" }) })] }), T("div", { class: "-base-acc-sdk-dialog-instance-content", children: [T("div", { class: "-base-acc-sdk-dialog-instance-content-title", children: e }), T("div", { class: "-base-acc-sdk-dialog-instance-content-message", children: t })] }), n && n.length > 0 && T("div", { class: "-base-acc-sdk-dialog-instance-actions", children: n.map((p, f) => T("button", { class: Ze("-base-acc-sdk-dialog-instance-button", p.variant === "primary" && "-base-acc-sdk-dialog-instance-button-primary", p.variant === "secondary" && "-base-acc-sdk-dialog-instance-button-secondary"), onClick: p.onClick, children: p.text }, f)) })] });
};
let ge = null;
function vt() {
  if (!ge) {
    const e = document.createElement("div");
    e.className = "-base-acc-sdk-css-reset", document.body.appendChild(e), ge = new di(), ge.attach(e);
  }
  return Va(), ge;
}
const Gt = 420, $t = 700, mi = "{app} wants to continue in Base Account", hi = "This action requires your permission to open a new window.";
function gi(e) {
  const t = (window.innerWidth - Gt) / 2 + window.screenX, n = (window.innerHeight - $t) / 2 + window.screenY;
  vi(e);
  function r() {
    const i = `wallet_${crypto.randomUUID()}`, c = window.open(e, i, `width=${Gt}, height=${$t}, left=${t}, top=${n}`);
    return c == null || c.focus(), c || null;
  }
  const a = r();
  return a ? Promise.resolve(a) : yi(r);
}
function bi(e) {
  e && !e.closed && e.close();
}
...
function yi(e) {
  var t, n;
  const r = (n = (t = g.config.get().metadata) === null || t === void 0 ? void 0 : t.appName) !== null && n !== void 0 ? n : "App", a = vt();
  return new Promise((i, c) => {
    ft({ dialogContext: "popup_blocked" }), a.presentItem({
      title: mi.replace("{app}", r),
      message: hi,
      onClose: () => {
        G({
          dialogContext: "popup_blocked",
          dialogAction: "cancel"
        }), c(b.rpc.internal("Popup window was blocked"));
      },
      actionItems: [
        {
          text: "Try again",
          ...
          onClick: () => {
            ...
            const s = e();
            s ? i(s) : c(b.rpc.internal("Popup window was blocked")), a.clear();
          }
        },
        {
          text: "Cancel",
          ...
          onClick: () => {
            G({
              dialogContext: "popup_blocked",
              dialogAction: "cancel"
            }), c(b.rpc.internal("Popup window was blocked")), a.clear();
          }
        }
      ]
    });
...
class wi {
  constructor({ url: t = da, metadata: n, preference: r }) {
    this.popup = null, this.listeners = /* @__PURE__ */ new Map(), this.postMessage = async (a) => {
      ...
      const i = this.onMessage(({ requestId: c }) => c === a.id);
      return this.postMessage(a), await i;
    }, this.onMessage = async (a) => new Promise((i, c) => {
      const s = (u) => {
        if (u.origin !== this.url.origin)
          return;
        const o = u.data;
        a(o) && (i(o), window.removeEventListener("message", s), this.listeners.delete(s));
      };
      window.addEventListener("message", s), this.listeners.set(s, { reject: c });
    }), this.disconnect = () => {
      bi(this.popup), this.popup = null, this.listeners.forEach(({ reject: a }, i) => {
        a(b.provider.userRejectedRequest("Request rejected")), window.removeEventListener("message", i);
      }), this.listeners.clear();
    }, this.waitForPopupLoaded = async () => this.popup && !this.popup.closed ? (this.popup.focus(), this.popup) : (La(), this.popup = await gi(this.url), this.onMessage(({ event: a }) => a === "PopupUnload").then(() => {
      this.disconnect(), qa();
    }).catch(() => {
...
function ki(e) {
  ...
  return n.searchParams.set("version", se), n.searchParams.set("code", t.code.toString()), n.searchParams.set("message", t.message), Object.assign(Object.assign({}, t), { docUrl: n.href });
}
function xi(e) {
...
function Si(e) {
  ...
  if (xi(e)) {
    const n = e.errorMessage, r = (t = e.errorCode) !== null && t !== void 0 ? t : n.match(/(denied|rejected)/i) ? O.provider.userRejectedRequest : void 0;
...
const Ei = ({ method: e, correlationId: t }) => {
  P("provider.request.started", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
...
}, _i = ({ method: e, correlationId: t, errorMessage: n }) => {
  P("provider.request.error", {
    action: E.error,
    componentType: A.unknown,
    method: e,
    signerType: "base-account",
...
}, Ii = ({ method: e, correlationId: t }) => {
  P("provider.request.responded", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
    signerType: "base-account",
...
function Gn(e) {
  return je(`0x${BigInt(e).toString(16)}`);
}
function ji(e) {
  return e.startsWith("0x") || e.startsWith("0X");
}
function $n(e) {
  return ji(e) ? e.slice(2) : e;
}
function Ni(e) {
  if (typeof e != "string")
    return !1;
...
function rt(e, t = !1) {
  if (typeof e == "string") {
    const n = $n(e).toLowerCase();
    if (Xn.test(n))
      return je(t ? `0x${n}` : n);
  }
  throw b.rpc.invalidParams(`"${String(e)}" is not a hexadecimal string`);
}
function Ri(e, t = !1) {
  let n = rt(e, !1);
  return n.length % 2 === 1 && (n = je(`0${n}`)), t ? je(`0x${n}`) : n;
}
function Mi(e) {
  ...
  if (typeof e == "string") {
    if (Pi.test(e))
      return Le(Number(e));
    if (Ni(e))
      return Le(Number(BigInt(Ri(e, !0))));
  }
  throw b.rpc.invalidParams(`Not an integer: ${String(e)}`);
}
const Bi = ({ method: e, correlationId: t }) => {
  var n;
  P("scw_signer.handshake.started", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
    correlationId: t,
    enableAutoSubAccounts: (n = g.subAccountsConfig.get()) === null || n === void 0 ? void 0 : n.enableAutoSubAccounts
  }, _.high);
}, Ui = ({ method: e, correlationId: t, errorMessage: n }) => {
  var r;
  P("scw_signer.handshake.error", {
    action: E.error,
    componentType: A.unknown,
    method: e,
    correlationId: t,
    errorMessage: n,
    enableAutoSubAccounts: (r = g.subAccountsConfig.get()) === null || r === void 0 ? void 0 : r.enableAutoSubAccounts
  }, _.high);
}, Di = ({ method: e, correlationId: t }) => {
  var n;
  P("scw_signer.handshake.completed", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, Ki = ({ method: e, correlationId: t }) => {
  var n;
  P("scw_signer.request.started", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, Hi = ({ method: e, correlationId: t, errorMessage: n }) => {
  var r;
  P("scw_signer.request.error", {
    action: E.error,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, Fi = ({ method: e, correlationId: t }) => {
  var n;
  P("scw_signer.request.completed", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, Li = ({ method: e, correlationId: t }) => {
  var n;
  P("scw_sub_account.request.started", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, zi = ({ method: e, correlationId: t }) => {
  var n;
  P("scw_sub_account.request.completed", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, qi = ({ method: e, correlationId: t, errorMessage: n }) => {
  var r;
  P("scw_sub_account.request.error", {
    action: E.error,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, Wi = ({ method: e, correlationId: t }) => {
  var n;
  P("scw_sub_account.add_owner.started", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, Vi = ({ method: e, correlationId: t }) => {
  var n;
  P("scw_sub_account.add_owner.completed", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, Zi = ({ method: e, correlationId: t, errorMessage: n }) => {
  var r;
  P("scw_sub_account.add_owner.error", {
    action: E.error,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, Ji = ({ method: e, correlationId: t }) => {
  var n;
  P("scw_sub_account.insufficient_balance.error_handling.started", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, Yi = ({ method: e, correlationId: t }) => {
  var n;
  P("scw_sub_account.insufficient_balance.error_handling.completed", {
    action: E.unknown,
    componentType: A.unknown,
    method: e,
    correlationId: t,
  ...
  var r;
  P("scw_sub_account.insufficient_balance.error_handling.error", {
    action: E.error,
    componentType: A.unknown,
    method: e,
    correlationId: t,
...
}, ce = (e) => "message" in e && typeof e.message == "string" ? e.message : "", er = ut(() => ({}));
function en(e) {
  e.forEach((t) => {
    var n, r, a, i, c, s, u, o;
    if (!t.rpcUrl)
    ...
    const d = Sr({
      ...
      nativeCurrency: {
        ...
        symbol: (s = (c = t.nativeCurrency) === null || c === void 0 ? void 0 : c.symbol) !== null && s !== void 0 ? s : "",
        decimals: (o = (u = t.nativeCurrency) === null || u === void 0 ? void 0 : u.decimal) !== null && o !== void 0 ? o : 18
      }
    }), l = Ar({
      chain: d,
      transport: At(t.rpcUrl)
    }), p = Vr({
      client: l,
      transport: At(t.rpcUrl)
    });
...
function tr(e) {
  var t;
  return (t = er.getState()[e]) === null || t === void 0 ? void 0 : t.client;
}
const be = ut(() => ({
  correlationIds: /* @__PURE__ */ new Map()
})), q = {
  get: (e) => be.getState().correlationIds.get(e),
  set: (e, t) => {
    be.setState((n) => {
...
function ve(e) {
  if (typeof e != "object" || e === null)
    throw b.rpc.internal("sub account info is not an object");
  if (!("address" in e))
    throw b.rpc.internal("sub account is invalid");
  if ("address" in e && typeof e.address == "string" && !Te(e.address))
    throw b.rpc.internal("sub account address is invalid");
  if ("factory" in e && typeof e.factory == "string" && !Te(e.factory))
    throw b.rpc.internal("sub account factory address is invalid");
  if ("factoryData" in e && typeof e.factoryData == "string" && !te(e.factoryData))
    throw b.rpc.internal("sub account factory data is invalid");
}
async function Xi() {
...
async function eo(e, { iv: t, cipherText: n }) {
...
async function rr(e, t) {
  const n = nr(e), r = await crypto.subtle.exportKey(n, t);
  return Ti(new Uint8Array(r));
}
async function ar(e, t) {
  const n = nr(e), r = Oi(t).buffer;
...
async function no(e, t) {
  return JSON.parse(await eo(t, e));
}
async function Pe(e, t) {
  const n = Object.assign(Object.assign({}, e), { jsonrpc: "2.0", id: crypto.randomUUID() }), r = await window.fetch(t, {
    ...
    headers: {
      ...
      "X-Cbw-Sdk-Version": se,
      "X-Cbw-Sdk-Platform": Re
    }
...
class C extends Error {
  constructor(t, n = {}) {
    const r = (() => {
      var u;
      if (n.cause instanceof C) {
        if (n.cause.details)
          return n.cause.details;
        if (n.cause.shortMessage)
          return n.cause.shortMessage;
      }
      return (u = n.cause) != null && u.message ? n.cause.message : n.details;
    })(), a = n.cause instanceof C && n.cause.docsPath || n.docsPath, c = `https://oxlib.sh${a ?? ""}`, s = [
      t || "An error occurred.",
...
`);
    super(s, n.cause ? { cause: n.cause } : void 0), Object.defineProperty(this, "details", {
      ...
      writable: !0,
      value: `ox@${io()}`
    }), this.cause = n.cause, this.details = r, this.docs = c, this.docsPath = a, this.shortMessage = t;
  }
  walk(t) {
    return ir(this, t);
  }
...
function ir(e, t) {
  return t != null && t(e) ? e : e && typeof e == "object" && "cause" in e && e.cause ? ir(e.cause, t) : t ? null : e;
}
const oo = "#__bigint";
function Ue(e, t, n) {
  return JSON.stringify(e, (r, a) => typeof a == "bigint" ? a.toString() + oo : a, n);
}
function so(e, t) {
  if (ie(e) > t)
    throw new Ao({
...
const po = /* @__PURE__ */ new TextEncoder(), mo = /* @__PURE__ */ Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function ho(e, t = {}) {
  const { strict: n = !1 } = t;
  if (!e)
    throw new nn(e);
...
function sr(e) {
  return e instanceof Uint8Array ? ae(e) : Array.isArray(e) ? ae(new Uint8Array(e)) : e;
}
function ae(e, t = {}) {
  let n = "";
  for (let a = 0; a < e.length; a++)
    n += mo[e[a]];
  const r = `0x${n}`;
  return typeof t.size == "number" ? (yt(r, t.size), ur(r, t.size)) : r;
}
function J(e, t = {}) {
  ...
  const c = typeof i == "bigint" && n ? -i - 1n : 0;
  if (i && a > i || a < c) {
  ...
  const u = `0x${(n && a < 0 ? (1n << BigInt(r * 8)) + BigInt(a) : a).toString(16)}`;
  return r ? go(u, r) : u;
}
function cr(e, t = {}) {
  return ae(po.encode(e), t);
}
function go(e, t) {
  return or(e, { dir: "left", size: t });
}
function ur(e, t) {
  return or(e, { dir: "right", size: t });
}
function D(e, t, n, r = {}) {
  const { strict: a } = r;
  lo(e, t);
...
function bo(e, t = {}) {
  ...
  if (!n)
    return r;
  const a = (e.length - 2) / 2, i = (1n << BigInt(a) * 8n) - 1n, c = i >> 1n;
  return r <= c ? r : r - i - 1n;
}
function vo(e, t = {}) {
  const { strict: n = !1 } = t;
  try {
    return ho(e, { strict: n }), !0;
  } catch {
    return !1;
  }
}
...
class nn extends C {
  constructor(t) {
    super(`Value \`${typeof t == "object" ? Ue(t) : t}\` of type \`${typeof t}\` is an invalid hex type.`, {
...
function dr(e) {
  return e instanceof Uint8Array ? e : typeof e == "string" ? pr(e) : fr(e);
}
function fr(e) {
...
function pr(e, t = {}) {
  ...
  let a = r.slice(2);
  a.length % 2 && (a = `0${a}`);
  const i = a.length / 2, c = new Uint8Array(i);
  for (let s = 0, u = 0; s < i; s++) {
    const o = tn(a.charCodeAt(u++)), d = tn(a.charCodeAt(u++));
    if (o === void 0 || d === void 0)
      throw new C(`Invalid byte sequence ("${a[u - 2]}${a[u - 1]}" in "${a}").`);
    c[s] = o * 16 + d;
  }
  return c;
}
...
class ye extends C {
  constructor(t) {
    super(`Value \`${typeof t == "object" ? Ue(t) : t}\` of type \`${typeof t}\` is an invalid Bytes value.`, {
...
function hr(e, t = {}) {
  const { as: n = typeof e == "string" ? "Hex" : "Bytes" } = t, r = Zr(dr(e));
...
function br(e) {
  if (e.length !== 132 && e.length !== 130 && e.length !== 68)
    throw new To({ publicKey: e });
  if (e.length === 130) {
    const r = BigInt(D(e, 0, 32)), a = BigInt(D(e, 32, 64));
    return {
      prefix: 4,
      x: r,
      y: a
  ...
  if (e.length === 132) {
    const r = Number(D(e, 0, 1)), a = BigInt(D(e, 1, 33)), i = BigInt(D(e, 33, 65));
    return {
      prefix: r,
      x: a,
      y: i
  ...
  const t = Number(D(e, 0, 1)), n = BigInt(D(e, 1, 33));
  return {
    prefix: t,
    x: n
  };
...
function wt(e, t = {}) {
  ...
  return De(
    ...
    typeof a == "bigint" ? J(a, { size: 32 }) : "0x"
  );
}
class Io extends C {
  constructor({ publicKey: t }) {
    super(`Value \`${Ue(t)}\` is not a valid public key.`, {
      metaMessages: [
...
function Oo(e, t = {}) {
  ...
  if (e.s < 0n || e.s > cn)
    throw new Uo({ value: e.s });
  if (typeof e.yParity == "number" && e.yParity !== 0 && e.yParity !== 1)
    throw new kt({ value: e.yParity });
}
function vr(e) {
  if (e.length !== 130 && e.length !== 132)
    throw new Mo({ signature: e });
  const t = BigInt(D(e, 0, 32)), n = BigInt(D(e, 32, 64)), r = (() => {
    const a = +`0x${e.slice(130)}`;
    if (!Number.isNaN(a))
      try {
        return No(a);
      } catch {
        throw new kt({ value: a });
      }
  })();
  return typeof r > "u" ? {
    r: t,
...
function jo(e) {
  ...
  return De(
    ...
    typeof e.yParity == "number" ? J(Ro(e.yParity), { size: 1 }) : "0x"
  );
}
function No(e) {
  if (e === 0 || e === 27)
...
class ze extends C {
  constructor({ signature: t }) {
    super(`Signature \`${Ue(t)}\` is missing either an \`r\`, \`s\`, or \`yParity\` property.`), Object.defineProperty(this, "name", {
      enumerable: !0,
      configurable: !0,
      writable: !0,
...
const Ko = /* @__PURE__ */ new TextDecoder(), we = /* @__PURE__ */ Object.fromEntries(Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").map((e, t) => [t, e.charCodeAt(0)]));
({
...
function Ho(e, t = {}) {
  ...
  for (let u = 0, o = 0; o < e.length; u += 4, o += 3) {
    const d = (e[o] << 16) + (e[o + 1] << 8) + (e[o + 2] | 0);
    a[u] = we[d >> 18], a[u + 1] = we[d >> 12 & 63], a[u + 2] = we[d >> 6 & 63], a[u + 3] = we[d & 63];
  }
  const i = e.length % 3, c = Math.floor(e.length / 3) * 4 + (i && i + 1);
  let s = Ko.decode(new Uint8Array(a.buffer, 0, c));
...
function Lo(e = {}) {
  const { flag: t = 5, rpId: n = window.location.hostname, signCount: r = 0 } = e, a = hr(cr(n)), i = J(t, { size: 1 }), c = J(r, { size: 4 });
  return De(a, i, c);
}
function zo(e) {
...
function qo(e) {
  const { challenge: t, crossOrigin: n, extraClientData: r, flag: a, origin: i, rpId: c, signCount: s, userVerification: u = "required" } = e, o = Lo({
    flag: a,
    rpId: c,
    signCount: s
  }), d = zo({
    ...
    extraClientData: r,
    origin: i
  }), l = hr(cr(d)), p = d.indexOf('"challenge"'), f = d.indexOf('"type"'), h = {
    authenticatorData: o,
    clientDataJSON: d,
    challengeIndex: p,
    typeIndex: f,
    userVerificationRequired: u === "required"
  }, m = De(o, l);
  return { metadata: h, payload: m };
}
async function Wo(e = {}) {
  const { extractable: t = !1 } = e, n = await globalThis.crypto.subtle.generateKey({
    name: "ECDSA",
    namedCurve: "P-256"
  }, t, ["sign", "verify"]), r = await globalThis.crypto.subtle.exportKey("raw", n.publicKey), a = Eo(new Uint8Array(r));
  return {
...
async function Vo(e) {
  const { payload: t, privateKey: n } = e, r = await globalThis.crypto.subtle.sign({
    name: "ECDSA",
    hash: "SHA-256"
  }, n, dr(t)), a = fr(new Uint8Array(r)), i = on(an(a, 0, 32));
  let c = on(an(a, 32, 64));
  return c > jt.CURVE.n / 2n && (c = jt.CURVE.n - c), { r: i, s: c };
}
function Ke(e) {
...
function yr(e, t) {
  ...
  const r = Ke(n);
  return (a, i) => r.then((c) => i(c.transaction(t, a).objectStore(t)));
}
let qe;
function xt() {
  return qe || (qe = yr("keyval-store", "keyval")), qe;
}
function Zo(e, t = xt()) {
  return t("readonly", (n) => Ke(n.get(e)));
}
function Jo(e, t, n = xt()) {
  return n("readwrite", (r) => (r.put(t, e), Ke(r.transaction)));
}
function Yo(e, t = xt()) {
  return t("readwrite", (n) => (n.delete(e), Ke(n.transaction)));
}
function Qo(e, t) {
  const n = typeof indexedDB < "u" ? yr(e, t) : void 0;
  return {
    getItem: async (r) => {
      const a = await Zo(r, n);
      return a || null;
    },
    removeItem: async (r) => Yo(r, n),
    setItem: async (r, a) => Jo(r, a, n)
  };
}
const Xo = "base-acc-sdk", Go = "keys", St = "activeId", oe = Qo(Xo, Go);
async function $o() {
  const e = await Wo({ extractable: !1 }), t = D(wt(e.publicKey), 1);
  return await oe.setItem(t, e), await oe.setItem(St, t), e;
}
async function es() {
  const e = await oe.getItem(St);
  if (!e)
    return null;
  const t = await oe.getItem(e);
  return t || null;
}
async function ts() {
  const e = await es();
  if (!e) {
    const t = await $o(), n = D(wt(t.publicKey), 1);
    return await oe.setItem(n, t), await oe.setItem(St, n), t;
  }
  return e;
}
async function ns() {
  const e = await ts(), t = D(wt(e.publicKey), 1), n = async (r) => {
    const { payload: a, metadata: i } = qo({
      challenge: r,
...
class rs {
  ...
  async setPeerPublicKey(t) {
    this.sharedSecret = null, this.peerPublicKey = t, await this.storeKey(dn, t), await this.loadKeysIfNeeded();
  }
  async clear() {
    this.ownPrivateKey = null, this.ownPublicKey = null, this.peerPublicKey = null, this.sharedSecret = null, g.keys.clear();
  }
  async generateKeyPair() {
    const t = await Xi();
    this.ownPrivateKey = t.privateKey, this.ownPublicKey = t.publicKey, await this.storeKey(un, t.privateKey), await this.storeKey(ln, t.publicKey);
  }
  async loadKeysIfNeeded() {
    if (this.ownPrivateKey === null && (this.ownPrivateKey = await this.loadKey(un)), this.ownPublicKey === null && (this.ownPublicKey = await this.loadKey(ln)), (this.ownPrivateKey === null || this.ownPublicKey === null) && await this.generateKeyPair(), this.peerPublicKey === null && (this.peerPublicKey = await this.loadKey(dn)), this.sharedSecret === null) {
      if (this.ownPrivateKey === null || this.peerPublicKey === null)
        return;
      this.sharedSecret = await Gi(this.ownPrivateKey, this.peerPublicKey);
    }
  }
  // storage methods
  async loadKey(t) {
    const n = g.keys.get(t.storageKey);
    return n ? ar(t.keyType, n) : null;
  }
  async storeKey(t, n) {
    const r = await rr(t.keyType, n);
    g.keys.set(t.storageKey, r);
  }
}
function le(e, t) {
  if (!(typeof e != "object" || e === null))
...
function is(e) {
  if (!e || !Array.isArray(e) || e.length !== 1 && e.length !== 2 || typeof e[0] != "string" || !Te(e[0]))
    throw b.rpc.invalidParams();
  if (e.length === 2) {
...
function Ne(e, t) {
  ...
  if (t && e.method.startsWith("wallet_")) {
    let r = le(n, "params.0.capabilities");
...
async function it() {
  var e;
  const t = (e = g.subAccountsConfig.get()) !== null && e !== void 0 ? e : {}, n = {};
  if (t.enableAutoSubAccounts) {
    const { account: r } = t.toOwnerAccount ? await t.toOwnerAccount() : await at();
    if (!r)
      throw b.provider.unauthorized("No owner account found");
    n.addSubAccount = {
      account: {
        type: "create",
        keys: [
  ...
  if (!(e.method === "coinbase_fetchPermissions" && e.params === void 0)) {
    if (e.method === "coinbase_fetchPermissions" && Array.isArray(e.params) && e.params.length === 1 && typeof e.params[0] == "object") {
      if (typeof e.params[0].account != "string" || !e.params[0].chainId.startsWith("0x"))
        throw b.rpc.invalidParams("FetchPermissions - Invalid params: params[0].account must be a hex string");
      if (typeof e.params[0].chainId != "string" || !e.params[0].chainId.startsWith("0x"))
        throw b.rpc.invalidParams("FetchPermissions - Invalid params: params[0].chainId must be a hex string");
      if (typeof e.params[0].spender != "string" || !e.params[0].spender.startsWith("0x"))
        throw b.rpc.invalidParams("FetchPermissions - Invalid params: params[0].spender must be a hex string");
      return;
    }
    throw b.rpc.invalidParams();
  }
...
function ss(e) {
  ...
  if (e.params !== void 0)
    return e;
  const a = (t = g.getState().account.accounts) === null || t === void 0 ? void 0 : t[0], i = (n = g.getState().account.chain) === null || n === void 0 ? void 0 : n.id, c = (r = g.getState().subAccount) === null || r === void 0 ? void 0 : r.address;
  if (!a || !c || !i)
    throw b.rpc.invalidParams("FetchPermissions - one or more of account, sub account, or chain id is missing, connect to sub account via wallet_connect first");
  return {
...
function cs({ spendPermission: e, chainId: t }) {
  return {
    domain: {
      name: "Spend Permission Manager",
      version: "1",
      chainId: t,
      verifyingContract: Pn
    },
    types: {
      SpendPermission: [
...
function us({ spendPermissionBatch: e, chainId: t }) {
  return {
    domain: {
      name: "Spend Permission Manager",
      version: "1",
...
async function wr({ client: e, id: t }) {
  var n;
  const r = await An(e, {
    id: t
  });
  ...
  throw b.rpc.internal("failed to send transaction");
}
function kr({ calls: e, from: t, chainId: n, capabilities: r }) {
  const a = Cn.get().paymasterUrls;
  let i = {
...
async function ls() {
  ...
  return await new Promise((n) => {
    ft({ dialogContext: "sub_account_insufficient_balance" }), e.presentItem({
      ...
      onClose: () => {
        Bn({ dialogContext: "sub_account_insufficient_balance" }), e.clear();
      },
      actionItems: [
        {
...
function ds({ errorData: e, sourceAddress: t }) {
  var n;
  const r = [];
  for (const [a, { amount: i, sources: c }] of Object.entries((n = e == null ? void 0 : e.required) !== null && n !== void 0 ? n : {})) {
    if (c.filter((u) => Ee(u.balance) >= Ee(i) && u.address.toLowerCase() === (t == null ? void 0 : t.toLowerCase())).length === 0)
...
function ms(e) {
  return Er(_r(ne(e)), 0, 16);
}
function hs({ attribution: e, dappOrigin: t }) {
  if (e) {
...
async function bs() {
  const e = g.spendPermissions.get(), t = g.subAccounts.get(), n = g.account.get().accounts;
  return n ? {
...
function ys({ webauthn: e, signature: t, id: n }) {
  const r = vr(t);
  return {
    id: n,
    rawId: Se(Et(n)),
    response: {
      authenticatorData: Se(Ve(e.authenticatorData)),
      clientDataJSON: Se(Et(e.clientDataJSON)),
      signature: Se(ws(r.r, r.s))
    },
    type: JSON.parse(e.clientDataJSON).type
  };
}
function ws(e, t) {
  const n = Ve(_t(B(e))), r = Ve(_t(B(t))), a = n.length, i = r.length, c = a + i + 4, s = new Uint8Array(c + 2);
  return s[0] = 48, s[1] = c, s[2] = 2, s[3] = a, s.set(n, 4), s[a + 4] = 2, s[a + 5] = i, s.set(r, a + 6), s;
}
var ks = function(e, t) {
  var n = {};
...
async function xs(e) {
  const { owner: t, ownerIndex: n, address: r, client: a, factoryData: i } = e, c = {
    abi: Qr,
    address: Yr,
    version: "0.6"
  }, s = {
  ...
  return Jr({
    client: a,
    entryPoint: c,
    extend: { abi: H, factory: s },
    async decodeCalls(u) {
      const o = gn({
        abi: H,
        data: u
      });
      if (o.functionName === "execute")
        return [{ to: o.args[0], value: o.args[1], data: o.args[2] }];
      if (o.functionName === "executeBatch")
        return o.args[0].map((d) => ({
          to: d.target,
          value: d.value,
          data: d.data
        }));
      throw new bn(`unable to decode calls for "${o.functionName}"`);
    },
    async encodeCalls(u) {
      var o, d;
      return u.length === 1 ? Y({
        ...
        args: [u[0].to, (o = u[0].value) !== null && o !== void 0 ? o : BigInt(0), (d = u[0].data) !== null && d !== void 0 ? d : "0x"]
      }) : Y({
        abi: H,
        ...
        args: [
          u.map((l) => {
            var p, f;
            return {
              data: (p = l.data) !== null && p !== void 0 ? p : "0x",
              target: l.to,
              value: (f = l.value) !== null && f !== void 0 ? f : BigInt(0)
            };
          })
        ]
      });
    ...
    async sign(u) {
      const o = await this.getAddress(), d = We({
        address: o,
        chainId: a.chain.id,
        hash: u.hash
      }), l = await Ae({ hash: d, owner: t });
      return ue({
        ownerIndex: n,
        signature: l
      });
    ...
    async signMessage(u) {
      const { message: o } = u, d = await this.getAddress(), l = We({
        address: d,
        chainId: a.chain.id,
        hash: hn(o)
      }), p = await Ae({ hash: l, owner: t });
      return ue({
        ownerIndex: n,
        signature: p
      });
    },
    async signTypedData(u) {
      const { domain: o, types: d, primaryType: l, message: p } = u, f = await this.getAddress(), h = We({
        address: f,
        chainId: a.chain.id,
        hash: ot({
          domain: o,
      ...
      }), m = await Ae({ hash: h, owner: t });
      return ue({
        ownerIndex: n,
        signature: m
      });
    },
    async signUserOperation(u) {
      const { chainId: o = a.chain.id } = u, d = ks(u, ["chainId"]), l = await this.getAddress(), p = Xr({
        chainId: o,
        entryPointAddress: c.address,
        entryPointVersion: c.version,
        userOperation: Object.assign(Object.assign({}, d), { sender: l })
      }), f = await Ae({ hash: p, owner: t });
      return ue({
        ownerIndex: n,
        signature: f
      });
    ...
    userOperation: {
      async estimateGas(u) {
        ...
        if (t.type === "webAuthn")
          return {
            verificationGasLimit: BigInt(Math.max(Number((o = u.verificationGasLimit) !== null && o !== void 0 ? o : BigInt(0)), 8e5))
          };
      }
    }
  });
}
async function Ae({ hash: e, owner: t }) {
  if (t.type === "webAuthn") {
    const { signature: n, webauthn: r } = await t.sign({
      hash: e
    });
    return Ss({ signature: n, webauthn: r });
  }
  if (t.sign)
    return t.sign({ hash: e });
  throw new bn("`owner` does not support raw sign.");
}
function We({ address: e, chainId: t, hash: n }) {
  return ot({
    domain: {
      chainId: t,
...
function Ss({ webauthn: e, signature: t }) {
  const { r: n, s: r } = vr(t);
  return vn([
    {
      components: [
  ...
  ], [
    {
      ...
      clientDataJSON: Ir(e.clientDataJSON),
...
function ue(e) {
  const { ownerIndex: t = 0 } = e, n = (() => {
    if (Cr(e.signature) !== 65)
      return e.signature;
    const r = Pr(e.signature);
    return Tr(["bytes32", "bytes32", "uint8"], [r.r, r.s, r.yParity === 0 ? 27 : 28]);
  })();
  return vn([
    {
      components: [
...
async function As({ address: e, client: t, factory: n, factoryData: r, owner: a, ownerIndex: i, parentAddress: c, attribution: s }) {
  var u;
  const o = {
    address: e,
    factory: n,
    factoryData: r
  }, d = (u = t.chain) === null || u === void 0 ? void 0 : u.id;
  if (!d)
    throw b.rpc.internal("chainId not found");
  const l = await xs({
    owner: a,
    ownerIndex: i ?? 1,
    address: e,
    ...
    try {
      switch (f.method) {
        ...
        case "eth_sendTransaction": {
          V(f.params);
          const k = f.params[0];
          K(k.to, b.rpc.invalidParams("to is required"));
          const I = {
            to: k.to,
            data: rt((h = k.data) !== null && h !== void 0 ? h : "0x", !0),
            value: rt((m = k.value) !== null && m !== void 0 ? m : "0x", !0),
            from: (v = k.from) !== null && v !== void 0 ? v : o.address
          }, M = kr({
            calls: [I],
            chainId: d,
            from: I.from
        ...
        case "wallet_sendCalls": {
          V(f.params);
          const k = le(f.params[0], "chainId");
          if (!k)
            throw b.rpc.invalidParams("chainId is required");
          if (!te(k))
            throw b.rpc.invalidParams("chainId must be a hex encoded integer");
          if (!f.params[0])
            throw b.rpc.invalidParams("params are required");
          if (!("calls" in f.params[0]))
            throw b.rpc.invalidParams("calls are required");
          let I = {
          ...
          let M = await p(I);
          const L = await ((w = (y = a).sign) === null || w === void 0 ? void 0 : w.call(y, {
            // Hash returned from wallet_prepareCalls is double hex encoded
            hash: It(M.signatureRequest.hash)
          }));
          let W;
          if (!L)
            throw b.rpc.internal("signature not found");
          return te(L) ? W = {
            type: "secp256k1",
            data: {
              address: a.address,
            ...
            type: "webauthn",
            data: {
              signature: JSON.stringify(ys(Object.assign({ id: (x = a.id) !== null && x !== void 0 ? x : "1" }, L))),
        ...
        case "wallet_prepareCalls": {
          ...
          if (!f.params[0])
            throw b.rpc.invalidParams("params are required");
          if (!le(f.params[0], "calls"))
            throw b.rpc.invalidParams("calls are required");
          const I = f.params[0];
          return s && I.capabilities && !("attribution" in I.capabilities) && (I.capabilities.attribution = s), await t.request({
            method: "wallet_prepareCalls",
            params: [Object.assign(Object.assign({}, f.params[0]), { chainId: k })]
          });
        }
        case "personal_sign": {
          if (V(f.params), !te(f.params[0]))
            throw b.rpc.invalidParams("message must be a hex encoded string");
          const k = It(f.params[0]);
          return l.signMessage({ message: k });
        }
        case "eth_signTypedData_v4": {
          V(f.params);
          const k = typeof f.params[1] == "string" ? JSON.parse(f.params[1]) : f.params[1];
          return l.signTypedData(k);
        }
        ...
        default:
          throw b.rpc.methodNotSupported();
      }
    } catch (k) {
      if (Mn(k)) {
        const I = Ba(k);
...
async function xr({ address: e, client: t, publicKey: n, factory: r, factoryData: a }) {
  if (!await Gr(t, {
    address: e
  }) && r && a) {
    const s = gn({
    ...
    if (s.functionName !== "createAccount")
      throw b.rpc.internal("unknown factory function");
    const [u] = s.args;
    return u.findIndex((o) => o.toLowerCase() === mn(n).toLowerCase());
  }
  const c = await Ot(t, {
    address: e,
    abi: H,
...
async function Es() {
  var e, t;
  const n = (t = (e = g.config.get().metadata) === null || e === void 0 ? void 0 : e.appName) !== null && t !== void 0 ? t : "App", r = vt();
  return new Promise((a) => {
    ft({ dialogContext: "sub_account_add_owner" }), r.presentItem({
      title: `Re-authorize ${n}`,
      message: `${n} has lost access to your account. Please sign at the next step to re-authorize ${n}`,
      onClose: () => {
        Bn({ dialogContext: "sub_account_add_owner" }), a("cancel");
      },
      actionItems: [
        {
          text: "Continue",
...
async function _s({ ownerAccount: e, globalAccountRequest: t }) {
  var n, r;
  const a = g.account.get(), i = g.subAccounts.get(), c = (n = a.accounts) === null || n === void 0 ? void 0 : n.find((h) => h.toLowerCase() !== (i == null ? void 0 : i.address.toLowerCase()));
  K(c, b.provider.unauthorized("no global account")), K((r = a.chain) === null || r === void 0 ? void 0 : r.id, b.provider.unauthorized("no chain id")), K(i == null ? void 0 : i.address, b.provider.unauthorized("no sub account"));
  const s = [];
  if (e.type === "local" && e.address && s.push({
    ...
    const [h, m] = yn([{ type: "bytes32" }, { type: "bytes32" }], e.publicKey);
    s.push({
      to: i.address,
      data: Y({
        abi: H,
  ...
  if (await Es() === "cancel")
    throw b.provider.unauthorized("user cancelled");
  const d = await t(u), l = tr(a.chain.id);
  if (K(l, b.rpc.internal(`client not found for chainId ${a.chain.id}`)), (await An(l, {
    id: d
  })).status !== "success")
    throw b.rpc.internal("add owner call failed");
  const f = await xr({
    address: i.address,
  ...
  if (f === -1)
    throw b.rpc.internal("failed to find owner index");
  return f;
}
async function Is({ errorData: e, globalAccountAddress: t, subAccountAddress: n, client: r, request: a, subAccountRequest: i, globalAccountRequest: c }) {
  var s;
  const u = (s = r.chain) === null || s === void 0 ? void 0 : s.id;
  K(u, b.rpc.internal("invalid chainId"));
  const o = ds({
    errorData: e,
    sourceAddress: t
  }), d = await ls();
  ...
  let l;
  const p = 60 * 60 * 24, f = 3;
  if (d === "update_permission") {
    if (o.length === 1) {
      const x = o[0], k = cs({
        spendPermission: {
          token: x.token,
          allowance: B(x.requiredAmount * BigInt(f)),
          period: p,
          account: t,
          spender: n,
          start: 0,
          end: 281474976710655,
          salt: B(BigInt(Math.floor(Math.random() * Number.MAX_SAFE_INTEGER))),
          extraData: "0x"
        },
        chainId: u
      });
      ...
      const x = us({
        spendPermissionBatch: {
          ...
          permissions: o.map((k) => ({
            token: k.token,
            allowance: B(k.requiredAmount * BigInt(f)),
            period: p,
            account: t,
            spender: n,
            salt: "0x0",
    ...
    try {
      ...
      throw console.error(x), new Error("User denied spend permission request");
    }
    return i(a);
  }
  const h = o.map((x) => x.token.toLowerCase() === "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE".toLowerCase() ? {
    to: n,
    value: B(x.requiredAmount),
    data: "0x"
  } : {
    to: x.token,
    value: "0x0",
    data: Y({
      ...
      args: [n, x.requiredAmount]
    })
  });
  let m;
  if (a.method === "wallet_sendCalls" && fs(a.params))
    m = a.params[0];
  else if (a.method === "eth_sendTransaction" && ps(a.params))
    m = kr({
      calls: [a.params[0]],
      chainId: u,
  ...
  const v = Y({
    ...
    args: [
      m.calls.map((x) => {
        ...
        return {
          target: x.to,
          value: Ee((k = x.value) !== null && k !== void 0 ? k : "0x0"),
          data: (I = x.data) !== null && I !== void 0 ? I : "0x"
        };
      })
    ]
  }), y = [
    ...
    method: "wallet_sendCalls",
    params: [Object.assign(Object.assign({}, m), { calls: y, from: t })]
  });
  return a.method === "eth_sendTransaction" ? wr({
    client: r,
    id: w
  }) : w;
}
class Cs {
  constructor(t) {
    var n, r, a, i;
    this.communicator = t.communicator, this.callback = t.callback, this.keyManager = new rs();
    const { account: c, chains: s } = g.getState();
    this.accounts = (n = c.accounts) !== null && n !== void 0 ? n : [], this.chain = (r = c.chain) !== null && r !== void 0 ? r : {
  ...
  async handshake(t) {
    var n, r, a;
    const i = q.get(t);
    Bi({ method: t.method, correlationId: i });
    try {
      await ((r = (n = this.communicator).waitForPopupLoaded) === null || r === void 0 ? void 0 : r.call(n));
      const c = await this.createRequestMessage({
        handshake: {
          method: t.method,
          params: (a = t.params) !== null && a !== void 0 ? a : []
        }
      }, i), s = await this.communicator.postRequestAndWaitForResponse(c);
      if ("failure" in s.content)
        throw s.content.failure;
      const u = await ar("public", s.sender);
      await this.keyManager.setPeerPublicKey(u);
      const o = await this.decryptResponseMessage(s);
      this.handleResponse(t, o), Di({ method: t.method, correlationId: i });
    } catch (c) {
      throw Ui({
        method: t.method,
        correlationId: i,
  ...
  async request(t) {
    const n = q.get(t);
    Ki({ method: t.method, correlationId: n });
    try {
      const r = await this._request(t);
      return Fi({ method: t.method, correlationId: n }), r;
    } catch (r) {
      throw Hi({
        method: t.method,
        correlationId: n,
  ...
  async _request(t) {
    var n, r, a, i, c, s, u, o, d, l;
    if (this.accounts.length === 0)
      switch (t.method) {
        case "wallet_switchEthereumChain": {
          pn(t.params), this.chain.id = Number(t.params[0].chainId);
          return;
        }
        case "wallet_connect": {
          await ((r = (n = this.communicator).waitForPopupLoaded) === null || r === void 0 ? void 0 : r.call(n)), await it();
          let p = {};
          gs(t, "addSubAccount") && (p = (i = (a = g.subAccountsConfig.get()) === null || a === void 0 ? void 0 : a.capabilities) !== null && i !== void 0 ? i : {});
          const f = Ne(t, p);
    ...
    if (this.shouldRequestUseSubAccountSigner(t)) {
      const p = q.get(t);
      Li({ method: t.method, correlationId: p });
      try {
        const f = await this.sendRequestToSubAccountSigner(t);
        return zi({ method: t.method, correlationId: p }), f;
      } catch (f) {
        throw qi({
          method: t.method,
          correlationId: p,
    ...
    switch (t.method) {
      ...
      case "eth_accounts": {
        const p = g.subAccounts.get(), f = g.subAccountsConfig.get();
        return p != null && p.address && (this.accounts = f != null && f.enableAutoSubAccounts ? ke(this.accounts, p.address) : xe(this.accounts, p.address)), (c = this.callback) === null || c === void 0 || c.call(this, "connect", { chainId: B(this.chain.id) }), this.accounts;
      }
      case "eth_coinbase":
      ...
      case "wallet_connect": {
        ...
        if (p)
          return p;
        await ((u = (s = this.communicator).waitForPopupLoaded) === null || u === void 0 ? void 0 : u.call(s)), await it();
        const f = g.subAccountsConfig.get(), h = Ne(t, (o = f == null ? void 0 : f.capabilities) !== null && o !== void 0 ? o : {}), m = await this.sendRequestToPopup(h);
        return (d = this.callback) === null || d === void 0 || d.call(this, "connect", { chainId: B(this.chain.id) }), m;
      }
      case "wallet_getSubAccounts": {
        const p = g.subAccounts.get();
        if (p != null && p.address)
          return {
            subAccounts: [p]
          };
        ...
        const f = await Pe(t, this.chain.rpcUrl);
        if (V(f.subAccounts, "subAccounts"), f.subAccounts.length > 0) {
          ve(f.subAccounts[0]);
          const h = f.subAccounts[0];
          g.subAccounts.set({
            address: h.address,
            factory: h.factory,
            factoryData: h.factoryData
          });
        }
        return f;
      }
      ...
      case "coinbase_fetchPermissions": {
        os(t);
        const p = ss(t), f = await Pe(p, _n), h = He((l = p.params) === null || l === void 0 ? void 0 : l[0].chainId);
        return g.spendPermissions.set(f.permissions.map((m) => Object.assign(Object.assign({}, m), { chainId: h }))), f;
      }
      default:
        if (!this.chain.rpcUrl)
          throw b.rpc.internal("No RPC URL set for chain");
        return Pe(t, this.chain.rpcUrl);
    }
  }
  ...
  async handleResponse(t, n) {
    ...
    switch (t.method) {
      case "eth_requestAccounts": {
        const o = u.value;
        this.accounts = o, g.account.set({
          accounts: o,
          chain: this.chain
        }), (r = this.callback) === null || r === void 0 || r.call(this, "accountsChanged", o);
        break;
      }
      case "wallet_connect": {
        const o = u.value, d = o.accounts.map((y) => y.address);
        this.accounts = d, g.account.set({
          accounts: d
        });
        const l = o.accounts.at(0), p = l == null ? void 0 : l.capabilities;
        if (p != null && p.subAccounts) {
          const y = p == null ? void 0 : p.subAccounts;
          V(y, "subAccounts"), ve(y[0]), g.subAccounts.set({
            address: y[0].address,
            factory: y[0].factory,
            factoryData: y[0].factoryData
          });
        }
        let f = [this.accounts[0]];
        const h = g.subAccounts.get(), m = g.subAccountsConfig.get();
        h != null && h.address && (this.accounts = m != null && m.enableAutoSubAccounts ? ke(this.accounts, h.address) : xe(this.accounts, h.address));
        const v = (i = (a = o == null ? void 0 : o.accounts) === null || a === void 0 ? void 0 : a[0].capabilities) === null || i === void 0 ? void 0 : i.spendPermissions;
        v && "permissions" in v && g.spendPermissions.set(v == null ? void 0 : v.permissions), (c = this.callback) === null || c === void 0 || c.call(this, "accountsChanged", f);
        break;
      }
      case "wallet_addSubAccount": {
        ve(u.value);
        const o = u.value;
        g.subAccounts.set(o);
        const d = g.subAccountsConfig.get();
        this.accounts = d != null && d.enableAutoSubAccounts ? ke(this.accounts, o.address) : xe(this.accounts, o.address), (s = this.callback) === null || s === void 0 || s.call(this, "accountsChanged", this.accounts);
        break;
      }
    }
    return u.value;
  ...
  async cleanup() {
    var t, n;
    const r = g.config.get().metadata;
    await this.keyManager.clear(), g.account.clear(), g.subAccounts.clear(), g.spendPermissions.clear(), g.chains.clear(), this.accounts = [], this.chain = {
  ...
  async handleGetCapabilitiesRequest(t) {
    ...
    if (!this.accounts.some((s) => Nr(s, n)))
      throw b.provider.unauthorized("no active account found when getting capabilities");
    const a = g.getState().account.capabilities;
    if (!a)
      return {};
    if (!r || r.length === 0)
      return a;
    const i = new Set(r.map((s) => He(s)));
  ...
  async sendEncryptedRequest(t) {
    ...
    if (!n)
      throw b.provider.unauthorized("No shared secret found when encrypting request");
    const r = await to({
      action: t,
      chainId: this.chain.id
    }, n), a = q.get(t), i = await this.createRequestMessage({ encrypted: r }, a);
    return this.communicator.postRequestAndWaitForResponse(i);
  }
  async createRequestMessage(t, n) {
    const r = await rr("public", await this.keyManager.getOwnPublicKey());
    return {
  ...
  async decryptResponseMessage(t) {
    ...
    if (!c)
      throw b.provider.unauthorized("Invalid session: no shared secret found when decrypting response");
    const s = await no(i.encrypted, c), u = (n = s.data) === null || n === void 0 ? void 0 : n.chains;
    if (u) {
      const d = (r = s.data) === null || r === void 0 ? void 0 : r.nativeCurrencies, l = Object.entries(u).map(([p, f]) => {
        const h = d == null ? void 0 : d[Number(p)];
        return Object.assign({ id: Number(p), rpcUrl: f }, h ? { nativeCurrency: h } : {});
      });
      g.chains.set(l), this.updateChain(this.chain.id, l), en(l);
    }
    const o = (a = s.data) === null || a === void 0 ? void 0 : a.capabilities;
    return o && g.account.set({
      capabilities: o
    }), s;
  }
  updateChain(t, n) {
    var r;
    const a = g.getState(), i = n ?? a.chains, c = i == null ? void 0 : i.find((s) => s.id === t);
    return c ? (c !== this.chain && (this.chain = c, g.account.set({
      chain: c
    }), (r = this.callback) === null || r === void 0 || r.call(this, "chainChanged", Gn(c.id))), !0) : !1;
  }
  async addSubAccount(t) {
    var n, r, a, i;
    const s = g.getState().subAccount, u = g.subAccountsConfig.get();
    if (s != null && s.address)
      return this.accounts = u != null && u.enableAutoSubAccounts ? ke(this.accounts, s.address) : xe(this.accounts, s.address), (n = this.callback) === null || n === void 0 || n.call(this, "accountsChanged", this.accounts), s;
    if (await ((a = (r = this.communicator).waitForPopupLoaded) === null || a === void 0 ? void 0 : a.call(r)), Array.isArray(t.params) && t.params.length > 0 && t.params[0].account && t.params[0].account.type === "create") {
      ...
      if (t.params[0].account.keys && t.params[0].account.keys.length > 0)
        d = t.params[0].account.keys;
      else {
        const l = (i = g.subAccountsConfig.get()) !== null && i !== void 0 ? i : {}, { account: p } = l.toOwnerAccount ? await l.toOwnerAccount() : await at();
        if (!p)
          throw b.provider.unauthorized("could not get subaccount owner account when adding sub account");
        d = [
          {
      ...
      t.params[0].account.keys = d;
    }
    const o = await this.sendRequestToPopup(t);
    return ve(o), o;
  }
  shouldRequestUseSubAccountSigner(t) {
    const n = fn(t), r = g.subAccounts.get();
    return n ? n.toLowerCase() === (r == null ? void 0 : r.address.toLowerCase()) : !1;
  }
  async sendRequestToSubAccountSigner(t) {
    var n;
    const r = g.subAccounts.get(), a = g.subAccountsConfig.get(), i = g.config.get();
    K(r == null ? void 0 : r.address, b.provider.unauthorized("no active sub account when sending request to sub account signer"));
    const c = a != null && a.toOwnerAccount ? await a.toOwnerAccount() : await at();
    K(c == null ? void 0 : c.account, b.provider.unauthorized("no active sub account owner when sending request to sub account signer")), fn(t) === void 0 && (t = as(t, r.address));
    const u = tr(this.chain.id);
    K(u, b.rpc.internal(`client not found for chainId ${this.chain.id} when sending request to sub account signer`));
    const o = this.accounts.find((h) => h.toLowerCase() !== r.address.toLowerCase());
    K(o, b.provider.unauthorized("no global account found when sending request to sub account signer"));
    const d = hs({
      attribution: (n = i.preference) === null || n === void 0 ? void 0 : n.attribution,
      dappOrigin: window.location.origin
    }), l = c.account.type === "local" ? c.account.address : c.account.publicKey;
    let p = await xr({
      address: r.address,
      factory: r.factory,
    ...
    if (p === -1) {
      const h = q.get(t);
      Wi({ method: t.method, correlationId: h });
      try {
        p = await _s({
          ownerAccount: c.account,
          globalAccountRequest: this.sendRequestToPopup.bind(this)
        }), Vi({ method: t.method, correlationId: h });
      } catch (m) {
        return Zi({
          method: t.method,
          correlationId: h,
          errorMessage: ce(m)
        }), b.provider.unauthorized("failed to add sub account owner when sending request to sub account signer");
      }
    }
    const { request: f } = await As({
      address: r.address,
      owner: c.account,
      client: u,
      factory: r.factory,
    ...
    try {
      ...
      let m;
      if (Mn(h))
        m = JSON.parse(h.details);
      else if (Bt(h))
        m = h;
      else
        throw h;
      if (!(Bt(m) && m.data) || !m.data)
        throw h;
      const v = q.get(t);
      Ji({ method: t.method, correlationId: v });
      try {
        const y = await Is({
          errorData: m.data,
        ...
        return Yi({ method: t.method, correlationId: v }), y;
      } catch (y) {
        throw console.error(y), Qi({
          method: t.method,
          correlationId: v,
          errorMessage: ce(y)
        }), h;
...
class Ts extends Ai {
  constructor(t) {
    var { metadata: n } = t, r = t.preference, { walletUrl: a } = r, i = Ps(r, ["walletUrl"]);
    super(), this.isBaseAccount = !0, this.communicator = new wi({
      url: a,
      metadata: n,
      preference: i
    }), this.signer = new Cs({
  ...
  async request(t) {
    ...
    q.set(t, n), Ei({ method: t.method, correlationId: n });
    try {
      const r = await this._request(t);
      return Ii({
        method: t.method,
  ...
  async _request(t) {
    var n, r;
    try {
      if (ro(t), !this.signer.isConnected)
        switch (t.method) {
          case "eth_requestAccounts": {
            await this.signer.handshake({ method: "handshake" }), await it(), await this.signer.request({
              method: "wallet_connect",
              params: [
                {
                  version: "1",
                  capabilities: Object.assign({}, (r = (n = g.subAccountsConfig.get()) === null || n === void 0 ? void 0 : n.capabilities) !== null && r !== void 0 ? r : {})
                }
              ]
            });
            break;
      ...
      const { code: i } = a;
      return i === O.provider.unauthorized && await this.disconnect(), Promise.reject(ki(a));
    }
  }
  async disconnect() {
    await this.signer.cleanup(), q.clear(), this.emit("disconnect", b.provider.disconnected("User initiated disconnection"));
  }
}
const Os = "isCoinbaseBrowser";
function js() {
  var e, t;
  const n = (e = window.ethereum) !== null && e !== void 0 ? e : (t = window.top) === null || t === void 0 ? void 0 : t.ethereum;
  return n != null && n[Os] ? n : null;
}
function Ks(e) {
  var t, n, r, a;
  const i = {
  ...
  !((n = e.subAccounts) === null || n === void 0) && n.toOwnerAccount && Ut(e.subAccounts.toOwnerAccount), g.subAccountsConfig.set({
  ...
  }), g.config.set(i), g.persist.rehydrate(), Ka(), Fa(i.preference), i.preference.telemetry !== !1 && Pa();
  let c = null;
  const s = {
    getProvider: () => {
      var u;
      return c || (c = (u = js()) !== null && u !== void 0 ? u : new Ts(i)), c;
    },
    subAccount: {
      async create(u) {
        var o;
        return await ((o = s.getProvider()) === null || o === void 0 ? void 0 : o.request({
      ...
      async get() {
        var u, o;
        const d = g.subAccounts.get();
        if (d != null && d.address)
          return d;
        const p = (o = (await ((u = s.getProvider()) === null || u === void 0 ? void 0 : u.request({
          method: "wallet_connect",
          params: [
            {
              version: "1",
        ...
        }))).accounts[0].capabilities) === null || o === void 0 ? void 0 : o.subAccounts;
        return Array.isArray(p) ? p[0] : null;
      },
      addOwner: async ({ address: u, publicKey: o, chainId: d }) => {
        var l, p;
        const f = g.subAccounts.get(), h = g.account.get();
        K(h, new Error("account does not exist")), K(f == null ? void 0 : f.address, new Error("subaccount does not exist"));
        const m = [];
        if (o) {
          const [v, y] = yn([{ type: "bytes32" }, { type: "bytes32" }], o);
          m.push({
            to: f.address,
            data: Y({
              abi: H,
        ...
        return u && m.push({
          ...
          value: ne(0)
        }), await ((l = s.getProvider()) === null || l === void 0 ? void 0 : l.request({
          method: "wallet_sendCalls",
          params: [
            {
              calls: m,
              chainId: ne(d),
              from: (p = h.accounts) === null || p === void 0 ? void 0 : p[0],
              version: "1"
            }
          ]
        }));
...
export {
  Ks as createBaseAccountSDK,
  at as getCryptoKeyAccount
};
