import { r as U, e as M, K as S, R as l, k as h, c as I, S as f, b as P, C as V, O as x, E as c, M as N, F as B, a as H } from "./index-C8kdZHDI.js";
import { c as d, U as W } from "./index-D5_HZ1pl.js";
import { i as E, a as v, x as u } from "./lit-element-CWLRvgWK.js";
import { n as O, r as m } from "./class-map-BaJ3HzzH.js";
import "./index-WFWVbb2G.js";
import "./index-Cv4vyh4e.js";
import { e as q, n as K } from "./ref-B6QhSp7s.js";
...
let w = class extends v {
  ...
  handleInput(e, t) {
    ...
    if (o) {
      const i = o.value;
      e.inputType === "insertFromPaste" ? this.handlePaste(o, i, t) : W.isNumber(i) && e.data ? (this.updateInput(o, t, e.data), this.focusInputField("next", t)) : this.updateInput(o, t, "");
    }
...
let p = T = class extends v {
  ...
  constructor() {
    var e;
    super(), this.loading = !1, this.timeoutTimeLeft = S.getTimeToNextEmailLogin(), this.error = "", this.otp = "", this.email = (e = l.state.data) == null ? void 0 : e.email, this.authConnector = h.getAuthConnector();
  }
  render() {
    if (!this.email)
  ...
  startOTPTimeout() {
    this.timeoutTimeLeft = S.getTimeToNextEmailLogin(), this.OTPTimeout = setInterval(() => {
      this.timeoutTimeLeft > 0 ? this.timeoutTimeLeft = S.getTimeToNextEmailLogin() : clearInterval(this.OTPTimeout);
    }, 1e3);
  }
  async onOtpInputChange(e) {
    ...
    try {
      ...
      this.error = I.parseError(n), this.loading = !1;
    }
  }
  async onResendCode() {
    try {
  ...
  shouldSubmitOnOtpChange() {
    return this.authConnector && this.otp.length === T.OTP_LENGTH;
  }
};
p.OTP_LENGTH = 6;
p.styles = J;
    ...
    super(...arguments), this.onOtpSubmit = async (e) => {
      ...
      try {
        if (this.authConnector) {
          const i = P.state.activeChain, r = V.getConnections(i), s = (t = x.state.remoteFeatures) == null ? void 0 : t.multiWallet, y = r.length > 0;
          if (await this.authConnector.provider.connectOtp({ otp: e }), c.sendEvent({ type: "track", event: "EMAIL_VERIFICATION_CODE_PASS" }), i)
            await V.connectExternal(this.authConnector, i);
          else
          ...
          if (c.sendEvent({
            ...
            properties: {
              ...
              caipNetworkId: (n = P.getActiveCaipNetwork()) == null ? void 0 : n.caipNetworkId
            }
        ...
        throw c.sendEvent({
          ...
          properties: { message: I.parseError(i) }
        }), i;
      }
...
let b = class extends v {
  constructor() {
    var e, t;
    super(...arguments), this.formRef = q(), this.initialEmail = ((e = l.state.data) == null ? void 0 : e.email) ?? "", this.redirectView = (t = l.state.data) == null ? void 0 : t.redirectView, this.email = "", this.loading = !1;
  }
  firstUpdated() {
    var e;
    ...
    super(), this.email = (e = l.state.data) == null ? void 0 : e.email, this.onOtpSubmit = async (t) => {
      try {
        ...
        throw c.sendEvent({
          type: "track",
          event: "EMAIL_VERIFICATION_CODE_FAIL",
          properties: { message: I.parseError(n) }
        }), n;
      }
    }, this.onStartOver = () => {
    ...
    super(), this.email = (e = l.state.data) == null ? void 0 : e.newEmail, this.redirectView = (t = l.state.data) == null ? void 0 : t.redirectView, this.onOtpSubmit = async (n) => {
      try {
        ...
        throw c.sendEvent({
          type: "track",
          event: "EMAIL_VERIFICATION_CODE_FAIL",
          properties: { message: I.parseError(o) }
        }), o;
      }
    }, this.onStartOver = () => {
      l.replace("UpdateEmailWallet", l.state.data);
...
let A = class extends v {
  ...
  checkIfAuthEnabled(e) {
    const t = e.filter((o) => o.type === B.CONNECTOR_TYPE_AUTH).map((o) => o.chain);
    return H.AUTH_CONNECTOR_SUPPORTED_CHAINS.some((o) => t.includes(o));
  }
};
z([
  m()
