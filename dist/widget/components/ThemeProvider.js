...
export const ThemeProvider = ({ children, initialTheme = "auto", }) => {
    ...
    return (_jsx(DesignSystemThemeProvider, { theme: theme === "dark" ? "dark" : "light", children: _jsx(ThemeContext.Provider, { value: { theme, setTheme, isDark }, children: _jsx("div", { className: isDark ? "dark" : "", "data-theme": isDark ? "dark" : "light", children: children }) }) }));
};
