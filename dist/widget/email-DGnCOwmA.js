import { i as E, r as F, j as k, a as v, k as _, R as l, C as h, d as x, S as f, h as z, l as D, O as R, e as c, M as P, m as M, c as B } from "./index-C5WaG16p.js";
import { n as I, c as d, r as m, U as V } from "./if-defined-CulHeU7H.js";
import { x as u } from "./lit-html-jz-94mx9.js";
import "./index-CyUx-1CD.js";
import "./index-BJYWKRmD.js";
import "./index-D6HnP1d3.js";
import { e as H, n as q } from "./ref-CNbTEWmU.js";
    ...
    super(...arguments), this.onOtpSubmit = async (e) => {
      ...
      try {
        if (this.authConnector) {
          const n = z.state.activeChain, o = D.getConnections(n), i = (t = R.state.remoteFeatures) == null ? void 0 : t.multiWallet, r = o.length > 0;
          if (await this.authConnector.provider.connectOtp({ otp: e }), c.sendEvent({ type: "track", event: "EMAIL_VERIFICATION_CODE_PASS" }), n)
            await D.connectExternal(this.authConnector, n);
          else
          ...
          }), R.state.siwx ? P.close() : r && i ? (l.replace("ProfileWallets"), f.showSuccess("New Wallet Added")) : P.close();
        }
      } catch (n) {
        throw c.sendEvent({
          type: "track",
