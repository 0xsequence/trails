import { k as lr, A as dr, E as Pr, i as Ur, L as xr } from "./index-CUWmD1rN.js";
import { formatUnits as Lr, fallback as qn, http as Qt, toHex as Kn } from "viem";
import { B as St, r as ke, i as _t } from "./lit-element-CWLRvgWK.js";
const Dr = Symbol(), zn = Object.getPrototypeOf, Un = /* @__PURE__ */ new WeakMap(), Mr = (t) => t && (Un.has(t) ? Un.get(t) : zn(t) === Object.prototype || zn(t) === Array.prototype), Fr = (t) => Mr(t) && t[Dr] || null, Yn = (t, e = !0) => {
  Un.set(t, e);
}, ln = {}, Gn = (t) => typeof t == "object" && t !== null, Wr = (t) => Gn(t) && !Yt.has(t) && (Array.isArray(t) || !(Symbol.iterator in t)) && !(t instanceof WeakMap) && !(t instanceof WeakSet) && !(t instanceof Error) && !(t instanceof Number) && !(t instanceof Date) && !(t instanceof String) && !(t instanceof RegExp) && !(t instanceof ArrayBuffer) && !(t instanceof Promise), ur = (t, e) => {
  const n = xn.get(t);
  if ((n == null ? void 0 : n[0]) === e)
    return n[1];
  const r = Array.isArray(t) ? [] : Object.create(Object.getPrototypeOf(t));
  return Yn(r, !0), xn.set(t, [e, r]), Reflect.ownKeys(t).forEach((s) => {
  ...
  set(s, a, o, i) {
    ...
    if (l && (Zn(d, o) || xt.has(o) && Zn(d, xt.get(o))))
      return !0;
    n(a), Gn(o) && (o = Fr(o) || o);
    const p = !nt.has(o) && Hr(o) ? ae(o) : o;
    return e(a, p), Reflect.set(s, a, p, i), r(["set", [a], o, d]), !0;
  }
}), nt = /* @__PURE__ */ new WeakMap(), Yt = /* @__PURE__ */ new WeakSet(), xn = /* @__PURE__ */ new WeakMap(), Rt = [1, 1], xt = /* @__PURE__ */ new WeakMap();
...
function ae(t = {}) {
  ...
  if (e)
    return e;
  let n = Rt[0];
  const r = /* @__PURE__ */ new Set(), s = (w, H = ++Rt[0]) => {
    n !== H && (n = H, r.forEach((P) => P(w, H)));
  };
  let a = Rt[1];
  const o = (w = ++Rt[1]) => (a !== w && !r.size && (a = w, l.forEach(([H]) => {
    const P = H[1](w);
    P > n && (n = P);
  })), n), i = (w) => (H, P) => {
    const Z = [...H];
    Z[1] = [w, ...Z[1]], s(Z, P);
  }, l = /* @__PURE__ */ new Map(), d = (w, H) => {
    const P = !Yt.has(H) && nt.get(H);
    if (P) {
      if ((ln ? "production" : void 0) !== "production" && l.has(w))
    ...
    if ((ln ? "production" : void 0) !== "production" && Z)
  ...
  xt.set(t, j);
  const F = [t, o, h];
  return nt.set(j, F), Reflect.ownKeys(t).forEach((w) => {
...
const f = {
  ...
  bigNumber(t) {
    return t ? new St(t) : new St(0);
  },
  multiply(t, e) {
    if (t === void 0 || e === void 0)
      return new St(0);
    const n = new St(t), r = new St(e);
    return n.times(r);
  },
...
class Zt {
  ...
  async get({ headers: e, signal: n, cache: r, ...s }) {
    ...
    return (await bt(a, { method: "GET", headers: e, signal: n, cache: r })).json();
  }
  async getBlob({ headers: e, signal: n, ...r }) {
    const s = this.createUrl(r);
    return (await bt(s, { method: "GET", headers: e, signal: n })).blob();
  }
...
const ts = {
  ...
  enabled: !0,
  events: []
}), rs = new Zt({ baseUrl: O.getAnalyticsUrl(), clientId: null }), ss = 5, as = 60 * 1e3, Xe = ae({
  ...ns
}), os = {
  state: Xe,
  subscribeKey(t, e) {
...
class Nt extends Error {
  constructor(e, n, r) {
    super(e), this.name = "AppKitError", this.category = n, this.originalError = r, Object.setPrototypeOf(this, Nt.prototype);
    let s = !1;
...
${i}`, s = !0;
    ...
    s || (Error.captureStackTrace ? Error.captureStackTrace(this, Nt) : this.stack || (this.stack = `${this.name}: ${this.message}`));
  }
}
function Xn(t, e) {
  const n = t instanceof Nt ? t : new Nt(t instanceof Error ? t.message : String(t), e, t);
...
const is = "https://secure.walletconnect.org/sdk", cs = (typeof process < "u" && typeof process.env < "u" ? process.env.NEXT_PUBLIC_SECURE_SITE_SDK_URL : void 0) || is, ls = (typeof process < "u" && typeof process.env < "u" ? process.env.NEXT_PUBLIC_DEFAULT_LOG_LEVEL : void 0) || "error", ds = (typeof process < "u" && typeof process.env < "u" ? process.env.NEXT_PUBLIC_SECURE_SITE_SDK_VERSION : void 0) || "4", I = {
  ...
  subscribeNetworkImages(t) {
    return fe(Te.networkImages, () => t(Te.networkImages));
  },
  subscribeKey(t, e) {
    return Ce(Te, t, e);
  },
  ...
  getChainImage(t) {
    return Pe.state.networkImages[hs[t]];
  }
}, Je = ae({
  message: "",
  variant: "info",
  ...
  open(t, e) {
    ...
    s && n && (Je.message = s, Je.variant = e, Je.open = !0), a && console.error(typeof a == "function" ? a() : a, r ? { code: r } : void 0);
  },
  close() {
    Je.open = !1, Je.message = "", Je.variant = "info";
  }
}, ue = Re(fs), ms = O.getAnalyticsUrl(), gs = new Zt({ baseUrl: ms, clientId: null }), Cs = ["MODAL_CREATED"], qe = ae({
  timestamp: Date.now(),
  reportedErrors: {},
  data: {
    type: "track",
  ...
  async _sendAnalyticsEvent(t) {
    try {
      ...
      if (Cs.includes(t.data.event) || typeof window > "u")
        return;
      await gs.post({
        path: "/e",
...
}, Es = O.getApiUrl(), _e = new Zt({
  baseUrl: Es,
  clientId: null
}), ws = 40, Jn = 4, _s = 20, G = ae({
  promises: {},
  page: 1,
  count: 0,
  featured: [],
  ...
  _filterWalletsByPlatform(t) {
    return O.isMobile() ? t == null ? void 0 : t.filter((n) => n.mobile_link || n.id === je.COINBASE.id ? !0 : u.state.activeChain === "solana" && (n.id === je.SOLFLARE.id || n.id === je.PHANTOM.id)) : t;
  },
...
}, ve = Re(Ln), gr = Object.fromEntries(hr.map((t) => [t, void 0])), ys = Object.fromEntries(hr.map((t) => [t, !0])), X = ae({
  allConnectors: [],
  connectors: [],
  ...
  setConnectors(t) {
    t.filter((s) => !X.allConnectors.some((a) => a.id === s.id && E.getConnectorName(a.name) === E.getConnectorName(s.name) && a.chain === s.chain)).forEach((s) => {
      s.type !== "MULTI_CHAIN" && X.allConnectors.push(dt(s));
    });
  ...
  canSwitchToSmartAccount(t) {
    return u.checkIfSmartAccountEnabled() && Fe(t) === pe.ACCOUNT_TYPES.EOA;
  },
  ...
  connectSocial({ social: t, namespace: e, closeModalOnConnect: n = !0, onOpenFarcaster: r, onConnect: s }) {
    let a = R.state.socialWindow, o = R.state.socialProvider, i = !1, l = null;
    ...
    return new Promise((h, y) => {
      ...
      async function j() {
        if (t && (R.setSocialProvider(t, d), o = R.state.socialProvider, ne.sendEvent({
          ...
          if (w && !R.state.farcasterUrl)
            try {
              const { url: H } = await w.provider.getFarcasterUri();
          ...
          try {
            if (F && o) {
              const { uri: w } = await F.provider.getSocialRedirectUri({
                provider: o
              });
              if (l && w) {
                ...
                l == null || l.close(), y(new Error("Failed to initiate social connection"));
            }
          } catch {
...
const dn = {
  getConnectionStatus(t, e) {
    const n = E.state.activeConnectorIds[e], r = _.getConnections(e);
  ...
  getConnectionsData(t) {
    var i;
    const e = !!((i = m.state.remoteFeatures) != null && i.multiWallet), n = E.state.activeConnectorIds[t], r = _.getConnections(t), a = (_.state.recentConnections.get(t) ?? []).filter((l) => E.getConnectorById(l.connectorId)), o = dn.excludeExistingConnections([...r.map((l) => l.connectorId), ...n ? [n] : []], a);
    return e ? {
      connections: r,
      recentConnections: o
    } : {
  ...
  hide() {
    de.message = ct.message, de.variant = ct.variant, de.svg = ct.svg, de.open = ct.open, de.autoClose = ct.autoClose;
  },
    ...
    try {
      ...
      ne.sendEvent({
        ...
        properties: {
          ...
          cursor: oe.next,
          isSmartAccount: Fe(r) === pe.ACCOUNT_TYPES.SMART_ACCOUNT
        }
...
const bs = {
  ...
  async connectWalletConnect() {
    ...
    if (O.isTelegram() || O.isSafari() && O.isIos()) {
      ...
      ot = (e = (t = _._getClient()) == null ? void 0 : t.connectWalletConnect) == null ? void 0 : e.call(t).catch(() => {
      }), _.state.status = "connecting", await ot, ot = void 0, K.wcPairingExpiry = void 0, _.state.status = "connected";
    } else
      await ((r = (n = _._getClient()) == null ? void 0 : n.connectWalletConnect) == null ? void 0 : r.call(n));
  },
  ...
  resetWcConnection() {
    K.wcUri = void 0, K.wcPairingExpiry = void 0, K.wcLinking = void 0, K.recentWallet = void 0, K.status = "disconnected", sn.resetTransactions(), g.deleteWalletConnectDeepLink();
  },
  resetUri() {
  ...
  finalizeWcConnection() {
    var n, r, s;
    const { wcLinking: t, recentWallet: e } = _.state;
  ...
  async disconnect({ id: t, namespace: e, initialDisconnect: n } = {}) {
    ...
    try {
      ...
      throw new Nt("Failed to disconnect", "INTERNAL_SDK_ERROR", s);
    }
  },
  setConnections(t, e) {
  ...
  async handleAuthAccountSwitch({ address: t, namespace: e }) {
    var s, a;
    const n = (a = (s = R.state.user) == null ? void 0 : s.accounts) == null ? void 0 : a.find((o) => o.type === "smartAccount"), r = n && n.address.toLowerCase() === t.toLowerCase() && It.canSwitchToSmartAccount(e) ? "smartAccount" : "eoa";
  ...
  async handleActiveConnection({ connection: t, namespace: e, address: n }) {
    ...
    if (s)
      s && n && await _.handleAuthAccountSwitch({ address: n, namespace: e });
    else {
  ...
  async handleDisconnectedConnection({ connection: t, namespace: e, address: n, closeModalOnConnect: r }) {
    ...
    if (o)
      ...
      const { address: h } = await It.connectWalletConnect({
        ...
        closeModalOnConnect: r,
        onOpen(y) {
          z.open({ view: y ? "AllWallets" : "ConnectingWalletConnect" });
        },
        onConnect() {
          B.replace("ProfileWallets");
        }
    ...
    return o && n && await _.handleAuthAccountSwitch({ address: n, namespace: e }), l;
  },
  ...
  async getTokenList() {
    var r;
    const t = u.state.activeCaipNetwork, e = await M.fetchSwapTokens({
  ...
  async fetchGasPrice() {
    ...
    try {
      switch (t.chainNamespace) {
        case "solana":
          const n = (e = await (_ == null ? void 0 : _.estimateGas({ chainNamespace: "solana" }))) == null ? void 0 : e.toString();
          return {
            standard: n,
            fast: n,
            instant: n
  ...
  async fetchTokenBalance(t) {
    var a, o;
    te.loading = !0;
    const e = (a = u.state.activeCaipNetwork) == null ? void 0 : a.caipNetworkId, n = (o = u.state.activeCaipNetwork) == null ? void 0 : o.chainNamespace, r = u.state.activeCaipAddress, s = r ? O.getPlainAddress(r) : void 0;
    if (te.lastRetry && !O.isAllowedRetry(te.lastRetry, 30 * ee.ONE_SEC_MS))
      return te.loading = !1, [];
    try {
      if (s && e && n) {
  ...
  async sendNativeToken(t) {
    ...
    const e = t.receiverAddress, n = R.state.address, r = _.parseUnits(t.sendTokenAmount.toString(), Number(t.decimals));
    await _.sendTransaction({
      ...
      event: "SEND_SUCCESS",
      properties: {
        isSmartAccount: Fe("eip155") === pe.ACCOUNT_TYPES.SMART_ACCOUNT,
  ...
  initialize(t, e, n) {
    ...
    ((t == null ? void 0 : t.length) === 0 || !i) && (A.noAdapters = !0), A.noAdapters || (A.activeChain = i == null ? void 0 : i.namespace, A.activeCaipNetwork = a, u.setChainNetworkData(i == null ? void 0 : i.namespace, {
      caipNetwork: a
    }), A.activeChain && xe.set({ activeChain: i == null ? void 0 : i.namespace })), d.forEach((p) => {
      const h = e == null ? void 0 : e.filter((j) => j.chainNamespace === p), y = g.getPreferredAccountTypes() || {}, b = { ...m.state.defaultAccountTypes, ...y };
      u.state.chains.set(p, {
        namespace: p,
        networkState: ae({ ...tn, caipNetwork: h == null ? void 0 : h[0] }),
        accountState: ae({ ...bn, preferredAccountType: b[p] }),
        caipNetworks: h ?? [],
        ...n
  ...
  addNetwork(t) {
    ...
    if (e) {
      ...
      (n = e.caipNetworks) != null && n.find((s) => s.id === t.id) || r.push(t), A.chains.set(t.chainNamespace, { ...e, caipNetworks: r }), u.setRequestedCaipNetworks(r, t.chainNamespace), E.filterByNamespace(t.chainNamespace, !0);
    }
  },
  removeNetwork(t, e) {
    var r, s, a;
    ...
    if (n) {
      ...
      o && ((a = n == null ? void 0 : n.caipNetworks) != null && a[0]) && u.setActiveCaipNetwork(n.caipNetworks[0]), A.chains.set(t, { ...n, caipNetworks: i }), u.setRequestedCaipNetworks(i || [], t), i.length === 0 && E.filterByNamespace(t, !1);
    }
  },
  ...
  setChainAccountData(t, e, n = !0) {
    ...
    if (r) {
      ...
      A.chains.set(t, { ...r, accountState: s }), (A.chains.size === 1 || A.activeChain === t) && (e.caipAddress && (A.activeCaipAddress = e.caipAddress), R.replaceState(s));
    }
  },
  ...
  setActiveNamespace(t) {
    ...
    n != null && n.id && t && (A.activeCaipAddress = (s = e == null ? void 0 : e.accountState) == null ? void 0 : s.caipAddress, A.activeCaipNetwork = n, u.setChainNetworkData(t, { caipNetwork: n }), g.setActiveCaipNetworkId(n == null ? void 0 : n.caipNetworkId), xe.set({
      activeChain: t,
  ...
  setActiveCaipNetwork(t) {
    ...
    const e = A.chains.get(t.chainNamespace);
    A.activeChain = t.chainNamespace, A.activeCaipNetwork = t, u.setChainNetworkData(t.chainNamespace, { caipNetwork: t }), (r = e == null ? void 0 : e.accountState) != null && r.address ? A.activeCaipAddress = `${t.chainNamespace}:${t.id}:${(s = e == null ? void 0 : e.accountState) == null ? void 0 : s.address}` : A.activeCaipAddress = void 0, u.setAccountProp("caipAddress", A.activeCaipAddress, t.chainNamespace), e && R.replaceState(e.accountState), Q.resetSend(), xe.set({
  ...
  checkIfSupportedNetwork(t, e) {
    var s;
    const n = e || ((s = A.activeCaipNetwork) == null ? void 0 : s.caipNetworkId), r = u.getRequestedCaipNetworks(t);
  ...
  checkIfSmartAccountEnabled() {
    var r;
    const t = pr.caipNetworkIdToNumber((r = A.activeCaipNetwork) == null ? void 0 : r.caipNetworkId), e = A.activeChain;
    if (!e || !t)
      return !1;
...
}, Er = O.getBlockchainApiUrl(), Ae = ae({
  clientId: null,
  api: new Zt({ baseUrl: Er, clientId: null }),
  ...
  setClientId(t) {
    Ae.clientId = t, Ae.api = new Zt({ baseUrl: Er, clientId: t });
  }
}, In = {
  /**
   ...
   */
  async getMyTokensWithBalance(t) {
    const e = R.state.address, n = u.state.activeCaipNetwork, r = E.getConnectorId("eip155") === f.CONNECTOR_ID.AUTH;
    if (!e || !n)
      return [];
  ...
  async getEIP155Balances(t, e) {
    var n, r;
    try {
      const s = In.getChainIdHexFromCAIP2ChainId(e.caipNetworkId), a = await _.getCapabilities(t);
      ...
      if (!In.isWalletGetAssetsResponse(o))
        return null;
      const l = (o[s] || []).map((d) => In.createBalance(d, e.caipNetworkId));
      return g.updateBalanceCache({
  ...
  setSocialWindow(t, e) {
    u.setAccountProp("socialWindow", t ? dt(t) : void 0, e);
  },
  setFarcasterUrl(t, e) {
  ...
  async fetchTokenBalance(t) {
    ...
    Be.balanceLoading = !0;
    const e = (a = u.state.activeCaipNetwork) == null ? void 0 : a.caipNetworkId, n = (o = u.state.activeCaipNetwork) == null ? void 0 : o.chainNamespace, r = u.state.activeCaipAddress, s = r ? O.getPlainAddress(r) : void 0;
    if (Be.lastRetry && !O.isAllowedRetry(Be.lastRetry, 30 * ee.ONE_SEC_MS))
      return Be.balanceLoading = !1, [];
    try {
      if (s && e && n) {
        const i = await Vn.getMyTokensWithBalance();
        return R.setTokenBalance(i, n), Be.lastRetry = void 0, Be.balanceLoading = !1, i;
      }
    } catch (i) {
  ...
  onSwitchNetwork({ network: t, ignoreSwitchConfirmation: e = !1 }) {
    ...
    if (t.id === (n == null ? void 0 : n.id))
      return;
    const a = R.getCaipAddress(u.state.activeChain), o = t.chainNamespace !== u.state.activeChain, i = R.getCaipAddress(t.chainNamespace), d = E.getConnectorId(u.state.activeChain) === f.CONNECTOR_ID.AUTH, p = f.AUTH_CONNECTOR_SUPPORTED_CHAINS.find((h) => h === t.chainNamespace);
  ...
  async open(t) {
    ...
    if (_.state.wcBasic ? x.prefetch({ fetchNetworkImages: !1, fetchConnectorImages: !1 }) : await x.prefetch(), E.setFilterByNamespace(t == null ? void 0 : t.namespace), z.setLoading(!0, e), e && r) {
  ...
  close() {
    ...
    }), ye.open = !1, B.reset("Connect"), z.clearLoading(), t ? e ? B.replace("Account") : B.push("Connect") : xe.set({ open: !1 }), _.resetUri();
  },
  setLoading(t, e) {
  ...
  async registerName(t) {
    const e = u.state.activeCaipNetwork, n = R.state.address, r = E.getAuthConnector();
    if (!e)
...
const Ue = {
  ...
  async initializeIfEnabled(t = u.getActiveCaipAddress()) {
    ...
    if (u.checkIfSupportedNetwork(n, `${n}:${r}`))
      try {
        ...
        }), await ((i = _._getClient()) == null ? void 0 : i.disconnect().catch(console.error)), B.reset("Connect"), He.showError("A problem occurred while trying initialize authentication");
      }
  },
  async requestSignMessage() {
    const t = m.state.siwx, e = O.getPlainAddress(u.getActiveCaipAddress()), n = Dn(), r = _._getClient();
    if (!t)
  ...
  async authConnectorAuthenticate({ authConnector: t, chainId: e, socialUri: n, preferredAccountType: r, chainNamespace: s }) {
    ...
    return l.accountAddress = d.address, l.serializedMessage = d.message || "", d.signature && d.message && await Ue.addEmbeddedWalletSession(l, d.message, d.signature), {
      address: d.address,
      chainId: d.chainId,
      accounts: d.accounts
    };
  ...
  async universalProviderAuthenticate({ universalProvider: t, chains: e, methods: n }) {
    ...
    const a = await r.createMessage({
      chainId: ((i = Dn()) == null ? void 0 : i.caipNetworkId) || "",
      accountAddress: ""
    ...
    if (He.showLoading("Authenticating...", { autoClose: !1 }), R.setConnectedWalletInfo({
  ...
  getSIWXEventProperties() {
    ...
    return {
      ...
      isSmartAccount: Fe(t) === pe.ACCOUNT_TYPES.SMART_ACCOUNT
    };
  },
  async clearSessions() {
    const t = this.getSIWX();
...
const Rn = [
  ...
  getDefaultRpcUrl(t, e, n) {
    ...
    return Rn.includes(e) ? er(e, n) : r || "";
  },
  extendCaipNetwork(t, { customNetworkImageUrls: e, projectId: n, customRpcUrls: r }) {
    var y, b, j, F, w, H, P;
    const s = this.getChainNamespace(t), a = this.getCaipNetworkId(t), o = (j = (b = (y = t.rpcUrls) == null ? void 0 : y.default) == null ? void 0 : b.http) == null ? void 0 : j[0], i = this.getDefaultRpcUrl(t, a, n), l = ((H = (w = (F = t == null ? void 0 : t.rpcUrls) == null ? void 0 : F.chainDefault) == null ? void 0 : w.http) == null ? void 0 : H[0]) || o, d = ((P = r == null ? void 0 : r[a]) == null ? void 0 : P.map((Z) => Z.url)) || [], p = [...d, ...i ? [i] : []], h = [...d];
  ...
  getViemTransport(t, e, n) {
    ...
    }), Rn.includes(t.caipNetworkId) && r.push(Qt(er(t.caipNetworkId, e), {
      fetchOptions: {
        headers: {
...
const $ = Object.freeze({
  status: "aborted"
}), Ar = (t) => ({ status: "dirty", value: t }), we = (t) => ({ status: "valid", value: t }), Bn = (t) => t.status === "aborted", jn = (t) => t.status === "dirty", Ft = (t) => t.status === "valid", fn = (t) => typeof Promise < "u" && t instanceof Promise;
var D;
(function(t) {
  ...
  _parse(e) {
    ...
    for (const a of this._def.checks)
      if (a.kind === "min")
        ...
        On || (On = new RegExp(Xs, "u")), On.test(e.data) || (s = this._getOrReturnCtx(e, s), S(s, {
          validation: "emoji",
          code: C.invalid_string,
          message: a.message
        }), r.dirty());
  ...
  _parse(e) {
    ...
    if (this._def.returns instanceof Tt) {
      ...
      return we(async function(...l) {
        const d = new De([]), p = await i._def.args.parseAsync(l, a).catch((b) => {
...
const vr = (t, e = {}, n) => t ? vt.create().superRefine((r, s) => {
  var a, o;
  if (!t(r)) {
...
}) => vr((n) => n instanceof t, e), Tr = Le.create, Sr = rt.create, oa = wn.create, ia = st.create, br = Wt.create, ca = ut.create, la = mn.create, da = Bt.create, ua = jt.create, pa = vt.create, ha = lt.create, fa = Ze.create, ma = gn.create, ga = Me.create, Ca = ie.create, Ea = ie.strictCreate, wa = Ht.create, _a = An.create, Aa = $t.create, ya = Ve.create, Na = Gt.create, va = Cn.create, Ta = pt.create, Sa = At.create, ba = Vt.create, Ia = qt.create, Ra = at.create, Oa = Kt.create, ka = Tt.create, rr = We.create, Pa = Ye.create, Ua = ht.create, xa = We.createWithPreprocess, La = Xt.create, Da = () => Tr().optional(), Ma = () => Sr().optional(), Fa = () => br().optional(), Wa = {
...
const po = c.object({
  ...
  frameEvent: T.extend({ type: v("FRAME_SWITCH_NETWORK_ERROR"), payload: ce }).or(T.extend({
    type: v("FRAME_SWITCH_NETWORK_SUCCESS"),
    payload: co
  })).or(T.extend({
    type: v("FRAME_CONNECT_EMAIL_SUCCESS"),
    payload: Qa
  })).or(T.extend({ type: v("FRAME_CONNECT_EMAIL_ERROR"), payload: ce })).or(T.extend({
    type: v("FRAME_GET_FARCASTER_URI_SUCCESS"),
    payload: eo
  })).or(T.extend({ type: v("FRAME_GET_FARCASTER_URI_ERROR"), payload: ce })).or(T.extend({
    type: v("FRAME_CONNECT_FARCASTER_SUCCESS"),
    payload: to
  })).or(T.extend({ type: v("FRAME_CONNECT_FARCASTER_ERROR"), payload: ce })).or(T.extend({ type: v("FRAME_CONNECT_OTP_ERROR"), payload: ce })).or(T.extend({ type: v("FRAME_CONNECT_OTP_SUCCESS") })).or(T.extend({ type: v("FRAME_CONNECT_DEVICE_ERROR"), payload: ce })).or(T.extend({ type: v("FRAME_CONNECT_DEVICE_SUCCESS") })).or(T.extend({
    type: v("FRAME_CONNECT_SOCIAL_SUCCESS"),
    payload: no
  })).or(T.extend({
    type: v("FRAME_CONNECT_SOCIAL_ERROR"),
    payload: ce
  })).or(T.extend({ type: v("FRAME_GET_USER_ERROR"), payload: ce })).or(T.extend({
    ...
    payload: ao
  })).or(T.extend({ type: v("FRAME_SIGN_OUT_ERROR"), payload: ce })).or(T.extend({ type: v("FRAME_SIGN_OUT_SUCCESS") })).or(T.extend({ type: v("FRAME_IS_CONNECTED_ERROR"), payload: ce })).or(T.extend({
    type: v("FRAME_IS_CONNECTED_SUCCESS"),
    payload: oo
  })).or(T.extend({ type: v("FRAME_GET_CHAIN_ID_ERROR"), payload: ce })).or(T.extend({
    type: v("FRAME_GET_CHAIN_ID_SUCCESS"),
    payload: io
  })).or(T.extend({ type: v("FRAME_RPC_REQUEST_ERROR"), payload: ce })).or(T.extend({ type: v("FRAME_RPC_REQUEST_SUCCESS"), payload: fo })).or(T.extend({ type: v("FRAME_SESSION_UPDATE"), payload: ar })).or(T.extend({ type: v("FRAME_UPDATE_EMAIL_ERROR"), payload: ce })).or(T.extend({
    type: v("FRAME_UPDATE_EMAIL_SUCCESS"),
    payload: ro
  })).or(T.extend({
    type: v("FRAME_UPDATE_EMAIL_PRIMARY_OTP_ERROR"),
    payload: ce
  })).or(T.extend({ type: v("FRAME_UPDATE_EMAIL_PRIMARY_OTP_SUCCESS") })).or(T.extend({
    type: v("FRAME_UPDATE_EMAIL_SECONDARY_OTP_ERROR"),
    payload: ce
  })).or(T.extend({
    type: v("FRAME_UPDATE_EMAIL_SECONDARY_OTP_SUCCESS"),
    payload: lo
  })).or(T.extend({ type: v("FRAME_SYNC_THEME_ERROR"), payload: ce })).or(T.extend({ type: v("FRAME_SYNC_THEME_SUCCESS") })).or(T.extend({ type: v("FRAME_SYNC_DAPP_DATA_ERROR"), payload: ce })).or(T.extend({ type: v("FRAME_SYNC_DAPP_DATA_SUCCESS") })).or(T.extend({
    type: v("FRAME_GET_SMART_ACCOUNT_ENABLED_NETWORKS_SUCCESS"),
    payload: uo
  })).or(T.extend({
    type: v("FRAME_GET_SMART_ACCOUNT_ENABLED_NETWORKS_ERROR"),
    payload: ce
  })).or(T.extend({ type: v("FRAME_INIT_SMART_ACCOUNT_ERROR"), payload: ce })).or(T.extend({
    type: v("FRAME_SET_PREFERRED_ACCOUNT_SUCCESS"),
    payload: ho
  })).or(T.extend({
    type: v("FRAME_SET_PREFERRED_ACCOUNT_ERROR"),
    payload: ce
  })).or(T.extend({ type: v("FRAME_READY"), payload: po })).or(T.extend({
    type: v("FRAME_RELOAD_ERROR"),
    payload: ce
  })).or(T.extend({ type: v("FRAME_RELOAD_SUCCESS") }))
};
function Pn(t, e = {}) {
  var n;
  return typeof (e == null ? void 0 : e.type) == "string" && ((n = e == null ? void 0 : e.type) == null ? void 0 : n.includes(t));
}
function ii({ projectId: t, chainId: e, enableLogger: n, rpcUrl: r = wr.BLOCKCHAIN_API_RPC_URL, enableCloudAuthAccount: s = !1 }) {
  const a = new URL(cs);
...
class ci {
  constructor({ projectId: e, isAppClient: n = !1, chainId: r = "eip155:1", enableLogger: s = !0, enableCloudAuthAccount: a = !1, rpcUrl: o = wr.BLOCKCHAIN_API_RPC_URL }) {
    if (this.iframe = null, this.iframeIsReady = !1, this.initFrame = () => {
      ...
      registerFrameEventHandler: (i, l, d) => {
        function p({ data: h }) {
          var b;
          if (!Pn(I.FRAME_EVENT_KEY, h))
            return;
          const y = kn.frameEvent.safeParse(h);
          if (!y.success) {
      ...
      onFrameEvent: (i) => {
        Ie.isClient && window.addEventListener("message", ({ data: l }) => {
          if (!Pn(I.FRAME_EVENT_KEY, l))
            return;
          const d = kn.frameEvent.safeParse(l);
          d.success ? i(d.data) : console.warn("W3mFrame: invalid frame event", d.error.message);
        });
      },
      onAppEvent: (i) => {
        Ie.isClient && window.addEventListener("message", ({ data: l }) => {
          if (!Pn(I.APP_EVENT_KEY, l))
            return;
          const d = kn.appEvent.safeParse(l);
...
class di {
  ...
  async appEvent(e) {
    ...
    return !this.w3mFrame.iframeIsReady && !a.includes(e.type) && (r = setTimeout(() => {
      ...
      (F = (b = this.w3mLogger) == null ? void 0 : (j = b.logger).info) == null || F.call(j, { event: e, id: p }, "Sending app event"), this.w3mFrame.events.postAppEvent({ ...e, id: p });
      ...
      function y(w, H) {
        var P, Z, le;
        w.id === p && ((Z = H == null ? void 0 : (P = H.logger).info) == null || Z.call(P, { framEvent: w, id: p }, "Received frame response"), w.type === `@w3m-frame/${o}_SUCCESS` ? (n && clearTimeout(n), r && clearTimeout(r), "payload" in w && l(w.payload), l(void 0)) : w.type === `@w3m-frame/${o}_ERROR` && (n && clearTimeout(n), r && clearTimeout(r), "payload" in w && d(new Error(((le = w.payload) == null ? void 0 : le.message) || "An error occurred")), d(new Error("An error occurred"))));
      }
...
const ui = {
  ...
  isExcluded(t) {
    const e = !!t.rdns && x.state.excludedWallets.some((r) => r.rdns === t.rdns), n = !!t.name && x.state.excludedWallets.some((r) => Ee.isLowerCaseMatch(r.name, t.name));
    return e || n;
  },
  ...
  showConnector(t) {
    var s;
    const e = (s = t.info) == null ? void 0 : s.rdns, n = !!e && x.state.excludedWallets.some((a) => !!a.rdns && a.rdns === e), r = !!t.name && x.state.excludedWallets.some((a) => Ee.isLowerCaseMatch(a.name, t.name));
  ...
  getConnectorTypeOrder({ recommended: t, featured: e, custom: n, recent: r, announced: s, injected: a, multiChain: o, external: i, overriddenConnectors: l = ((d) => (d = m.state.features) == null ? void 0 : d.connectorTypeOrder)() ?? [] }) {
    ...
    ].filter((w) => w.isEnabled), b = new Set(y.map((w) => w.type)), j = l.filter((w) => b.has(w)).map((w) => ({ type: w, isEnabled: !0 })), F = y.filter(({ type: w }) => !j.some(({ type: P }) => P === w));
    return Array.from(new Set([...j, ...F].map(({ type: w }) => w)));
  },
...
let Ut, et, tt;
function Si(t, e) {
  Ut = document.createElement("style"), et = document.createElement("style"), tt = document.createElement("style"), Ut.textContent = yt(t).core.cssText, et.textContent = yt(t).dark.cssText, tt.textContent = yt(t).light.cssText, document.head.appendChild(Ut), document.head.appendChild(et), document.head.appendChild(tt), Ir(e);
}
function Ir(t) {
  et && tt && (t === "light" ? (et.removeAttribute("media"), tt.media = "enabled") : (tt.removeAttribute("media"), et.media = "enabled"));
}
function pi(t) {
  Ut && et && tt && (Ut.textContent = yt(t).core.cssText, et.textContent = yt(t).dark.cssText, tt.textContent = yt(t).light.cssText);
}
function yt(t) {
  return {
    core: _t`
    ...
    n && t.on("connect", () => {
      ...
      if ($e.isSessionEventData(i)) {
        ...
        if (l === "accountsChanged" && Array.isArray(d)) {
          const p = d.filter((h) => O.isCaipAddress(h)).map((h) => Se.parseCaipAddress(h)).filter((h) => h.chainNamespace === e);
          s(p);
        }
      }
...
class hi {
  ...
  async syncEVMConnections({ connectors: e, caipNetworks: n, universalProvider: r, getConnectionStatusInfo: s, onConnection: a, onListenProvider: o }) {
    await Promise.all(e.filter((i) => {
      ...
      if (i.id === f.CONNECTOR_ID.WALLET_CONNECT) {
        ...
        const { accounts: l, chainId: d } = await on.fetchProviderData(i);
        if (l.length > 0 && d) {
      ...
      if (p && p.length > 1 && (p = [
        {
          ...
          publicKey: ((y = p[mt.ACCOUNT_INDEXES.PAYMENT]) == null ? void 0 : y.publicKey) ?? "",
          path: ((b = p[mt.ACCOUNT_INDEXES.PAYMENT]) == null ? void 0 : b.path) ?? "",
          address: ((j = p[mt.ACCOUNT_INDEXES.PAYMENT]) == null ? void 0 : j.address) ?? "",
          type: "payment"
        },
        {
          namespace: f.CHAIN.BITCOIN,
          publicKey: ((F = p[mt.ACCOUNT_INDEXES.ORDINAL]) == null ? void 0 : F.publicKey) ?? "",
          path: ((w = p[mt.ACCOUNT_INDEXES.ORDINAL]) == null ? void 0 : w.path) ?? "",
          address: ((H = p[mt.ACCOUNT_INDEXES.ORDINAL]) == null ? void 0 : H.address) ?? "",
          type: "ordinal"
        }
  ...
  getConnection({ address: e, connectorId: n, connections: r, connectors: s }) {
    if (n) {
      ...
      if (!o)
        return null;
      const i = s.find((d) => Ee.isLowerCaseMatch(d.id, o.connectorId)), l = e ? o.accounts.find((d) => Ee.isLowerCaseMatch(d.address, e)) : o.accounts[0];
...
class gi {
  ...
  onAccountsChanged(e, n, r = !0) {
    ...
    if (e.length > 0) {
      ...
      o && Ee.isLowerCaseMatch(this.getConnectorId(f.CHAIN.EVM), n) && this.emit("accountChanged", {
        ...
        connectorId: n,
        accounts: e.map((l) => {
          const { address: d } = O.getAccount(l);
          return { address: d };
        }),
  ...
  onChainChanged(e, n) {
    ...
    s && this.addConnection({
      ...
      accounts: s.accounts,
      caipNetwork: a
    }), Ee.isLowerCaseMatch(this.getConnectorId(f.CHAIN.EVM), n) && this.emit("switchNetwork", { chainId: r });
  }
  /**
...
class Ci extends gi {
  ...
  async getBalance(e) {
    ...
    if (R.state.balanceLoading && e.chainId === ((l = u.state.activeCaipNetwork) == null ? void 0 : l.id))
      return {
...
class _i {
  constructor(e) {
    ...
    }, this.fetchIdentity = (n) => M.fetchIdentity(n), this.getReownName = (n) => kt.getNamesForAddress(n), this.getConnectors = () => E.getConnectors(), this.getConnectorImage = (n) => mr.getConnectorImage(n), this.getConnections = (n) => this.remoteFeatures.multiWallet ? dn.getConnectionsData(n).connections : (ue.open(f.REMOTE_FEATURES_ALERTS.MULTI_WALLET_NOT_ENABLED.DEFAULT, "info"), []), this.getRecentConnections = (n) => this.remoteFeatures.multiWallet ? dn.getConnectionsData(n).recentConnections : (ue.open(f.REMOTE_FEATURES_ALERTS.MULTI_WALLET_NOT_ENABLED.DEFAULT, "info"), []), this.switchConnection = async (n) => {
  ...
  async initialize(e) {
    var n, r, s;
    this.initializeProjectSettings(e), this.initControllers(e), await this.initChainAdapters(), this.sendInitializeEvent(e), m.state.enableReconnect ? (await this.syncExistingConnection(), await this.syncAdapterConnections()) : await this.unSyncExistingConnection(), this.remoteFeatures = await wi.fetchRemoteFeatures(e), m.setRemoteFeatures(this.remoteFeatures), this.remoteFeatures.onramp && Fn.setOnrampProviders(this.remoteFeatures.onramp), ((n = m.state.remoteFeatures) != null && n.email || Array.isArray((r = m.state.remoteFeatures) == null ? void 0 : r.socials) && ((s = m.state.remoteFeatures) == null ? void 0 : s.socials.length) > 0) && await this.checkAllowedOrigins();
  }
  async checkAllowedOrigins() {
    try {
      ...
      $e.isOriginAllowed(n, e, wt.DEFAULT_ALLOWED_ANCESTORS) || ue.open(me.ALERT_ERRORS.ORIGIN_NOT_ALLOWED, "error");
    } catch (e) {
  ...
  createClients() {
    this.connectionControllerClient = {
      connectWalletConnect: async () => {
        var d;
        const e = u.state.activeChain, n = this.getAdapter(e), r = (d = this.getCaipNetwork(e)) == null ? void 0 : d.id, s = _.getConnections(e), a = this.remoteFeatures.multiWallet, o = s.length > 0;
        if (!n)
          throw new Error("Adapter not found");
        const i = await n.connectWalletConnect(r);
        (!o || !a) && this.close(), this.setClientId((i == null ? void 0 : i.clientId) || null), g.setConnectedNamespaces([...u.state.chains.keys()]), await this.syncWalletConnectAccount(), await Ue.initializeIfEnabled();
      },
      connectExternal: async ({ id: e, address: n, info: r, type: s, provider: a, chain: o, caipNetwork: i, socialUri: l }) => {
        ...
        if (o && o !== d && !i) {
          const le = this.getCaipNetworks().find((Nn) => Nn.chainNamespace === o);
        ...
        const y = this.getCaipNetwork(p), b = await h.connect({
          id: e,
          address: n,
          info: r,
          type: s,
        ...
        if (b)
          return g.addConnectedNamespace(p), this.syncProvider({ ...b, chainNamespace: p }), this.setStatus("connected", p), this.syncConnectedWalletInfo(p), g.removeDisconnectedConnectorId(e, p), { address: b.address };
      },
      ...
      disconnect: async (e) => {
        ...
        try {
          ...
          const y = h.map(async (F) => {
            const w = E.getConnectorId(F), H = await this.disconnectNamespace(F, n || w);
          ...
          Q.resetSend(), _.resetWcConnection(), (d = Ue.getSIWX()) != null && d.signOutOnDisconnect && await Ue.clearSessions(), E.setFilterByNamespace(void 0), _.syncStorageConnections();
  ...
  listenAdapter(e) {
    ...
    m.state.enableReconnect === !1 ? this.setStatus("disconnected", e) : r === "connected" ? this.setStatus("connecting", e) : r === "disconnected" ? (g.clearAddressCache(), this.setStatus(r, e)) : this.setStatus(r, e), n.on("switchNetwork", ({ address: s, chainId: a }) => {
      ...
      const s = this.remoteFeatures.multiWallet, a = Array.from(_.state.connections.values()).flat();
      ...
      const s = R.state.address, a = u.state.activeCaipNetwork;
  ...
  async unSyncExistingConnection() {
    try {
      await Promise.allSettled(this.chainNamespaces.map((e) => _.disconnect({ namespace: e, initialDisconnect: !0 })));
    } catch (e) {
  ...
  async syncWalletConnectAccount() {
    ...
    const e = Object.keys(((s = (r = this.universalProvider) == null ? void 0 : r.session) == null ? void 0 : s.namespaces) || {}), n = this.chainNamespaces.map(async (a) => {
      ...
      if (!o)
        return;
      const i = ((b = (y = (h = (p = this.universalProvider) == null ? void 0 : p.session) == null ? void 0 : h.namespaces) == null ? void 0 : y[a]) == null ? void 0 : b.accounts) || [], l = (j = u.state.activeCaipNetwork) == null ? void 0 : j.id, d = i.find((F) => {
        const { chainId: w } = Se.parseCaipAddress(F);
        return w === (l == null ? void 0 : l.toString());
      }) || i[0];
      if (d) {
        const F = Se.validateCaipAddress(d), { chainId: w, address: H } = Se.parseCaipAddress(F);
  ...
  async syncAccount(e) {
    ...
    if (this.setStatus("connected", o), !(d && !p) && l) {
      let b = this.getCaipNetworks().find((w) => w.id.toString() === l.toString()), j = this.getCaipNetworks().find((w) => w.chainNamespace === o);
      if (!p && !b && !j) {
        const w = this.getApprovedCaipNetworkIds() || [], H = w.find((Z) => {
          var le;
    ...
    if (r === be.CONNECTOR_TYPE_ANNOUNCED || r === be.CONNECTOR_TYPE_INJECTED) {
      if (n) {
        const o = this.getConnectors().find((i) => {
          var h, y;
          const l = i.id === n, d = ((h = i.info) == null ? void 0 : h.rdns) === n, p = (y = i.connectors) == null ? void 0 : y.some((b) => {
            var j;
  ...
  async initializeUniversalAdapter() {
    ...
    m.setManualWCControl(!!((y = this.options) != null && y.manualWCControl)), this.universalProvider = this.options.universalProvider ?? await xr.init(n), m.state.enableReconnect === !1 && this.universalProvider.session && await this.universalProvider.disconnect(), this.listenWalletConnect();
  }
  listenWalletConnect() {
  ...
  // -- Public -------------------------------------------------------------------
  async open(e) {
    if (await this.injectModalUi(), e != null && e.uri && _.setUri(e.uri), e != null && e.arguments)
  ...
  async disconnect(e) {
    await _.disconnect({ namespace: e });
  }
  getSIWX() {
    return m.state.siwx;
  }
  ...
  getAccount(e) {
    const n = e || u.state.activeChain, r = E.getAuthConnector(n), s = u.getAccountData(n), a = g.getConnectedConnectorId(u.state.activeChain), o = _.getConnections(n);
    if (!n)
      throw new Error("AppKit:getAccount - namespace is required");
    const i = o.flatMap((l) => l.accounts.map(({ address: d, type: p }) => O.createAccount(n, d, p || "eoa")));
    if (s)
      return {
        allAccounts: i,
...
class kr extends _i {
  ...
  async onAuthProviderConnected(e) {
    ...
    this.setUser({ ...R.state.user || {}, ...p }, n), this.setSmartAccountDeployed(!!e.smartAccountDeployed, n), this.setPreferredAccountType(o, n), this.setLoading(!1, n);
  }
  setupAuthConnectorListeners(e) {
    e.onRpcRequest((n) => {
      ...
      const s = Ie.checkIfRequestIsSafe(r), a = R.state.address, o = u.state.activeCaipNetwork;
  ...
  async syncAuthConnector(e, n) {
    ...
    this.setUser({ ...((d = R.state) == null ? void 0 : d.user) || {}, username: i, email: o }, n), this.setupAuthConnectorListeners(e);
  ...
  createAuthProvider(e) {
    ...
    if (!f.AUTH_CONNECTOR_SUPPORTED_CHAINS.includes(e))
      return;
    const r = (d = this.remoteFeatures) == null ? void 0 : d.email, s = Array.isArray((p = this.remoteFeatures) == null ? void 0 : p.socials) && this.remoteFeatures.socials.length > 0, a = r || s, i = Ee.getActiveNamespaceConnectedToAuth() || e;
  ...
  async switchCaipNetwork(e) {
    ...
    if (r === n && s) {
      ...
      const d = se.getProviderId(n) === be.CONNECTOR_TYPE_AUTH, p = se.getProviderId(r), h = p === be.CONNECTOR_TYPE_AUTH, y = f.AUTH_CONNECTOR_SUPPORTED_CHAINS.includes(r);
      if (!r)
      ...
      if ((d && p === void 0 || h) && y)
        ...
        if (!u.state.noAdapters) {
          const b = this.getAdapter(r), j = se.getProvider(r), F = se.getProviderId(r);
          await (b == null ? void 0 : b.switchNetwork({ caipNetwork: e, provider: j, providerType: F }));
        }
  ...
  async loadModalComponents(e, n) {
    if (!O.isClient())
      return;
    const r = [];
    (n.email || n.socials && n.socials.length > 0) && r.push(import("./embedded-wallet-reZ8EuIA.js")), n.email && r.push(import("./email-DhrKKxpa.js")), n.socials && r.push(import("./socials-BFsyvlRs.js")), n.swaps && n.swaps.length > 0 && r.push(import("./swaps-6p6k2D-4.js")), e.send && r.push(import("./send-B7-QDW9w.js")), e.receive && r.push(import("./receive-CAiv9uoa.js")), n.onramp && n.onramp.length > 0 && r.push(import("./onramp-DiEQbbFi.js")), n.activity && r.push(import("./transactions-D0u3f4VK.js")), e.pay && r.push(import("./index-CNPVGNx6.js")), n.emailCapture && r.push(import("./ui-BVgQse1u.js")), await Promise.all([
      ...r,
      import("./index-dm8XJkTU.js"),
      import("./w3m-modal-qFBR25VO.js")
    ]);
  }
}
const Ai = "1.7.17";
function yi(t) {
  return new kr({
    ...t,
    sdkVersion: O.generateSdkVersion(t.adapters ?? [], "html", Ai)
  });
}
