...
import { o as R, r as w } from "./class-map-BaJ3HzzH.js";
import { O as j, P as S, h as O, f as y, d as g, I as F, b as h, J as q, p as z, E as _, S as T, A, R as G, M as x, s as X, a as J, T as Z, n as Y, o as Q } from "./index-B7iWI5Xa.js";
import { c as H } from "./index-Cd9Pfdzb.js";
import "./index-CB4mFa7F.js";
import "./index-CRSAiBSB.js";
...
function ne() {
  const t = j.getSnapshot().projectId;
...
function v(t, e) {
  const { chainNamespace: s, chainId: a } = S.parseCaipNetworkId(t), r = ie[s];
  if (!r)
...
function oe(t) {
  const { chainNamespace: e } = S.parseCaipNetworkId(t);
  return re.includes(e);
}
async function ce(t) {
  const { paymentAssetNetwork: e, activeCaipNetwork: s, approvedCaipNetworkIds: a, requestedCaipNetworks: r } = t, u = O.sortRequestedNetworks(a, r).find((P) => P.caipNetworkId === e);
  if (!u)
    throw new c(o.INVALID_PAYMENT_CONFIG);
  if (u.caipNetworkId === s.caipNetworkId)
    return;
  const d = y.getNetworkProp("supportsAllNetworks", u.chainNamespace);
  if (!((a == null ? void 0 : a.includes(u.caipNetworkId)) || d))
    throw new c(o.INVALID_PAYMENT_CONFIG);
  try {
    await y.switchActiveNetwork(u);
  } catch (P) {
...
const $ = 0, k = "unknown", n = z({
  ...
  async fetchExchanges() {
    try {
      ...
      const t = await V({
        page: $,
        asset: v(n.paymentAsset.network, n.paymentAsset.asset),
  ...
  async getAvailableExchanges(t) {
    var e;
    try {
      const s = t != null && t.asset && (t != null && t.network) ? v(t.network, t.asset) : void 0;
      return await V({
  ...
  async handlePayment() {
    ...
    if (!t)
      return;
    const { chainId: e, address: s } = S.parseCaipAddress(t), a = y.state.activeChain;
    ...
    if (i && !n.isPaymentInProgress)
      try {
        ...
        const u = y.getAllRequestedCaipNetworks(), d = y.getAllApprovedCaipNetworkIds();
        switch (await ce({
          ...
          case g.CHAIN.EVM:
            n.paymentAsset.asset === "native" && (n.currentPayment.result = await ue(n.paymentAsset, a, {
              recipient: n.recipient,
              amount: n.amount,
              fromAddress: s
  ...
  getPaymentIcon() {
    ...
    if (e) {
      ...
      if (e.type === "wallet") {
        ...
        if (!r)
          return;
        const i = Y.getConnectorId(r);
        if (!i)
          return;
        const u = Y.getConnectorById(i);
        return u ? Q.getConnectorImage(u) : void 0;
      }
    }
  }
  successTemplate() {
...
async function ve(t, e = ye) {
  ...
  return new Promise((s, a) => {
    let r = !1;
    const i = setTimeout(() => {
      r || (r = !0, C(), a(new c(o.GENERIC_PAYMENT_ERROR, "Payment timeout")));
    }, e);
    function u() {
      if (r)
        return;
      const f = l.state.currentPayment, U = l.state.error, K = l.state.isPaymentInProgress;
      ...
      U && !K && !f && (r = !0, C(), clearTimeout(i), s({
        success: !1,
        error: U
      }));
    }
    const d = D("currentPayment", u), M = D("error", u), P = D("isPaymentInProgress", u), C = fe([
      d,
      M,
      P
    ]);
