 ...
 */
const y = globalThis, M = y.trustedTypes, B = M ? M.createPolicy("lit-html", { createHTML: (h) => h }) : void 0, W = "$lit$", p = `lit$${Math.random().toFixed(9).slice(2)}$`, k = "?" + p, z = `<${k}>`, f = document, x = () => f.createComment(""), H = (h) => h === null || typeof h != "object" && typeof h != "function", I = Array.isArray, Z = (h) => I(h) || typeof (h == null ? void 0 : h[Symbol.iterator]) == "function", w = `[ 	
\f\r]`, m = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, P = /-->/g, U = />/g, u = RegExp(`>|${w}(?:([^\\s"'>=/]+)(${w}*=${w}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), O = /'/g, R = /"/g, V = /^(?:script|style|textarea|title)$/i, j = (h) => (t, ...e) => ({ _$litType$: h, strings: t, values: e }), X = j(1), Y = j(2), N = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), L = /* @__PURE__ */ new WeakMap(), g = f.createTreeWalker(f, 129);
function D(h, t) {
...
const F = (h, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    o += n === m ? r + z : l >= 0 ? (s.push($), r.slice(0, l) + W + r.slice(l) + p + d) : r + p + (l === -2 ? a : d);
  }
...
class b {
  ...
  $(t) {
    var o;
    const { values: e, _$litType$: s } = t, i = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = T.createElement(D(s.h, s.h[0]), this.options)), s);
...
E == null || E(T, b), (y.litHtmlVersions ?? (y.litHtmlVersions = [])).push("3.3.0");
const tt = (h, t, e) => {
