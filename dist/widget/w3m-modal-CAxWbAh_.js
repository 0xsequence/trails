import { i as y, a as C, x as c } from "./lit-element-CWLRvgWK.js";
import { n as u, r as d, o as z } from "./class-map-BaJ3HzzH.js";
import { M as p, U as R, R as l, C as re, r as j, f as B, e as le, n as ce, b as h, o as L, Q as de, m as K, E as q, O as T, k as M, A as F, S as A, D as P, T as ue, V as pe, P as he, c as we, a as me } from "./index-C8kdZHDI.js";
import { c as b, U as fe } from "./index-D5_HZ1pl.js";
...
import "./index-CZRTk9Nd.js";
import { S as be } from "./SwapController-CeOWmkdP.js";
const ee = {
...
let _ = class extends C {
  constructor() {
    super(), this.unsubscribe = [], this.open = B.state.open, this.onOpen(!0), this.unsubscribe.push(B.subscribeKey("open", (e) => {
  ...
  render() {
    const { message: e, variant: t } = B.state, i = ke[t];
    return c`
      <wui-alertbar
        message=${e}
...
function H() {
  var s, r, x, m, E, $, O;
  const n = (r = (s = l.state.data) == null ? void 0 : s.connector) == null ? void 0 : r.name, e = (m = (x = l.state.data) == null ? void 0 : x.wallet) == null ? void 0 : m.name, t = ($ = (E = l.state.data) == null ? void 0 : E.network) == null ? void 0 : $.name, i = e ?? n, a = M.getConnectors();
  return {
...
let w = class extends C {
  constructor() {
    super(), this.unsubscribe = [], this.heading = H()[l.state.view], this.network = h.state.activeCaipNetwork, this.networkImage = L.getNetworkImage(this.network), this.showBack = !1, this.prevHistoryLength = 1, this.view = l.state.view, this.viewDirection = "", this.headerText = H()[l.state.view], this.unsubscribe.push(de.subscribeNetworkImages(() => {
  ...
  leftHeaderTemplate() {
    var m;
    const { view: e } = l.state, t = e === "Connect", i = T.state.enableEmbedded, a = e === "ApproveTransaction", o = e === "ConnectingSiwe", s = e === "Account", r = T.state.enableNetworkSwitch, x = a || o || t && i;
...
class v extends C {
  ...
  initializeTheming() {
    const { themeVariables: e, themeMode: t } = ue.state, i = fe.getColorTheme(t);
    pe(e, i);
  }
  onClose() {
  ...
  async onConnected(e) {
    if (e.isInProfileView)
      return;
    const { chainNamespace: t, chainId: i, address: a } = he.parseCaipAddress(e.caipAddress), o = `${t}:${i}`, s = !we.getPlainAddress(this.caipAddress), r = await R.getSessions({ address: a, caipNetworkId: o }), x = R.getSIWX() ? r.some(($) => $.data.accountAddress === a) : !0, m = e.isSwitchingNamespace && x && !this.enableEmbedded, E = this.enableEmbedded && s;
    m ? l.goBack() : E && p.close();
  }
  onNewNetwork(e) {
    var Y, X, G;
    const t = this.caipNetwork, i = (Y = t == null ? void 0 : t.caipNetworkId) == null ? void 0 : Y.toString(), a = t == null ? void 0 : t.chainNamespace, o = (X = e == null ? void 0 : e.caipNetworkId) == null ? void 0 : X.toString(), s = e == null ? void 0 : e.chainNamespace, r = i !== o, m = r && !(a !== s), E = (t == null ? void 0 : t.name) === me.UNSUPPORTED_NETWORK_NAME, $ = l.state.view === "ConnectingExternal", O = l.state.view === "ProfileWallets", ae = !((G = h.getAccountData(e == null ? void 0 : e.chainNamespace)) != null && G.caipAddress), se = l.state.view === "UnsupportedChain", ne = p.state.open;
    let N = !1;
    this.enableEmbedded && l.state.view === "SwitchNetwork" && (N = !0), r && be.resetState(), ne && !$ && !O && (ae ? r && (N = !0) : (se || m && !E) && (N = !0)), N && l.state.view !== "SIWXSignMessage" && l.goBack(), this.caipNetwork = e;
  }
  prefetch() {
