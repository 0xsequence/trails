...
import { M as p, U as R, R as l, b as re, r as j, j as B, e as le, c as ce, f as h, o as L, Q as de, C as K, E as q, O as T, n as M, A as F, S as A, D as P, T as ue, V as pe, P as he, h as we, d as me } from "./index-Cdjo1-uC.js";
import { c as b, U as fe } from "./index-BgaOWKxg.js";
...
let _ = class extends C {
  ...
  render() {
    const { message: e, variant: t } = B.state, i = Ce[t];
    return c`
      <wui-alertbar
        message=${e}
...
const Se = ["SmartSessionList"];
function H() {
  var s, r, k, m, E, $, O;
  const n = (r = (s = l.state.data) == null ? void 0 : s.connector) == null ? void 0 : r.name, e = (m = (k = l.state.data) == null ? void 0 : k.wallet) == null ? void 0 : m.name, t = ($ = (E = l.state.data) == null ? void 0 : E.network) == null ? void 0 : $.name, i = e ?? n, a = M.getConnectors();
  return {
...
let U = class extends C {
  ...
  render() {
    const { message: e, variant: t, svg: i } = A.state, a = $e[t], { icon: o, iconColor: s } = i ?? a ?? {};
    return c`
      <wui-snackbar
        message=${e}
...
class v extends C {
  ...
  async onConnected(e) {
    if (e.isInProfileView)
      return;
    const { chainNamespace: t, chainId: i, address: a } = he.parseCaipAddress(e.caipAddress), o = `${t}:${i}`, s = !we.getPlainAddress(this.caipAddress), r = await R.getSessions({ address: a, caipNetworkId: o }), k = R.getSIWX() ? r.some(($) => $.data.accountAddress === a) : !0, m = e.isSwitchingNamespace && k && !this.enableEmbedded, E = this.enableEmbedded && s;
  ...
  onNewNetwork(e) {
    ...
    let N = !1;
    this.enableEmbedded && l.state.view === "SwitchNetwork" && (N = !0), ne && !$ && !O && (ae ? r && (N = !0) : (se || m && !E) && (N = !0)), N && l.state.view !== "SIWXSignMessage" && l.goBack(), this.caipNetwork = e;
  }
  prefetch() {
