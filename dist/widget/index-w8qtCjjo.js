import { O as Y, P as _, d as R, e as h, c as U, l as E, K as $, v as W, f as N, S as I, A as f, R as O, L as S, M as P, D as B, F as H, i as M, a as G, T as F } from "./index-D7QEUbBB.js";
import { x as p } from "./lit-html-jz-94mx9.js";
import { o as C, r as w, c as V } from "./if-defined-C_M2V4-7.js";
import "./index-Dqfsto7-.js";
import "./index-6lUxcvUu.js";
...
async function te(t, e, s) {
  ...
  if (isNaN(a))
    throw new c(o.INVALID_PAYMENT_CONFIG);
  const r = ((d = t.metadata) == null ? void 0 : d.decimals) ?? 18, i = E.parseUnits(a.toString(), r);
  if (typeof i != "bigint")
...
async function ne(t, e) {
  ...
  const s = t.asset, a = e.recipient, r = Number(t.metadata.decimals), i = E.parseUnits(e.amount.toString(), r);
  if (i === void 0)
    throw new c(o.GENERIC_PAYMENT_ERROR);
  return await E.writeContract({
...
const D = 0, v = "unknown", n = W({
  ...
  subscribeEvents() {
    ...
    }), f.subscribeKey("caipAddress", async (t) => {
...
let m = class extends G {
  ...
  get isWalletConnected() {
    return f.state.status === "connected";
  }
  render() {
    return p`
  ...
  renderPayWithWallet() {
    return Z(this.networkName) ? p`<wui-flex flexDirection="column" gap="s">
...
let A = class extends G {
  ...
  setupSubscription() {
    l.subscribeKey("isPaymentInProgress", (e) => {
      ...
      !e && this.paymentState === "in-progress" && (l.state.error || !((s = l.state.currentPayment) != null && s.result) ? this.paymentState = "error" : this.paymentState = "completed", this.updateMessages(), setTimeout(() => {
        E.state.status !== "disconnected" && P.close();
      }, 3e3));
  ...
  loaderTemplate() {
    ...
    return p`<wui-loading-thumbnail radius=${s * 9}></wui-loading-thumbnail>`;
  }
  successTemplate() {
...
export {
  ...
  m as W3mPayView,
  xe as baseETH,
  Se as baseSepoliaETH,
  Te as baseUSDC,
  Ne as getExchanges,
  _e as getIsPaymentInProgress,
  Pe as getPayError,
  Ie as getPayResult,
  Ae as openPay
};
