import { k as lr, A as dr, E as Pr, i as Ur, L as xr } from "./index-Bmza8DDV.js";
...
class kr extends _i {
  ...
  async loadModalComponents(e, n) {
    if (!O.isClient())
      return;
    const r = [];
    (n.email || n.socials && n.socials.length > 0) && r.push(import("./embedded-wallet-DZNupJ4u.js")), n.email && r.push(import("./email-CJJALP_c.js")), n.socials && r.push(import("./socials-C6ncRmBb.js")), n.swaps && n.swaps.length > 0 && r.push(import("./swaps-9gm0g4WU.js")), e.send && r.push(import("./send-CJAPCneu.js")), e.receive && r.push(import("./receive-DNNDdvIt.js")), n.onramp && n.onramp.length > 0 && r.push(import("./onramp-Cpy3HZ5w.js")), n.activity && r.push(import("./transactions-BQXujYN9.js")), e.pay && r.push(import("./index-Dcv--Hdk.js")), n.emailCapture && r.push(import("./ui-BhHpNLzu.js")), await Promise.all([
      ...r,
      import("./index-BMVlsFwE.js"),
      import("./w3m-modal-BZbVZIxh.js")
    ]);
  }
}
const Ai = "1.7.17";
