import { i as T, a as w, G as Z, H as l, I as B, J as x, A as L, O as S, M as I, h as O, u as ee, e as G, f as H, W as Q, R as D, d as V, b as M, B as X, l as te, S as E, T as ie } from "./index-C5WaG16p.js";
import { x as c } from "./lit-html-jz-94mx9.js";
import { n as d, c as g, o as h, r as u } from "./if-defined-CulHeU7H.js";
import { D as re, T as oe } from "./index-BrrcoI8n.js";
import "./index-D6HnP1d3.js";
import "./index-CndrU6Y3.js";
import "./index-BJYWKRmD.js";
import "./index-d1KYboYp.js";
import { O as z } from "./index-Cf3qqtou.js";
...
let p = class extends w {
  ...
  async fetchTokenImage() {
    await Z._fetchTokenImage(this.purchaseCurrency);
  }
  statusIconTemplate() {
...
let P = class extends w {
  constructor() {
    super(), this.unsubscribe = [], this.selectedOnRampProvider = l.state.selectedProvider, this.loading = !1, this.coinbaseTransactions = B.state.coinbaseTransactions, this.tokenImages = x.state.tokenImages, this.unsubscribe.push(l.subscribeKey("selectedProvider", (e) => {
  ...
  templateTransactions(e) {
    return e == null ? void 0 : e.map((t) => {
      var n, j, F;
      const r = re.formatDate((n = t == null ? void 0 : t.metadata) == null ? void 0 : n.minedAt), o = t.transfers[0], i = o == null ? void 0 : o.fungible_info;
      if (!i)
        return null;
      const s = ((j = i == null ? void 0 : i.icon) == null ? void 0 : j.url) || ((F = this.tokenImages) == null ? void 0 : F[i.symbol || ""]);
      return c`
  ...
  templateTransactionsByYear() {
    return Object.keys(this.coinbaseTransactions).sort().reverse().map((t) => {
      ...
      return new Array(12).fill(null).map((i, s) => s).reverse().map((i) => {
        var j;
        const s = oe.getTransactionGroupTitle(r, i), n = (j = this.coinbaseTransactions[r]) == null ? void 0 : j[i];
        return n ? c`
  ...
  async fetchCoinbaseTransactions() {
    const e = L.state.address, t = S.state.projectId;
    if (!e)
      throw new Error("No address found");
    if (!t)
      throw new Error("No projectId found");
    this.loading = !0, await B.fetchTransactions(e, "coinbase"), this.loading = !1, this.refetchLoadingTransactions();
  }
  refetchLoadingTransactions() {
    ...
    this.refetchTimeout = setTimeout(async () => {
      const i = L.state.address;
      await B.fetchTransactions(i, "coinbase"), this.refetchLoadingTransactions();
    }, 3e3);
  }
  templateLoading() {
    return Array(ae).fill(c` <wui-transaction-list-item-loader></wui-transaction-list-item-loader> `).map((e) => e);
  }
};
P.styles = ne;
U([
...
let A = class extends w {
  ...
  render() {
    var n;
    const { termsConditionsUrl: e, privacyPolicyUrl: t } = S.state, r = (n = S.state.features) == null ? void 0 : n.legalCheckbox, s = !!(e || t) && !!r && !this.checked;
    return c`
...
R([
  d()
], y.prototype, "feeRange", void 0);
R([
  d({ type: Boolean })
], y.prototype, "loading", void 0);
R([
  d()
], y.prototype, "onClick", void 0);
y = R([
...
let K = class extends w {
  render() {
    const { termsConditionsUrl: e, privacyPolicyUrl: t } = S.state;
    return !e && !t ? null : c`
      <wui-flex
        .padding=${["m", "s", "s", "s"]}
        flexDirection="column"
  ...
  onWhatIsBuy() {
    G.sendEvent({
      ...
      properties: {
        isSmartAccount: H(O.state.activeChain) === Q.ACCOUNT_TYPES.SMART_ACCOUNT
      }
    }), D.push("WhatIsABuy");
  }
};
...
let Y = class extends w {
  ...
  onClickProvider(e) {
    var t;
    l.setSelectedProvider(e), D.push("BuyInProgress"), V.openHref(((t = l.state.selectedProvider) == null ? void 0 : t.url) || e.url, "popupWindow", "width=600,height=800,scrollbars=yes"), G.sendEvent({
      type: "track",
  ...
  async getCoinbaseOnRampURL() {
    const e = L.state.address, t = O.state.activeCaipNetwork;
    if (!e)
      throw new Error("No address found");
    if (!(t != null && t.name))
...
let m = class extends w {
  constructor() {
    super(), this.unsubscribe = [], this.selectedOnRampProvider = l.state.selectedProvider, this.uri = te.state.wcUri, this.ready = !1, this.showRetry = !1, this.buffering = !1, this.error = !1, this.startTime = null, this.isMobile = !1, this.onRetry = void 0, this.unsubscribe.push(l.subscribeKey("selectedProvider", (e) => {
      this.selectedOnRampProvider = e;
  ...
  async watchCoinbaseTransactions() {
    try {
      const e = L.state.address;
      if (!e)
        throw new Error("No address found");
      (await X.fetchTransactions({
        account: e,
        onramp: "coinbase"
      })).data.filter((o) => new Date(o.metadata.minedAt) > new Date(this.startTime) || o.metadata.status === "ONRAMP_TRANSACTION_STATUS_IN_PROGRESS").length ? (clearInterval(this.intervalId), D.replace("OnRampActivity")) : this.startTime && Date.now() - this.startTime >= 18e4 && (clearInterval(this.intervalId), this.error = !0);
    } catch (e) {
      E.showError(e);
    }
  }
  ...
  loaderTemplate() {
    const e = ie.state.themeVariables["--w3m-border-radius-master"], t = e ? parseInt(e.replace("px", ""), 10) : 4;
    return c`<wui-loading-thumbnail radius=${t * 9}></wui-loading-thumbnail>`;
  }
  onCopyUri() {
    var e;
    if (!((e = this.selectedOnRampProvider) != null && e.url)) {
      E.showError("No link found"), D.goBack();
      return;
    }
    try {
      V.copyToClopboard(this.selectedOnRampProvider.url), E.showSuccess("Link copied");
    } catch {
      E.showError("Failed to copy");
    }
  }
};
m.styles = he;
