import { I as Nr, b as No, g as Xl, c as U, a as fr, C as Zl, e as Ec, f as Ql, h as eu, s as Sn, i as Cc, j as Bs, k as ni, A as Ic, E as et, l as tu, m as su, y as wt, n as Rs, r as Ar, O as oo, o as At, p as ru, q as ao, t as co, u as ji, N as lo, P as Ao, Q as iu, v as nu, w as ou, x as _o, z as cr, B as Nc, D as Zt, F as qt, G as is, H as Ut } from "./index-CUWmD1rN.js";
...
const Eu = {
  ...
  setRemoteFeatures(t) {
    ...
    V.remoteFeatures = e, (s = V.remoteFeatures) != null && s.socials && (V.remoteFeatures.socials = Eu.filterSocialsByPlatform(V.remoteFeatures.socials));
  },
  setFeatures(t) {
    if (!t)
      return;
...
const jt = {
  ...
  async fetchWalletsByPage({ page: t }) {
    const { includeWalletIds: e, excludeWalletIds: s, featuredWalletIds: r } = T.state, i = p.getRequestedCaipNetworkIds().join(","), n = [
      ...
      exclude: n,
      chains: i
    }, { data: a, count: c } = await K.fetchWallets(o), l = a.slice(0, Du).map((u) => u.image_id).filter(Boolean);
...
const ju = {
  ...
  async open(t) {
    ...
    if (Y.state.wcBasic ? K.prefetch({ fetchNetworkImages: !1, fetchConnectorImages: !1 }) : await K.prefetch({
      ...
      c && Vu.onSwitchNetwork({ network: c, ignoreSwitchConfirmation: !0 });
    } else {
  ...
  async getAvailableCurrencies() {
    ...
    oe.purchaseCurrencies = t.purchaseCurrencies, oe.paymentCurrencies = t.paymentCurrencies, oe.paymentCurrency = t.paymentCurrencies[0] || On, oe.purchaseCurrency = t.purchaseCurrencies[0] || Hr, await K.fetchCurrencyImages(t.paymentCurrencies.map((e) => e.id)), await K.fetchTokenImages(t.purchaseCurrencies.map((e) => e.symbol));
  },
  async getQuote() {
    var t, e;
    oe.quotesLoading = !0;
  ...
  async registerName(t) {
    ...
    try {
      ...
      const n = Kr.parseEnsApiError(i, `Error registering name ${t}`);
...
const [ah, ch] = Vd(Wc, !0), Vo = (t, e, s) => s > 32 ? Yd(t, e, s) : Gd(t, e, s), Go = (t, e, s) => s > 32 ? Xd(t, e, s) : Jd(t, e, s);
function lh(t, e = 24) {
  const s = new Uint32Array(10);
  for (let r = 24 - e; r < 24; r++) {
    for (let o = 0; o < 10; o++) s[o] = t[o] ^ t[o + 10] ^ t[o + 20] ^ t[o + 30] ^ t[o + 40];
    for (let o = 0; o < 10; o += 2) {
      const a = (o + 8) % 10, c = (o + 2) % 10, l = s[c], u = s[c + 1], d = Vo(l, u, 1) ^ s[a], h = Go(l, u, 1) ^ s[a + 1];
      for (let g = 0; g < 50; g += 10) t[o + g] ^= d, t[o + g + 1] ^= h;
    }
    let i = t[2], n = t[3];
    for (let o = 0; o < 24; o++) {
      const a = jc[o], c = Vo(i, n, a), l = Go(i, n, a), u = qc[o];
...
let uh = class zc extends po {
  ...
  keccak() {
    Ho || Ko(this.state32), lh(this.state32, this.rounds), Ho || Ko(this.state32), this.posOut = 0, this.pos = 0;
  }
  update(e) {
    wr(this);
...
async function Xo(t) {
  const { cacao: e, projectId: s } = t, { s: r, p: i } = e, n = Kc(i, i.iss), o = Li(i.iss);
...
const Jc = (t) => Uint8Array.from(t.split("").map((e) => e.charCodeAt(0))), Hh = Jc("expand 16-byte k"), Kh = Jc("expand 32-byte k"), Vh = ws(Hh), Gh = ws(Kh);
function ce(t, e) {
  return t << e | t >>> 32 - e;
}
function Ln(t) {
...
function Xh(t, e) {
  ...
  return nn(i), nn(o), ta(n), ta(s), (a, c, l, u, d = 0) => {
    ...
    else if (w === 16 && s) m = new Uint8Array(32), m.set(a), m.set(a, 16), f = Vh, g.push(m);
...
const { bytesToNumberBE: Hp, hexToBytes: Kp } = Np;
class Vp extends Error {
  constructor(e = "") {
    super(e);
  }
}
const es = { Err: Vp, _tlv: { encode: (t, e) => {
  const { Err: s } = es;
  ...
  const { Err: e, _int: s, _tlv: r } = es, i = typeof t == "string" ? Kp(t) : t;
  ui(i);
...
function Yp(t) {
  ...
  function H(I, O, A, M = C) {
    ...
    G && (O = e.hash(O));
    const { r: De, s: Ge } = he, xe = P(O), Re = a(Ge), Is = o(xe * Re), Kt = o(De * Re), Dt = (Vt = c.BASE.multiplyAndAddUnsafe(Te, Is, Kt)) == null ? void 0 : Vt.toAffine();
...
function fl(t) {
  if (Ms(t.type) === hi) return ct(Vr([t.type, t.sealed]), $t);
  if (Ms(t.type) === rs) {
    if (typeof t.senderPublicKey > "u") throw new Error("Missing sender public key for type 1 envelope");
    return ct(Vr([t.type, t.senderPublicKey, t.iv, t.sealed]), $t);
  }
  return ct(Vr([t.type, t.iv, t.sealed]), $t);
}
function ii(t) {
...
function ug(t) {
  ...
  return Vr([new Uint8Array([4]), e, s]);
}
function dg(t, e) {
  ...
  if (!tg.verify(Vr([o, a]), l, u)) throw new Error("Invalid signature");
  return Sn(t).payload;
}
const hg = "irn";
function Fi(t) {
...
function Kg(t) {
  return !(Ke(t) || Ke(t.result) && Ke(t.error) || !yo(t.id, !1) || !ke(t.jsonrpc, !1));
}
function Vg(t) {
...
const Al = (t, e) => new Vf({ ...t.decoders || { [t.prefix]: t }, ...e.decoders || { [e.prefix]: e } });
class Gf {
  constructor(e, s, r, i) {
    this.name = e, this.prefix = s, this.baseEncode = r, this.baseDecode = i, this.encoder = new Hf(e, s, r), this.decoder = new Kf(e, s, i);
  }
  encode(e) {
...
const Qf = Ve({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
var em = Object.freeze({ __proto__: null, base2: Qf });
const tm = Ve({ prefix: "7", name: "base8", alphabet: "01234567", bitsPerChar: 3 });
...
const nm = Ve({ prefix: "f", name: "base16", alphabet: "0123456789abcdef", bitsPerChar: 4 }), om = Ve({ prefix: "F", name: "base16upper", alphabet: "0123456789ABCDEF", bitsPerChar: 4 });
var am = Object.freeze({ __proto__: null, base16: nm, base16upper: om });
const cm = Ve({ prefix: "b", name: "base32", alphabet: "abcdefghijklmnopqrstuvwxyz234567", bitsPerChar: 5 }), lm = Ve({ prefix: "B", name: "base32upper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", bitsPerChar: 5 }), um = Ve({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 }), dm = Ve({ prefix: "C", name: "base32padupper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", bitsPerChar: 5 }), hm = Ve({ prefix: "v", name: "base32hex", alphabet: "0123456789abcdefghijklmnopqrstuv", bitsPerChar: 5 }), pm = Ve({ prefix: "V", name: "base32hexupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV", bitsPerChar: 5 }), gm = Ve({ prefix: "t", name: "base32hexpad", alphabet: "0123456789abcdefghijklmnopqrstuv=", bitsPerChar: 5 }), fm = Ve({ prefix: "T", name: "base32hexpadupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV=", bitsPerChar: 5 }), mm = Ve({ prefix: "h", name: "base32z", alphabet: "ybndrfg8ejkmcpqxot1uwisza345h769", bitsPerChar: 5 });
...
const Nm = Ve({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 }), Am = Ve({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 }), _m = Ve({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 }), Sm = Ve({ prefix: "U", name: "base64urlpad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=", bitsPerChar: 6 });
...
var Fm = Kn, Mm = 128, $a = 127;
function Kn(t, r) {
  var s = 0, r = r || 0, i = 0, n = r, o, a = t.length;
  do {
    if (n >= a) throw Kn.bytes = 0, new RangeError("Could not decode varint");
    o = t[n++], s += i < 28 ? (o & $a) << i : (o & $a) * Math.pow(2, i), i += 7;
  } while (o >= Mm);
  return Kn.bytes = n - r, s;
}
var Bm = Math.pow(2, 7), qm = Math.pow(2, 14), jm = Math.pow(2, 21), Wm = Math.pow(2, 28), zm = Math.pow(2, 35), Hm = Math.pow(2, 42), Km = Math.pow(2, 49), Vm = Math.pow(2, 56), Gm = Math.pow(2, 63), Jm = function(t) {
  return t < Bm ? 1 : t < qm ? 2 : t < jm ? 3 : t < Wm ? 4 : t < zm ? 5 : t < Hm ? 6 : t < Km ? 7 : t < Vm ? 8 : t < Gm ? 9 : 10;
}, Ym = { encode: Um, decode: Fm, encodingLength: Jm }, Pl = Ym;
const Ua = (t, e, s = 0) => (Pl.encode(t, e, s), e), Da = (t) => Pl.encodingLength(t), Vn = (t, e) => {
...
class Zm {
  ...
  digest(e) {
    if (e instanceof Uint8Array) {
      ...
      return s instanceof Uint8Array ? Vn(this.code, s) : s.then((r) => Vn(this.code, r));
...
const kl = 0, sw = "identity", xl = Nl, rw = (t) => Vn(kl, xl(t)), iw = { code: kl, name: sw, encode: xl, digest: rw };
...
var Tw = Object.defineProperty, Ow = (t, e, s) => e in t ? Tw(t, e, { enumerable: !0, configurable: !0, writable: !0, value: s }) : t[e] = s, Ks = (t, e, s) => Ow(t, typeof e != "symbol" ? e + "" : e, s);
class kw {
  constructor() {
...
function Yr(t, e, s, r) {
  ...
  let i = Ka(t), n = Ka(e);
  if (i === Va && (i = bn), n === Va && (n = bn), i !== n) return !1;
  switch (i) {
    case zw:
  ...
  constructor(e, s, r, i = Ht, n = void 0) {
    super(e, s, r, i), this.core = e, this.logger = s, this.name = r, it(this, "map", /* @__PURE__ */ new Map()), it(this, "version", vf), it(this, "cached", []), it(this, "initialized", !1), it(this, "getKey"), it(this, "storagePrefix", Ht), it(this, "recentlyDeleted", []), it(this, "recentlyDeletedLimit", 200), it(this, "init", async () => {
      this.initialized || (this.logger.trace("Initialized"), await this.restore(), this.cached.forEach((o) => {
        this.getKey && o !== null && !Ke(o) ? this.map.set(this.getKey(o), o) : Rg(o) ? this.map.set(o.id, o) : $g(o) && this.map.set(o.topic, o);
      }), this.cached = [], this.initialized = !0);
    ...
    super(e), N(this, "name", Hy), N(this, "events", new lo()), N(this, "initialized", !1), N(this, "requestQueue", { state: Mt.idle, queue: [] }), N(this, "sessionRequestQueue", { state: Mt.idle, queue: [] }), N(this, "requestQueueDelay", U.ONE_SECOND), N(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), N(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), N(this, "recentlyDeletedLimit", 200), N(this, "relayMessageCache", []), N(this, "pendingSessions", /* @__PURE__ */ new Map()), N(this, "init", async () => {
      ...
      const P = f && f > Fe.wc_sessionAuthenticate.req.ttl ? f : Fe.wc_sessionAuthenticate.req.ttl, S = { authPayload: { type: h ?? "caip122", chains: a, statement: c, aud: l, domain: u, version: "1", nonce: d, iat: (/* @__PURE__ */ new Date()).toISOString(), exp: g, nbf: w, resources: y }, requester: { publicKey: _, metadata: this.client.metadata }, expiryTimestamp: Ue(P) }, D = { eip155: { chains: a, methods: [.../* @__PURE__ */ new Set(["personal_sign", ...m])], events: ["chainChanged", "accountsChanged"] } }, v = { requiredNamespaces: {}, optionalNamespaces: D, relays: [{ protocol: "irn" }], pairingTopic: b, proposer: { publicKey: _, metadata: this.client.metadata }, expiryTimestamp: Ue(Fe.wc_sessionPropose.req.ttl), id: is() }, { done: R, resolve: C, reject: L } = Ps(P, "Request expired"), H = is(), I = pe("session_connect", v.id), O = pe("session_request", H), A = async ({ error: k, session: G }) => {
        ...
        for (const Re of Ee) {
          ...
          const { p: Is } = Re, Kt = Ti(Is.resources), Dt = [$n(Is.iss)], Vt = Li(Is.iss);
          if (Kt) {
            const Gt = Zo(Kt), fi = Qo(Kt);
        ...
        let xe;
        Te.length > 0 && (xe = { topic: Ge, acknowledged: !0, self: { publicKey: _, metadata: this.client.metadata }, peer: he, controller: he.publicKey, expiry: Ue(Vs), requiredNamespaces: {}, optionalNamespaces: {}, relay: { protocol: "irn" }, pairingTopic: b, namespaces: Na([...new Set(Te)], [...new Set(De)]), transportType: o }, await this.client.core.relayer.subscribe(Ge, { transportType: o }), await this.client.session.set(Ge, xe), b && await this.client.core.pairing.updateMetadata({ topic: b, metadata: he.metadata }), xe = this.client.session.get(Ge)), (G = this.client.metadata.redirect) != null && G.linkMode && (Q = he.metadata.redirect) != null && Q.linkMode && (se = he.metadata.redirect) != null && se.universal && r && (this.client.core.addLinkModeSupportedApp(he.metadata.redirect.universal), this.client.session.update(Ge, { transportType: Ne.link_mode })), C({ auths: Ee, session: xe });
      };
      ...
      if ((h == null ? void 0 : h.length) > 0) {
        m = { topic: w, acknowledged: !0, self: { publicKey: l, metadata: this.client.metadata }, peer: { publicKey: c, metadata: o.requester.metadata }, controller: c, expiry: Ue(Vs), authentication: i, requiredNamespaces: {}, optionalNamespaces: {}, relay: { protocol: "irn" }, pairingTopic: o.pairingTopic, namespaces: Na([...new Set(h)], [...new Set(g)]), transportType: a }, n.addTrace(_s.subscribing_authenticated_session_topic);
        try {
      ...
      if (Ke(r) || await this.isValidPairingTopic(r), !jg(c)) {
...
class ab extends qs {
  constructor(e, s) {
    super(e, s, Ky, bo, (r) => r.id), this.core = e, this.logger = s;
  }
}
class cb extends qs {
  constructor(e, s) {
...
function hc(t) {
  ...
  for (const [s, r] of Object.entries(t)) {
    const i = r.methods || [], n = r.events || [], o = r.accounts || [], a = Gi(s) ? [s] : r.chains ? r.chains : Kl(r.accounts);
...
class Co {
  ...
  createProviders() {
    ...
    Nn("client", this.client), Nn("events", this.events), Nn("disableProviderPing", this.disableProviderPing), e.forEach((s) => {
      if (!this.session) return;
      const r = ev(s, this.session), i = Kl(r), n = Ai(this.namespaces, this.optionalNamespaces), o = An(_i({}, n[s]), { accounts: r, chains: i });
      switch (s) {
        case "eip155":
...
const _n = [
  ...
  getConnectOrderMethod(t, e) {
    ...
    return o.length || a.length ? ["wallet", "email", "social"] : Kv.DEFAULT_CONNECT_METHOD_ORDER;
  },
  isExcluded(t) {
    const e = !!t.rdns && K.state.excludedWallets.some((r) => r.rdns === t.rdns), s = !!t.name && K.state.excludedWallets.some((r) => Io.isLowerCaseMatch(r.name, t.name));
    return e || s;
  }
}, Ri = {
  ...
  showConnector(t) {
    var i;
    const e = (i = t.info) == null ? void 0 : i.rdns, s = !!e && K.state.excludedWallets.some((n) => !!n.rdns && n.rdns === e), r = !!t.name && K.state.excludedWallets.some((n) => Io.isLowerCaseMatch(n.name, t.name));
...
class e0 {
  constructor(e) {
    ...
    }, this.fetchIdentity = (s) => J.fetchIdentity(s), this.getReownName = (s) => Kr.getNamesForAddress(s), this.getConnectors = () => B.getConnectors(), this.getConnectorImage = (s) => Sc.getConnectorImage(s), this.setConnectedWalletInfo = (s, r) => {
  ...
  setThemeVariables(e) {
    ht.setThemeVariables(e), Vv(ht.state.themeVariables);
  }
  subscribeTheme(e) {
...
class Yl extends e0 {
  ...
  async injectModalUi() {
    if (!vc && X.isClient()) {
      if (await import("./basic-BXtUFL3H.js"), await import("./w3m-modal-DHolrXxx.js"), !document.querySelector("w3m-modal")) {
