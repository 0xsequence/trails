import { i as D, a as C, x as u } from "./lit-element-CWLRvgWK.js";
import { r, n as w } from "./class-map-BaJ3HzzH.js";
import { f as P, N as _, l as V, E as W, R as S, A as j, h as K, M, g as F, W as Q, r as H, e as q } from "./index-B7iWI5Xa.js";
import { c as U, U as x } from "./index-Cd9Pfdzb.js";
import "./index-CB4mFa7F.js";
import { M as R } from "./index-DPHBYpPN.js";
import "./index-CEH4QC2u.js";
import { S as n } from "./index-D3Gtmr93.js";
...
const G = {
  numericInputKeyDown(c, t, e) {
    const i = [
      ...
      "ArrowRight",
      "Tab"
    ], a = c.metaKey || c.ctrlKey, o = c.key, s = o.toLocaleLowerCase(), l = s === "a", m = s === "c", v = s === "v", L = s === "x", E = o === ",", O = o === ".", B = o >= "0" && o <= "9";
    !a && (l || m || v || L) && c.preventDefault(), t === "0" && !E && !O && o === "0" && c.preventDefault(), t === "0" && B && (e(o), c.preventDefault()), (E || O) && (t || (e("0."), c.preventDefault()), (t != null && t.includes(".") || t != null && t.includes(",")) && c.preventDefault()), !B && !i.includes(o) && !O && !E && c.preventDefault();
  }
}, X = D`
  :host {
    width: 100%;
...
`;
var k = function(c, t, e, i) {
  var a = arguments.length, o = a < 3 ? t : i === null ? i = Object.getOwnPropertyDescriptor(t, e) : i, s;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") o = Reflect.decorate(c, t, e, i);
  else for (var l = c.length - 1; l >= 0; l--) (s = c[l]) && (o = (a < 3 ? s(o) : a > 3 ? s(t, e, o) : s(t, e)) || o);
...
let f = class extends C {
  constructor() {
    var t;
    super(), this.unsubscribe = [], this.networkName = (t = P.state.activeCaipNetwork) == null ? void 0 : t.name, this.detailsOpen = !1, this.sourceToken = n.state.sourceToken, this.toToken = n.state.toToken, this.toTokenAmount = n.state.toTokenAmount, this.sourceTokenPriceInUSD = n.state.sourceTokenPriceInUSD, this.toTokenPriceInUSD = n.state.toTokenPriceInUSD, this.priceImpact = n.state.priceImpact, this.maxSlippage = n.state.maxSlippage, this.networkTokenSymbol = n.state.networkTokenSymbol, this.inputError = n.state.inputError, this.unsubscribe.push(n.subscribe((e) => {
...
let b = class extends C {
  ...
  handleKeydown(t) {
    return G.numericInputKeyDown(t, this.value, (e) => {
      var i;
      return (i = this.onSetAmount) == null ? void 0 : i.call(this, this.target, e);
    });
  }
...
let p = class extends C {
  constructor() {
    var t, e;
    super(), this.unsubscribe = [], this.initialParams = (t = S.state.data) == null ? void 0 : t.swap, this.detailsOpen = !1, this.caipAddress = j.state.caipAddress, this.caipNetworkId = (e = P.state.activeCaipNetwork) == null ? void 0 : e.caipNetworkId, this.initialized = n.state.initialized, this.loadingQuote = n.state.loadingQuote, this.loadingPrices = n.state.loadingPrices, this.loadingTransaction = n.state.loadingTransaction, this.sourceToken = n.state.sourceToken, this.sourceTokenAmount = n.state.sourceTokenAmount, this.sourceTokenPriceInUSD = n.state.sourceTokenPriceInUSD, this.toToken = n.state.toToken, this.toTokenAmount = n.state.toTokenAmount, this.toTokenPriceInUSD = n.state.toTokenPriceInUSD, this.inputError = n.state.inputError, this.fetchError = n.state.fetchError, this.lastTokenPriceUpdate = 0, this.minTokenPriceUpdateInterval = 1e4, this.visibilityChangeHandler = () => {
      ...
      await n.swapTokens();
    }, 200), P.subscribeKey("activeCaipNetwork", (i) => this.onCaipNetworkChange({
      newCaipNetwork: i,
      resetSwapState: !0,
      initializeSwapState: !1
    })), j.subscribeKey("caipAddress", (i) => this.onCaipAddressChange({
      newCaipAddress: i,
      resetSwapState: !0,
      initializeSwapState: !1
    })), this.unsubscribe.push(P.subscribeKey("activeCaipNetwork", (i) => this.onCaipNetworkChange({
      newCaipNetwork: i,
      resetSwapState: !1,
  ...
  templateTokenInput(t, e) {
    var l, m;
    const i = (l = n.state.myTokensWithBalance) == null ? void 0 : l.find((v) => (v == null ? void 0 : v.address) === (e == null ? void 0 : e.address)), a = t === "toToken" ? this.toTokenAmount : this.sourceTokenAmount, o = t === "toToken" ? this.toTokenPriceInUSD : this.sourceTokenPriceInUSD, s = _.parseLocalStringToNumber(a) * o;
  ...
  templateActionButton() {
    const t = !this.toToken || !this.sourceToken, e = !this.sourceTokenAmount, i = this.loadingQuote || this.loadingPrices || this.loadingTransaction, a = i || t || e || this.inputError;
  ...
  async onSwapPreview() {
    ...
    this.fetchError && await n.swapTokens(), W.sendEvent({
      ...
      properties: {
        ...
        isSmartAccount: F(P.state.activeChain) === Q.ACCOUNT_TYPES.SMART_ACCOUNT
      }
    }), S.push("SwapPreview");
  }
  async handleSwapParameters() {
    this.initialParams && (n.state.initialized || await new Promise((e) => {
      const i = n.subscribeKey("initialized", (a) => {
        a && (i == null || i(), e());
      });
    }), await this.setSwapParameters(this.initialParams));
  }
  async setSwapParameters({ amount: t, fromToken: e, toToken: i }) {
    (!n.state.tokens || !n.state.myTokensWithBalance) && await new Promise((s) => {
      const l = n.subscribeKey("myTokensWithBalance", (m) => {
        m && m.length > 0 && (l == null || l(), s());
      });
      setTimeout(() => {
        l == null || l(), s();
      }, 5e3);
    ...
    if (e) {
      const o = a.find((s) => s.symbol.toLowerCase() === e.toLowerCase());
      o && n.setSourceToken(o);
    }
    if (i) {
      const o = a.find((s) => s.symbol.toLowerCase() === i.toLowerCase());
      o && n.setToToken(o);
    }
    t && !isNaN(Number(t)) && n.setSourceTokenAmount(t);
  }
  onCaipAddressChange({ newCaipAddress: t, resetSwapState: e, initializeSwapState: i }) {
    this.caipAddress !== t && (this.caipAddress = t, e && n.resetState(), i && n.initializeState());
  }
  onCaipNetworkChange({ newCaipNetwork: t, resetSwapState: e, initializeSwapState: i }) {
    this.caipNetworkId !== (t == null ? void 0 : t.caipNetworkId) && (this.caipNetworkId = t == null ? void 0 : t.caipNetworkId, e && n.resetState(), i && n.initializeState());
  }
};
p.styles = et;
h([
...
let d = class extends C {
  constructor() {
    ...
    }), P.subscribeKey("activeCaipNetwork", (t) => {
  ...
  templateSwap() {
    var m, v, L, E;
    const t = `${x.formatNumberToLocalString(parseFloat(this.sourceTokenAmount))} ${(m = this.sourceToken) == null ? void 0 : m.symbol}`, e = `${x.formatNumberToLocalString(parseFloat(this.toTokenAmount))} ${(v = this.toToken) == null ? void 0 : v.symbol}`, i = parseFloat(this.sourceTokenAmount) * this.sourceTokenPriceInUSD, a = parseFloat(this.toTokenAmount) * this.toTokenPriceInUSD, o = x.formatNumberToLocalString(i), s = x.formatNumberToLocalString(a), l = this.loadingQuote || this.loadingBuildTransaction || this.loadingTransaction || this.loadingApprovalTransaction;
    return u`
...
let T = class extends C {
  ...
  disconnectedCallback() {
    ...
    const t = (i = this.renderRoot) == null ? void 0 : i.querySelector(".suggested-tokens-container"), e = (a = this.renderRoot) == null ? void 0 : a.querySelector(".tokens");
  ...
  templateTokens() {
    const t = this.myTokensWithBalance ? Object.values(this.myTokensWithBalance) : [], e = this.popularTokens ? this.popularTokens : [], i = this.filterTokensWithText(t, this.searchValue), a = this.filterTokensWithText(e, this.searchValue);
    return u`
      <wui-flex class="tokens-container">
        <wui-flex class="tokens" .padding=${["0", "s", "s", "s"]} flexDirection="column">
          ${(i == null ? void 0 : i.length) > 0 ? u`
                ...
                ${i.map((o) => {
      var l, m, v;
      const s = o.symbol === ((l = this.sourceToken) == null ? void 0 : l.symbol) || o.symbol === ((m = this.toToken) == null ? void 0 : m.symbol);
      return u`
                    <wui-token-list-item
  ...
  filterTokensWithText(t, e) {
    return t.filter((i) => `${i.symbol} ${i.name} ${i.address}`.toLowerCase().includes(e.toLowerCase()));
  }
};
T.styles = nt;
I([
