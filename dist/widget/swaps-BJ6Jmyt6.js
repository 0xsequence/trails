import { i as P, a as C, e as D, N as _, b as K, f as W, R as S, A as j, d as V, M, h as F, W as Q, r as q, j as H } from "./index-D7QEUbBB.js";
import { x as u } from "./lit-html-jz-94mx9.js";
import { r as s, n as h, c as E, U as m } from "./if-defined-C_M2V4-7.js";
import "./index-Dqfsto7-.js";
import { M as N } from "./index-D4CX5tKt.js";
import "./index-BaEGgDqQ.js";
import { S as n } from "./index-CSYoQLtw.js";
...
let p = class extends C {
  ...
  templateTokenInput(t, e) {
    var l, x;
    const o = (l = n.state.myTokensWithBalance) == null ? void 0 : l.find((v) => (v == null ? void 0 : v.address) === (e == null ? void 0 : e.address)), a = t === "toToken" ? this.toTokenAmount : this.sourceTokenAmount, i = t === "toToken" ? this.toTokenPriceInUSD : this.sourceTokenPriceInUSD, r = _.parseLocalStringToNumber(a) * i;
  ...
  async onSwapPreview() {
    ...
    this.fetchError && await n.swapTokens(), W.sendEvent({
      ...
      properties: {
        ...
        isSmartAccount: F(t) === Q.ACCOUNT_TYPES.SMART_ACCOUNT
      }
    }), S.push("SwapPreview");
  }
...
let T = class extends C {
  ...
  handleSuggestedTokensScroll() {
    ...
    t && (t.style.setProperty("--suggested-tokens-scroll--left-opacity", N.interpolate([0, 100], [0, 1], t.scrollLeft).toString()), t.style.setProperty("--suggested-tokens-scroll--right-opacity", N.interpolate([0, 100], [0, 1], t.scrollWidth - t.scrollLeft - t.offsetWidth).toString()));
  }
  handleTokenListScroll() {
    var e;
    const t = (e = this.renderRoot) == null ? void 0 : e.querySelector(".tokens");
    t && (t.style.setProperty("--tokens-scroll--top-opacity", N.interpolate([0, 100], [0, 1], t.scrollTop).toString()), t.style.setProperty("--tokens-scroll--bottom-opacity", N.interpolate([0, 100], [0, 1], t.scrollHeight - t.scrollTop - t.offsetHeight).toString()));
  }
