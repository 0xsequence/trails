import { M as p, _ as R, R as c, i as y, r as D, a as C, o as _, j as re, U as ce, h, u as L, H as le, p as H, e as q, O as T, C as z, A as F, S as E, V as P, T as de, a0 as ue, P as pe, d as he, c as we } from "./index-DvFVvMve.js";
import { x as l } from "./lit-html-BRjl1r6K.js";
import { c as b, n as u, r as d, o as M, U as me } from "./if-defined-CqrI9SVX.js";
...
let B = class extends C {
  ...
  render() {
    const { message: e, variant: t } = _.state, i = ye[t];
    return l`
      <wui-alertbar
        message=${e}
...
function K() {
  var s, r, k, m, A, $, O;
  const n = (r = (s = c.state.data) == null ? void 0 : s.connector) == null ? void 0 : r.name, e = (m = (k = c.state.data) == null ? void 0 : k.wallet) == null ? void 0 : m.name, t = ($ = (A = c.state.data) == null ? void 0 : A.network) == null ? void 0 : $.name, i = e ?? n, a = z.getConnectors();
  return {
...
let w = class extends C {
  constructor() {
    super(), this.unsubscribe = [], this.heading = K()[c.state.view], this.network = h.state.activeCaipNetwork, this.networkImage = L.getNetworkImage(this.network), this.showBack = !1, this.prevHistoryLength = 1, this.view = c.state.view, this.viewDirection = "", this.headerText = K()[c.state.view], this.unsubscribe.push(le.subscribeNetworkImages(() => {
  ...
  leftHeaderTemplate() {
    var m;
    const { view: e } = c.state, t = e === "Connect", i = T.state.enableEmbedded, a = e === "ApproveTransaction", o = e === "ConnectingSiwe", s = e === "Account", r = T.state.enableNetworkSwitch, k = a || o || t && i;
    return s && r ? l`<wui-select
        id="dynamic"
...
let j = class extends C {
  constructor() {
    super(), this.unsubscribe = [], this.timeout = void 0, this.open = E.state.open, this.unsubscribe.push(E.subscribeKey("open", (e) => {
  ...
  render() {
    const { message: e, variant: t, svg: i } = E.state, a = Ae[t], { icon: o, iconColor: s } = i ?? a ?? {};
    return l`
      <wui-snackbar
        message=${e}
...
class v extends C {
  ...
  initializeTheming() {
    const { themeVariables: e, themeMode: t } = de.state, i = me.getColorTheme(t);
    ue(e, i);
  }
  onClose() {
  ...
  async onNewAddress(e) {
    const t = h.state.isSwitchingNamespace, i = c.state.view === "ProfileWallets";
    e ? await this.onConnected({
      caipAddress: e,
      isSwitchingNamespace: t,
      isInProfileView: i
    }) : !t && !this.enableEmbedded && !i && p.close(), await R.initializeIfEnabled(), this.caipAddress = e, h.setIsSwitchingNamespace(!1);
  }
  async onConnected(e) {
    if (e.isInProfileView)
      return;
    const { chainNamespace: t, chainId: i, address: a } = pe.parseCaipAddress(e.caipAddress), o = `${t}:${i}`, s = !he.getPlainAddress(this.caipAddress), r = await R.getSessions({ address: a, caipNetworkId: o }), k = R.getSIWX() ? r.some(($) => $.data.accountAddress === a) : !0, m = e.isSwitchingNamespace && k && !this.enableEmbedded, A = this.enableEmbedded && s;
    m ? c.goBack() : A && p.close();
  }
  onNewNetwork(e) {
    var Y, X, G;
    const t = this.caipNetwork, i = (Y = t == null ? void 0 : t.caipNetworkId) == null ? void 0 : Y.toString(), a = t == null ? void 0 : t.chainNamespace, o = (X = e == null ? void 0 : e.caipNetworkId) == null ? void 0 : X.toString(), s = e == null ? void 0 : e.chainNamespace, r = i !== o, m = r && !(a !== s), A = (t == null ? void 0 : t.name) === we.UNSUPPORTED_NETWORK_NAME, $ = c.state.view === "ConnectingExternal", O = c.state.view === "ProfileWallets", ae = !((G = h.getAccountData(e == null ? void 0 : e.chainNamespace)) != null && G.caipAddress), se = c.state.view === "UnsupportedChain", ne = p.state.open;
    let N = !1;
    this.enableEmbedded && c.state.view === "SwitchNetwork" && (N = !0), ne && !$ && !O && (ae ? r && (N = !0) : (se || m && !A) && (N = !0)), N && c.state.view !== "SIWXSignMessage" && c.goBack(), this.caipNetwork = e;
  }
  prefetch() {
