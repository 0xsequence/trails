import { i as v, a as h, M as R, C as W, T as E, g as M, b as N, r as j, c as $, E as c, A, d as O, e as D, f as x, h as y, W as S, S as P, R as k } from "./index-D7QEUbBB.js";
import { x as l } from "./lit-html-jz-94mx9.js";
import { r as p, c as f, n as g, o as z } from "./if-defined-C_M2V4-7.js";
import { N as H } from "./index-CapW5lEl.js";
import { e as V, n as F } from "./ref-BKG_cabU.js";
...
`;
var U = function(o, e, t, n) {
  var s = arguments.length, i = s < 3 ? e : n === null ? n = Object.getOwnPropertyDescriptor(e, t) : n, r;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") i = Reflect.decorate(o, e, t, n);
  else for (var a = o.length - 1; a >= 0; a--) (r = o[a]) && (i = (s < 3 ? r(i) : s > 3 ? r(e, t, i) : r(e, t)) || i);
  return s > 3 && i && Object.defineProperty(e, t, i), i;
};
const T = 600, _ = 360, Y = 64;
let b = class extends h {
  ...
  disconnectedCallback() {
    var e;
    this.onHideIframe(), this.unsubscribe.forEach((t) => t()), (e = this.bodyObserver) == null || e.unobserve(window.document.body);
  }
  async firstUpdated() {
    var t;
    await this.syncTheme(), this.iframe.style.display = "block";
    const e = (t = this == null ? void 0 : this.renderRoot) == null ? void 0 : t.querySelector("div");
    this.bodyObserver = new ResizeObserver((n) => {
      var r, a;
      const s = (r = n == null ? void 0 : n[0]) == null ? void 0 : r.contentBoxSize, i = (a = s == null ? void 0 : s[0]) == null ? void 0 : a.inlineSize;
      this.iframe.style.height = `${T}px`, e.style.height = `${T}px`, i && i <= 430 ? (this.iframe.style.width = "100%", this.iframe.style.left = "0px", this.iframe.style.bottom = "0px", this.iframe.style.top = "unset") : (this.iframe.style.width = `${_}px`, this.iframe.style.left = `calc(50% - ${_ / 2}px)`, this.iframe.style.top = `calc(50% - ${T / 2}px + ${Y / 2}px)`, this.iframe.style.bottom = "unset"), this.ready = !0, this.onShowIframe();
  ...
  async syncTheme() {
    ...
    if (e) {
      const t = E.getSnapshot().themeMode, n = E.getSnapshot().themeVariables;
      await e.provider.syncTheme({
        themeVariables: n,
        w3mThemeVariables: M(n, t)
      });
    }
  }
};
...
let u = class extends h {
  constructor() {
    super(), this.formRef = V(), this.usubscribe = [], this.name = "", this.error = "", this.loading = c.state.loading, this.suggestions = c.state.suggestions, this.registered = !1, this.profileName = A.state.profileName, this.onDebouncedNameInputChange = O.debounce((e) => {
      c.validateName(e) ? (this.error = "", this.name = e, c.getSuggestions(e), c.isNameRegistered(e).then((t) => {
        this.registered = t;
  ...
  disconnectedCallback() {
    var e;
    super.disconnectedCallback(), this.usubscribe.forEach((t) => t()), (e = this.formRef.value) == null || e.removeEventListener("keydown", this.onEnterKey.bind(this));
  }
  render() {
    return l`
      <wui-flex
  ...
  async onSubmitName() {
    ...
    try {
      ...
      x.sendEvent({
        ...
        properties: {
          isSmartAccount: y(e) === S.ACCOUNT_TYPES.SMART_ACCOUNT,
          ensName: t
        }
      ...
      P.showError(t.message), x.sendEvent({
        type: "track",
