import { N as l, w as V, v as $, R as A, S as g, l as B, c as S, e as x, f as F, W as M, h, B as v, d as _, x as C, A as H, o as j, y as q, b as G, z as Q, C as K, D as Y, F as J, i as X, r as Z, j as ee, a as oe } from "./index-C5WaG16p.js";
import { x as L } from "./lit-html-jz-94mx9.js";
import { n as z, c as ne } from "./if-defined-CulHeU7H.js";
...
const P = {
  ...
  getParams() {
    var c, d, T, m, f, w, b, I;
    const o = h.state.activeCaipAddress, t = _.getPlainAddress(o), n = Q(), s = K.getConnectorId(h.state.activeChain);
    if (!t)
  ...
  async createSwapTransaction() {
    ...
    try {
      const c = await v.generateSwapCalldata({
        ...
        amount: r,
        disableEstimate: !0
      }), d = s.address === o, T = BigInt(c.tx.eip155.gas), m = BigInt(c.tx.eip155.gasPrice), f = _.getPlainAddress(c.tx.to);
      if (!f)
