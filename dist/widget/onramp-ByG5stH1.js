import { i as T, a as w, G as Z, H as l, I as N, J as x, A as L, O as S, M as I, e as O, u as ee, f as G, h as H, W as Q, R as B, d as V, b as M, B as X, l as te, S as E, T as ie } from "./index-D7QEUbBB.js";
import { x as c } from "./lit-html-jz-94mx9.js";
import { n as d, c as g, o as h, r as u } from "./if-defined-C_M2V4-7.js";
import { D as re, T as oe } from "./index-aK_po7F7.js";
import "./index-QlLoATd0.js";
import "./index-C5xfMYb8.js";
import "./index-BMAzJhf3.js";
import "./index-4ezqlBN4.js";
import { O as z } from "./index-DDCRxesg.js";
...
let K = class extends w {
  ...
  onWhatIsBuy() {
    ...
    G.sendEvent({
      ...
      properties: {
        isSmartAccount: H(e) === Q.ACCOUNT_TYPES.SMART_ACCOUNT
      }
    }), B.push("WhatIsABuy");
  }
};
...
let Y = class extends w {
  ...
  onClickProvider(e) {
    ...
    l.setSelectedProvider(e), B.push("BuyInProgress"), V.openHref(e.url, "popupWindow", "width=600,height=800,scrollbars=yes"), G.sendEvent({
      ...
      properties: {
        provider: e.name,
        isSmartAccount: H(t) === Q.ACCOUNT_TYPES.SMART_ACCOUNT
      }
    });
  }
...
let m = class extends w {
  ...
  onCopyUri() {
    ...
    if (!((e = this.selectedOnRampProvider) != null && e.url)) {
      E.showError("No link found"), B.goBack();
      return;
    }
    try {
