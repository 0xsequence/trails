...
import { n as O, o as xt, r as rt } from "./class-map-BaJ3HzzH.js";
import { r as $t, b as at, Y as j, c as ft, R as Mt, O as Ot, E as St, g as At, W as Ct } from "./index-C8kdZHDI.js";
import { U as vt, c as dt } from "./index-D5_HZ1pl.js";
import { ah as pt, ai as ht } from "./prepareSend-CyXootal.js";
...
(function(t, e) {
  (function(i, o) {
    ...
    var i = 1e3, o = 6e4, u = 36e5, r = "millisecond", c = "second", d = "minute", g = "hour", h = "day", v = "week", x = "month", R = "quarter", T = "year", D = "date", Y = "Invalid Date", W = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, Q = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, X = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(p) {
  ...
  (function(i, o) {
    ...
    return function(i, o, u) {
      ...
      u.en.relativeTime = c, r.fromToBase = function(h, v, x, R, T) {
        for (var D, Y, W, Q = x.$locale().relativeTime || c, X = i.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], tt = X.length, U = 0; U < tt; U += 1) {
          var A = X[U];
          ...
          if (W = D > 0, C <= A.r || !A.r) {
            C <= 1 && U > 0 && (A = X[U - 1]);
            var P = Q[A.l];
            T && (C = T("" + C)), Y = typeof P == "string" ? P.replace("%d", C) : P(C, v, A.l, W);
            break;
          }
        }
        if (v) return Y;
        var H = W ? Q.future : Q.past;
...
const mt = {
  ...
  getRelativeDateFromNow(t) {
    return Z(t).locale("en-web3-modal").fromNow(!0);
  },
...
J([
  O({ type: Boolean })
], k.prototype, "onlyDirectionIcon", void 0);
J([
  O({ type: Array })
], k.prototype, "images", void 0);
J([
  O({ type: Object })
], k.prototype, "secondImage", void 0);
k = J([
...
let B = class extends lt {
  ...
  templateRenderTransaction(e, i) {
    ...
    return (h == null ? void 0 : h.length) === 2 && !c ? $`
        ...
        ></wui-transaction-list-item>
      ` : x ? h.map((T, D) => {
      const Y = K.getTransferDescription(T), W = i && D === h.length - 1;
