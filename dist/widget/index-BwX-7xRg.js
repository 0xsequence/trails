import { i as ct, a as lt, x as $ } from "./lit-element-CWLRvgWK.js";
import { n as O, o as xt, r as rt } from "./class-map-h_7ODbZJ.js";
import { r as $t, f as at, Z as j, c as ft, R as Mt, O as Ot, d as St, e as At, W as Ct } from "./index-YPhvagLx.js";
import { U as vt, c as dt } from "./index-BluLXyw-.js";
import { R as pt, U as ht } from "./prepareSend-56cmiyOF.js";
...
(function(t, e) {
  (function(i, o) {
    ...
    C[A] = X;
    var P = "$isDayjsObject", H = function(p) {
      return p instanceof ot || !(!p || !p[P]);
    }, nt = function p(a, n, l) {
      var s;
      if (!a) return A;
      if (typeof a == "string") {
    ...
    var ot = function() {
      function p(n) {
        this.$L = nt(n.locale, null, !0), this.parse(n), this.$x = this.$x || n.x || {}, this[P] = !0;
      }
      var a = p.prototype;
      return a.parse = function(n) {
        ...
        return f.replace(Q, function(I, E) {
  ...
  (function(i, o) {
    ...
    return function(i, o, u) {
      ...
      u.en.relativeTime = c, r.fromToBase = function(h, v, x, R, T) {
        for (var D, k, U, Q = x.$locale().relativeTime || c, X = i.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], tt = X.length, W = 0; W < tt; W += 1) {
          var A = X[W];
          ...
          if (U = D > 0, C <= A.r || !A.r) {
            C <= 1 && W > 0 && (A = X[W - 1]);
            var P = Q[A.l];
            T && (C = T("" + C)), k = typeof P == "string" ? P.replace("%d", C) : P(C, v, A.l, U);
            break;
          }
        }
        if (v) return k;
        var H = U ? Q.future : Q.past;
...
const mt = {
...
}, Et = 3, Ut = ["receive", "deposit", "borrow", "claim"], Wt = ["withdraw", "repay", "burn"], Z = {
  ...
  getTransactionDescriptions(t) {
    ...
    if (!o)
      return (e === "send" || e === "receive") && r ? (g = vt.getTruncateString({
        string: t == null ? void 0 : t.metadata.sentFrom,
        charsStart: 4,
        charsEnd: 6,
        truncate: "middle"
      }), h = vt.getTruncateString({
    ...
    let v = "";
    return Ut.includes(e) ? v = "+" : Wt.includes(e) && (v = "-"), g = v.concat(g), [g];
  },
  ...
  render() {
    return $`
      <wui-flex>
        <wui-transaction-visual
          .status=${this.status}
          direction=${xt(this.direction)}
          type=${this.type}
          onlyDirectionIcon=${xt(this.onlyDirectionIcon)}
          .images=${this.images}
        ></wui-transaction-visual>
...
const ut = "last-transaction", Pt = 7;
let B = class extends lt {
  ...
  templateTransactionsByYear() {
    return Object.keys(this.transactionsByYear).sort().reverse().map((i) => {
      const o = parseInt(i, 10), u = new Array(12).fill(null).map((r, c) => {
        var h;
        const d = Z.getTransactionGroupTitle(o, c), g = (h = this.transactionsByYear[o]) == null ? void 0 : h[c];
        return {
          groupTitle: d,
          transactions: g
        };
  ...
  templateRenderTransaction(e, i) {
    ...
    return (h == null ? void 0 : h.length) === 2 && !c ? $`
        ...
        ></wui-transaction-list-item>
      ` : x ? h.map((T, D) => {
      const k = Z.getTransferDescription(T), U = i && D === h.length - 1;
  ...
  templateLoading() {
    return this.page === "activity" ? Array(Pt).fill($` <wui-transaction-list-item-loader></wui-transaction-list-item-loader> `).map((e) => e) : null;
  }
  onReceiveClick() {
  ...
  getTransactionListItemProps(e) {
    var g, h, v, x, R;
    const i = mt.formatDate((g = e == null ? void 0 : e.metadata) == null ? void 0 : g.minedAt), o = Z.getTransactionDescriptions(e), u = e == null ? void 0 : e.transfers, r = (h = e == null ? void 0 : e.transfers) == null ? void 0 : h[0], c = !!r && ((v = e == null ? void 0 : e.transfers) == null ? void 0 : v.every((T) => !!T.nft_info)), d = Z.getTransactionImages(u);
    return {
      date: i,
