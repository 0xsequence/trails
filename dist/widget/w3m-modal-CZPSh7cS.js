import { i as v, a as f, x as a } from "./lit-element-CWLRvgWK.js";
import { n as w, r as d, o as q } from "./class-map-BaJ3HzzH.js";
import { w as ve, p as fe, s as ge, a as be, M as g, S as se, R as l, r as P, A as K, e as ce, c as le, C as m, b as Y, d as ye, f as S, E as ie, O as E, g as F, h as oe, i as T, j as H, T as xe, k as Ce, l as ke, m as Se } from "./core-CPzRvkzn.js";
import { c as u, U as We } from "./index-7ybsrdVB.js";
const p = fe({
  message: "",
  open: !1,
  triggerRect: {
  ...
  async safeClose() {
    ...
    if (await se.isSIWXCloseDisabled()) {
      g.shake();
      return;
    }
    g.close();
...
function G() {
  var s, c, N, k, j, L, U;
  const r = (c = (s = l.state.data) == null ? void 0 : s.connector) == null ? void 0 : c.name, e = (k = (N = l.state.data) == null ? void 0 : N.wallet) == null ? void 0 : k.name, t = (L = (j = l.state.data) == null ? void 0 : j.network) == null ? void 0 : L.name, o = e ?? r, n = F.getConnectors();
  return {
...
let h = class extends f {
  ...
  leftHeaderTemplate() {
    var k;
    const { view: e } = l.state, t = e === "Connect", o = E.state.enableEmbedded, n = e === "ApproveTransaction", i = e === "ConnectingSiwe", s = e === "Account", c = E.state.enableNetworkSwitch, N = n || i || t && o;
...
let X = class extends f {
  ...
  render() {
    const { message: e, variant: t, svg: o } = T.state, n = je[t], { icon: i, iconColor: s } = o ?? n ?? {};
    return a`
      <wui-snackbar
        message=${e}
...
class x extends f {
  ...
  async onNewAddress(e) {
    ...
    !o && !t ? g.close() : t && o && l.goBack(), await se.initializeIfEnabled(), this.caipAddress = e, m.setIsSwitchingNamespace(!1);
  }
  onNewNetwork(e) {
    var Z, ee, te;
