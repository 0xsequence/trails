import { N as l, w as V, p as $, R as A, S as g, b as B, d as S, E as x, g as M, W as F, f as h, B as y, h as W, i as C, A as H, j, k as q, l as G, m as Q, n as K, s as Y, a as J, r as X, e as Z } from "./index-Cdjo1-uC.js";
import { i as ee, a as oe, x as L } from "./lit-element-CWLRvgWK.js";
import { n as z } from "./class-map-BaJ3HzzH.js";
import "./index-C2iZFEYI.js";
import { c as ne } from "./index-BgaOWKxg.js";
...
const P = {
  ...
  async getNetworkTokenPrice() {
    var i;
    const { networkAddress: o } = a.getParams(), n = (i = (await y.fetchTokenPrice({
      addresses: [o]
  ...
  async sendTransactionForApproval(o) {
    ...
    try {
      ...
      const d = c;
      e.transactionError = d == null ? void 0 : d.displayMessage, e.loadingApprovalTransaction = !1, g.showError((d == null ? void 0 : d.displayMessage) || "Transaction error"), x.sendEvent({
        type: "track",
        ...
        properties: {
          ...
          isSmartAccount: M(S.CHAIN.EVM) === F.ACCOUNT_TYPES.SMART_ACCOUNT
        }
      });
    }
  },
  async sendTransactionForSwap(o) {
    ...
    try {
      ...
      const p = D;
      e.transactionError = p == null ? void 0 : p.displayMessage, e.loadingTransaction = !1, g.showError((p == null ? void 0 : p.displayMessage) || "Transaction error"), x.sendEvent({
        type: "track",
        event: "SWAP_ERROR",
        properties: {
          message: (p == null ? void 0 : p.displayMessage) || (p == null ? void 0 : p.message) || "Unknown",
