import { i as p, a as h, x as e } from "./lit-element-CWLRvgWK.js";
import { r as u } from "./class-map-h_7ODbZJ.js";
import { R as l, n as c } from "./index-YPhvagLx.js";
import { c as d } from "./index-BluLXyw-.js";
import { T as g } from "./index-ogNOo4Ft.js";
const f = p`
  :host {
    --prev-height: 0px;
    --new-height: 0px;
...
var v = function(s, t, i, r) {
  var w = arguments.length, a = w < 3 ? t : r === null ? r = Object.getOwnPropertyDescriptor(t, i) : r, o;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") a = Reflect.decorate(s, t, i, r);
  else for (var m = s.length - 1; m >= 0; m--) (o = s[m]) && (a = (w < 3 ? o(a) : w > 3 ? o(t, i, a) : o(t, i)) || a);
...
let n = class extends h {
  ...
  firstUpdated() {
    ...
    this.resizeObserver = new ResizeObserver(([i]) => {
      ...
      }, c.ANIMATION_DURATIONS.ModalHeight);
  ...
  onViewChange(t) {
    g.hide();
    let i = c.VIEW_DIRECTION.Next;
    const { history: r } = l.state;
    r.length < this.prevHistoryLength && (i = c.VIEW_DIRECTION.Prev), this.prevHistoryLength = r.length, this.viewDirection = i, setTimeout(() => {
      this.view = t;
    }, c.ANIMATION_DURATIONS.ViewTransition);
  }
  getWrapper() {
    var t;
