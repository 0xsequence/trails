import { i as _, a as N, r as Y, e as C, I as h, d as I, R as L, O as z, f as E, h as W, W as F } from "./index-D7QEUbBB.js";
import { x as a } from "./lit-html-jz-94mx9.js";
import { n as l, c as S, o as k, r as v } from "./if-defined-C_M2V4-7.js";
import { T as A, D as U } from "./index-aK_po7F7.js";
import "./index-QlLoATd0.js";
import "./index-XWBDgTd7.js";
import "./index-C5xfMYb8.js";
var R;
(function(o) {
  o.approve = "approved", o.bought = "bought", o.borrow = "borrowed", o.burn = "burnt", o.cancel = "canceled", o.claim = "claimed", o.deploy = "deployed", o.deposit = "deposited", o.execute = "executed", o.mint = "minted", o.receive = "received", o.repay = "repaid", o.send = "sent", o.sell = "sold", o.stake = "staked", o.trade = "swapped", o.unstake = "unstaked", o.withdraw = "withdrawn";
})(R || (R = {}));
const V = _`
  :host > wui-flex {
    display: flex;
...
var m = function(o, t, e, r) {
  var s = arguments.length, i = s < 3 ? t : r === null ? r = Object.getOwnPropertyDescriptor(t, e) : r, n;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") i = Reflect.decorate(o, t, e, r);
  else for (var c = o.length - 1; c >= 0; c--) (n = o[c]) && (i = (s < 3 ? n(i) : s > 3 ? n(t, e, i) : n(t, e)) || i);
...
let f = class extends N {
  ...
  render() {
    const [t, e] = this.images, r = (t == null ? void 0 : t.type) === "NFT", s = e != null && e.url ? e.type === "NFT" : r, i = r ? "var(--wui-border-radius-xxs)" : "var(--wui-border-radius-s)", n = s ? "var(--wui-border-radius-xxs)" : "var(--wui-border-radius-s)";
...
let g = class extends N {
  ...
  templateTransactionsByYear() {
    return Object.keys(this.transactionsByYear).sort().reverse().map((e) => {
      const r = parseInt(e, 10), s = new Array(12).fill(null).map((i, n) => {
        var u;
        const c = A.getTransactionGroupTitle(r, n), d = (u = this.transactionsByYear[r]) == null ? void 0 : u[n];
        return {
          groupTitle: c,
          transactions: d
        };
  ...
  templateRenderTransaction(t, e) {
    const { date: r, descriptions: s, direction: i, isAllNFT: n, images: c, status: d, transfers: u, type: y } = this.getTransactionListItemProps(t), b = (u == null ? void 0 : u.length) > 1;
  ...
  createPaginationObserver() {
    const t = C.state.activeChain, { projectId: e } = z.state;
    this.paginationObserver = new IntersectionObserver(([r]) => {
      r != null && r.isIntersecting && !this.loading && (h.fetchTransactions(I.getPlainAddress(this.caipAddress)), E.sendEvent({
        type: "track",
        ...
        properties: {
          ...
          projectId: e,
          cursor: this.next,
          isSmartAccount: W(t) === F.ACCOUNT_TYPES.SMART_ACCOUNT
        }
      }));
    }, {}), this.setPaginationObserver();
  }
  ...
  getTransactionListItemProps(t) {
    var d, u, y, b, O;
    const e = U.formatDate((d = t == null ? void 0 : t.metadata) == null ? void 0 : d.minedAt), r = A.getTransactionDescriptions(t), s = t == null ? void 0 : t.transfers, i = (u = t == null ? void 0 : t.transfers) == null ? void 0 : u[0], n = !!i && ((y = t == null ? void 0 : t.transfers) == null ? void 0 : y.every(($) => !!$.nft_info)), c = A.getTransactionImages(s);
    return {
      date: e,
