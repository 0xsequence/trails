import type { CommitIntentConfigReturn, GetIntentCallsPayloadsArgs, GetIntentCallsPayloadsReturn as GetIntentCallsPayloadsReturnFromAPI, IntentCallsPayload, IntentPrecondition, SequenceAPIClient, TrailsExecutionInfo } from "@0xsequence/trails-api";
export type { IntentCallsPayload, IntentPrecondition, TrailsExecutionInfo, } from "@0xsequence/trails-api";
...
export declare function calculateIntentAddress(mainSigner: string, calls: Array<IntentCallsPayload>, executionInfosArg: Array<TrailsExecutionInfo> | null | undefined, sapientType?: QuoteProvider): `0x${string}`;
export declare function commitIntentConfig(apiClient: SequenceAPIClient, mainSignerAddress: string, calls: Array<IntentCallsPayload>, preconditions: Array<IntentPrecondition>, executionInfos: Array<TrailsExecutionInfo>, sapientType?: QuoteProvider): Promise<CommitIntentConfigReturn>;
...
export declare function getTrailsExecutionInfoHash(executionInfos: TrailsExecutionInfo[], attestationAddress: Address.Address): Hex.Hex;
export declare function calculateIntentConfigurationAddress(mainSigner: Address.Address, calls: Array<IntentCallsPayload>, context: Context.Context, attestationSigner?: Address.Address, executionInfos?: Array<TrailsExecutionInfo>, sapientType?: QuoteProvider): Address.Address;
