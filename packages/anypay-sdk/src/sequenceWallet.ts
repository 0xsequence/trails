...
import { type PublicClient, hexToBytes, bytesToHex, type Chain, type WalletClient } from 'viem'
...
export async function sequenceSendTransaction(
    ...
    const sequenceAccount = accountFor({
        ...
        signatures: [{ signer: accountClient.account?.address as `0x${string}`, signature: suffixed }]
    })
