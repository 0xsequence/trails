...
export const WebrpcHeaderValue =
  "webrpc@v0.24.0;gen-typescript@v0.16.3;sequence-relayer@v0.4.1";
...
export interface Relayer {
  ...
  getSequenceContext(
    headers?: object,
    signal?: AbortSignal,
  ): Promise<GetSequenceContextReturn>;
  getChainID(headers?: object, signal?: AbortSignal): Promise<GetChainIDReturn>;
  sendMetaTxn(
    args: SendMetaTxnArgs,
    headers?: object,
    signal?: AbortSignal,
  ): Promise<SendMetaTxnReturn>;
  getMetaTxnNonce(
  ...
  getGasTank(
    ...
    headers?: object,
    signal?: AbortSignal,
  ): Promise<GetGasTankReturn>;
  addGasTank(
    args: AddGasTankArgs,
    headers?: object,
    signal?: AbortSignal,
  ): Promise<AddGasTankReturn>;
  updateGasTank(
    args: UpdateGasTankArgs,
    headers?: object,
    signal?: AbortSignal,
  ): Promise<UpdateGasTankReturn>;
  ...
  getGasSponsor(
    ...
    headers?: object,
    signal?: AbortSignal,
  ): Promise<GetGasSponsorReturn>;
  addGasSponsor(
    args: AddGasSponsorArgs,
    headers?: object,
    signal?: AbortSignal,
  ): Promise<AddGasSponsorReturn>;
  updateGasSponsor(
