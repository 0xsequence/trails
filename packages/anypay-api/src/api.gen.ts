/* eslint-disable */
// sequence-api v0.4.0 5f1bf0cccdfeb83550afe380128240636ce763be
// --
...
export const WebRPCSchemaHash = "5f1bf0cccdfeb83550afe380128240636ce763be"
...
export interface GetIntentCallsPayloadsReturn {
  ...
  lifiInfos: Array<AnypayLifiInfo>
  anypayFee: AnypayFee  
}
    ...
    return this.fetch(
      ...
      return buildResponse(res).then(_data => {
        return {
          ...
          lifiInfos: <Array<AnypayLifiInfo>>(_data.lifiInfos),
