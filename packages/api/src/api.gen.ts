/* eslint-disable */
// sequence-api v0.4.0 e3bb56f2a43229dcfc895c9e23f6558cdb4e348d
// --
...
export const WebRPCSchemaHash = "e3bb56f2a43229dcfc895c9e23f6558cdb4e348d"
...
export interface IntentConfig {
  ...
  AnypayExecutionInfo: AnypayExecutionInfo
  updatedAt?: string
  createdAt?: string
}
...
export interface GetIntentCallsPayloadsReturn {
  ...
  anypayInfos: Array<AnypayExecutionInfo>
  anypayFee: AnypayFee  
}
    ...
    return this.fetch(
      ...
      return buildResponse(res).then(_data => {
        return {
          ...
          anypayInfos: <Array<AnypayExecutionInfo>>(_data.anypayInfos),
          anypayFee: <AnypayFee>(_data.anypayFee),
        }
      })
    }, (error) => {
      throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error.message || ''}` })
