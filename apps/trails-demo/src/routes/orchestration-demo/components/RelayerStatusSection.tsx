      ...
      <div className="space-y-6 mt-4">
        ...
        <div className="bg-gray-900/90 p-4 rounded-lg border border-gray-700/70 overflow-x-auto shadow-inner">
          ...
          <div className="space-y-3">
                  ...
                  className={`font-mono ${
                    originCallStatus?.status === "Success"
                      ...
                      : originCallStatus?.status === "Failed"
                        ? "text-red-400"
                        : originCallStatus?.status === "Pending" ||
                            originCallStatus?.status === "Sending..."
                          ? "text-yellow-400"
                          : "text-gray-400"
                  }`}
                >
            ...
            {typeof originBlockTimestamp === "number" &&
          ...
          <div className="space-y-4">
            {metaTxns?.map((metaTxn: MetaTxn, index: number) => {
              ...
              return (
                <div
                  key={`metatx-${index}`}
                  className="bg-gray-800/70 p-3 rounded-md"
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    >
                      ...
                      <span className="text-gray-400 text-xs ml-2">
                        (
                        {getChainInfo(parseInt(metaTxn.chainId))?.name ||
                          "Unknown Chain"}
                        )
                      </span>
                    </Text>
